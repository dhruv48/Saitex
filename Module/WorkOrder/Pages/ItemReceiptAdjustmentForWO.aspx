<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ItemReceiptAdjustmentForWO.aspx.cs"
    Inherits="WorkOrder_ItemReceiptAdjustmentForWO" %>
                                ...
                                <asp:GridView ID="grdReceiptAdjustment" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="PO Branch">
                                            ...
                                            <asp:TemplateField HeaderText="PO Year">
                                            <ItemTemplate>
                                                <asp:Label ID="lblPOYear" runat="server" CssClass="SmallFont Label" Text='<%# Eval("PO_YEAR") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField FooterStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right"
                                            ...
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtAdjustedReceiptQTY" runat="server" AutoPostBack="True" CssClass="SmallFont TextBoxNo"
                                                    MaxLength="5" OnTextChanged="txtAdjustedReceiptQTY_TextChanged1" Text='<%# Bind("IRADJUST_QTY") %>' Width="50px"></asp:TextBox>
                                                <br />
