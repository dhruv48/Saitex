<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WO_TRN_SUB.aspx.cs" Inherits="Module_WorkOrder_Pages_WO_TRN_SUB" %>
                                ...
                                <tr>
                                    ...
                                    <td align="left" valign="top">
                                       ...
                                       <td align="left" valign="top">
                                        <asp:TextBox ID="txtGrossWt" Width="70px" class="SmallFont" runat="server" AutoPostBack="True"
                                             MaxLength="15"  TabIndex="4" ontextchanged="txtGrossWt_TextChanged"></asp:TextBox>
                                    ...
                                    <td align="left" valign="top">
                                        <asp:TextBox ID="txtQty" Width="70px" class="SmallFont" runat="server" AutoPostBack="True"
                                            OnTextChanged="txtQty_TextChanged" MaxLength="15"  TabIndex="6"></asp:TextBox>
