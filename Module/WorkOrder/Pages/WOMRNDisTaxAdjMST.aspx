<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WOMRNDisTaxAdjMST.aspx.cs"
    Inherits="Module_WorkOrder_Pages_WOMRNDisTaxAdjMST" %>
                                ...
                                <tr>
                                    <td>
                                        <asp:DropDownList ID="ddlRateComponent" runat="server" AppendDataBoundItems="True"
                                            Width="120px" CssClass="SmallFont">
