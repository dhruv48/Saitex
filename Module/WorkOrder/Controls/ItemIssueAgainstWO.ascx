<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ItemIssueAgainstWO.ascx.cs"
    Inherits="Module_WorkOrder_Controls_ItemIssueAgainstWO" %>
        ...
        <table class="tdMain" width="100%">
            ...
            <tr>
                <td align="center" class="TableHeader td" width="100%">
                    <b class="titleheading">Item Issue Against Work Order</b>
                </td>
            </tr>
            <tr>
                ...
                <td width="100%" class="td">
                    <table width="100%">
                        <tr>
                            ...
                            <td class="tdRight" width="15%">
                                <asp:Label ID="Label16" runat="server" Text="Challan Date : " CssClass="Label SmallFont"></asp:Label>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="tdLeft" width="15%">
                                <cc2:ComboBox ID="txtPartyCode" runat="server" AutoPostBack="True" EnableLoadOnDemand="true"
                                    OnLoadingItems="txtPartyCode_LoadingItems" DataTextField="PRTY_CODE" DataValueField="PRTY_ADDRESS"
                                    EmptyText="Select Party" OnSelectedIndexChanged="txtPartyCode_SelectedIndexChanged"
                            ...
                            <td class="tdRight" colspan="2">
                                ...
                                <asp:TextBox ID="txtPartyAddress" TabIndex="4" runat="server" CssClass="TextBox TextBoxDisplay SmallFont"
                                    ReadOnly="True" Width="65%"></asp:TextBox>
                            </td>
                             <td class="tdRight" width="15%">
                            ...
                            OnSelectedIndexChanged="txtTransporterCode_SelectedIndexChanged" Width="150px"  EmptyText="Select Transporter"
                            ...
                            <td class="tdRight" colspan="2">
                                <asp:TextBox ID="lblTransporterCode" TabIndex="4" runat="server" CssClass="TextBox TextBoxDisplay SmallFont"
                                    ReadOnly="True" Width="25%"></asp:TextBox>
                          
                                <asp:TextBox ID="txtTransporterAddress" TabIndex="4" runat="server" CssClass="TextBox TextBoxDisplay SmallFont"
                                    ReadOnly="True" Width="65%"></asp:TextBox>
                            </td>
                             <td class="tdRight" width="15%">
                ...
                <td width="100%" class="td">
                    <table width="98%">
                        <tr bgcolor="#336699" class="SmallFont titleheading">
                            ...
                            <td id="thmachine" runat="server" visible="false">
                                Mac Code
                            </td>
                            <td>
                                Remarks
                        ...
                        <tr>
                            <td>
                                <cc2:ComboBox ID="txtICODE" runat="server" CssClass="SmallFont" EmptyText="select..."
                                    AutoPostBack="True" EnableLoadOnDemand="true" MenuWidth="700px" Width="100px"
                                ...
                                <div class="header c6">
                                    ...
                                    <ItemTemplate>
                                        <div class="item c2">
                                            <asp:Literal runat="server" ID="Literal4" Text='<%# Eval("WO_NUMB") %>' />
                                        </div>
                                        <div class="item c2">
                                            <asp:Literal runat="server" ID="Container2" Text='<%# Eval("BASE_ARTICLE_CODE") %>' />
                                        </div>
                                        <div class="item c4">
                                            <asp:Literal runat="server" ID="Container3" Text='<%# Eval("BASE_ARTICLE_DESC") %>' />
                                        </div>
                                         <div class="item c2">
                            ...
                            <td>
                                <asp:DropDownList ID="ddlCostCode" CssClass="SmallFont" runat="server" AppendDataBoundItems="True" Width="100px">
                                </asp:DropDownList>
                            </td>
                            <td id="trmachine" runat="server" visible="false">
                        ...
                        <tr>
                            <td colspan="7">
                                <span lang="en-us">WO Numb:<asp:TextBox ID="txtPO_NUMB" runat="server" CssClass="TextBox TextBoxDisplay SmallFont"
                            ...
                            Bal&nbsp;Qty:    <asp:Label ID="lblPO_Year" runat="server" Visible="False"></asp:Label>
                                <asp:Label ID="lblMaxQty" runat="server" CssClass="SmallFont"></asp:Label>
                            </td>
                            <td>
                ...
                <td width="100%" class="td">
                    <asp:Panel ID="pnlGrid" runat="server" Width="100%">
                        <asp:GridView ID="grdMaterialItemIssue" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="WO Numb">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="No of Unit" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" Visible="false">
                                    <ItemTemplate>
