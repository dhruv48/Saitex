<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ItemReceivingAgainstWO.ascx.cs"
    Inherits="Module_WorkOrder_Controls_ItemReceivingAgainstWO" %>
    ...
    <ContentTemplate>
        <table class="tdMain tContentArial" width="800px">
            ...
            <tr>
                <td align="center" class="TableHeader td" width="100%">
                    <b class="titleheading">M.R.N. Against WO </b>
                </td>
            </tr>
            <tr>
                ...
                <td width="100%" class="td">
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td width="17%" class="tdLeft">
                                <cc2:ComboBox ID="ddlGateEntryNo" TabIndex="4" runat="server" AutoPostBack="True" EnableLoadOnDemand="true"
                                ...
                                <asp:TextBox ID="txtGateEntryNo" TabIndex="5" runat="server" CssClass="TextBoxNo TextBoxDisplay SmallFont"
                            ...
                            <td width="17%" class="tdLeft">
                                <asp:TextBox ID="txtGateEntryDate" runat="server" TabIndex="6" Width="150px" ReadOnly="true"
                                    CssClass="TextBox TextBoxDisplay SmallFont"></asp:TextBox>
                            </td>
                            <td width="17%" class="tdRight">
                                <asp:Label ID="Label9" runat="server" Text="Vehicle/LorryNo.:" CssClass="Label SmallFont"></asp:Label>
                            </td>
                            <td width="17%" class="tdLeft">
                                <asp:TextBox ID="txtVehicleNo" runat="server" TabIndex="7" Width="150px" ReadOnly="true"
                        ...
                        <tr>
                            ...
                            <td width="17%" class="tdLeft">
                                <asp:TextBox ID="txtPartyChallanNo" runat="server" TabIndex="8" Width="150px" ReadOnly="true"
                                    CssClass="TextBox TextBoxDisplay SmallFont"></asp:TextBox>
                            </td>
                            <td width="17%" class="tdRight">
                            ...
                            <td width="17%" class="tdLeft">
                                <asp:TextBox ID="txtPartyChallanDate" runat="server" TabIndex="9" Width="150px" ReadOnly="true"
                                    CssClass="TextBox TextBoxDisplay SmallFont"></asp:TextBox>
                            </td>
                            <td width="17%" class="tdRight">
                            ...
                            <td width="17%" class="tdLeft">
                                <asp:TextBox ID="txtDepartment" runat="server" TabIndex="10" Width="150px" CssClass="TextBox TextBoxDisplay SmallFont"
                        ...
                        <tr>
                            ...
                            <td width="17%" class="tdLeft">
                                <asp:TextBox ID="lblPartyCode" TabIndex="11" runat="server" CssClass="TextBox TextBoxDisplay SmallFont"
                            ...
                            <td class="tdLeft" colspan="0" style="width: 17%">
                                <asp:TextBox ID="txtPartyAddress" TabIndex="12" runat="server" Width="150px" CssClass="TextBox TextBoxDisplay SmallFont"
                                    ReadOnly="True"></asp:TextBox>
                            </td>
                             <td width="17%" class="tdRight">
                        ...
                        <tr>
                            ...
                            <td width="17%" class="tdLeft">
                                <asp:TextBox ID="lblTransporterCode" TabIndex="14" runat="server" CssClass="TextBox TextBoxDisplay SmallFont"
                                    ReadOnly="True" Width="150px"></asp:TextBox>
                            </td>
                            <td width="17%" class="tdRight">
                                <asp:Label ID="Label21" runat="server" Text="Transporter Details :" CssClass="LabelNo SmallFont"></asp:Label>
                            </td>
                            <td class="tdLeft"  style="width: 49%">
                                <asp:TextBox ID="txtTransporterAddress" TabIndex="15" runat="server" Width="150px"
                        ...
                        <tr>
                            ...
                            <td width="17%" class="tdLeft">
                                <asp:TextBox ID="txtPartyBillNo" runat="server" TabIndex="17" Width="150px" CssClass="TextBoxNo SmallFont"
                            ...
                            <td width="17%" class="tdLeft">
                                <asp:TextBox ID="txtPartyBillDate" runat="server" TabIndex="18" Width="150px" CssClass="TextBox SmallFont"></asp:TextBox>
                            </td>
                            <td width="17%" class="tdRight">
                                Party&nbsp;Bill&nbsp;Amount&nbsp;:
                            </td>
                            <td width="15%" class="tdLeft">
                                <asp:TextBox ID="txtTotalPartyAmt" runat="server" TabIndex="19" Width="150px" CssClass="TextBoxDisplay TextBoxNo SmallFont"
                                    ReadOnly="True"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td width="17%" class="tdLeft">
                                <asp:TextBox ID="txtFormType" runat="server" TabIndex="20" Width="150px" CssClass="TextBox SmallFont"
                            ...
                            <td width="17%" class="tdLeft">
                                <asp:TextBox ID="txtFormRefNo" runat="server" TabIndex="21" Width="150px" CssClass="TextBox SmallFont"
                                    MaxLength="15"></asp:TextBox>
                            </td>
                            <td width="17%" class="tdRight">
                            ...
                            <td width="15%" class="tdLeft">
                                <asp:TextBox ID="txtTotalAmount" runat="server" TabIndex="22" Width="150px" CssClass="TextBoxDisplay TextBoxNo SmallFont"
                                    ReadOnly="true"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td width="17%" class="tdLeft">
                                <asp:TextBox ID="txtLRNo" runat="server" TabIndex="23" Width="150px" CssClass="TextBox TextBoxDisplay SmallFont"
                                    MaxLength="15"></asp:TextBox>
                            </td>
                            <td width="17%" class="tdRight">
                            ...
                            <td width="17%" class="tdLeft">
                                <asp:TextBox ID="txtLRDate" runat="server" TabIndex="24" Width="150px" CssClass="TextBox TextBoxDisplay SmallFont"></asp:TextBox>
                            </td>
                            <td width="17%" class="tdRight">
                                Other Charges :
                            </td>
                            <td width="15%" class="tdLeft">
                                <asp:Button ID="btnDisTaxAdjMST" TabIndex="25" runat="server" Text="Other Charges" Width="150px"
                        ...
                        <tr>
                            ...
                            <td width="15%" class="tdLeft">
                                <asp:TextBox ID="txtPartyBillAmount" runat="server" TabIndex="26" Width="150px" CssClass="TextBoxDisplay TextBoxNo SmallFont"
                        ...
                        <tr>
                            ...
                            <td class="tdLeft" width="83%" colspan="5">
                                <asp:TextBox ID="txtRemarks" runat="server" Width="100%" TabIndex="27" CssClass="TextBox SmallFont"
            ...
            <tr>
                <td width="100%" class="td">
                    <table width="100%" class="SmallFont">
                        ...
                        <tr>
                            <td>
                                <cc2:ComboBox ID="cmbPOITEM" TabIndex="28" runat="server" CssClass="SmallFont" EmptyText="select..."
                                    ...
                                    <ItemTemplate>
                                      <%--  <div class="item c1">
                                        ...
                                        <div class="item c1">
                                            <asp:Literal runat="server" ID="Container7" Text='<%# Eval("WO_NUMB") %>' />
                                        </div>
                                        <div class="item c2">
                                            <asp:Literal runat="server" ID="Container8" Text='<%# Eval("ARTICLE_CODE") %>' />
                                        </div>
                                        <div class="item c6">
                                            <asp:Literal runat="server" ID="Container9" Text='<%# Eval("ARTICLE_DESC") %>' />
                                        </div>
                                        <div class="item c1">
                            ...
                            <td>
                                <asp:TextBox ID="txtNoOfUnit" TabIndex="29" runat="server" CssClass="TextBoxNo tdRight SmallFont TextBoxDisplay"
                                    AutoPostBack="true" Width="72px" OnTextChanged="txtNoOfUnit_TextChanged" ReadOnly="true"></asp:TextBox>
                            </td>
                            <td>
                                <asp:TextBox ID="txtWeightofUnit" runat="server" TabIndex="30" CssClass="TextBoxNo tdRight SmallFont TextBoxDisplay"
                                    AutoPostBack="true" Width="74px" OnTextChanged="txtWeightofUnit_TextChanged"></asp:TextBox>
                            </td>
                            <td>
                                <asp:TextBox ID="txtQTY" runat="server" TabIndex="31" CssClass="TextBoxNo SmallFont tdRight TextBoxDisplay"
                                    AutoPostBack="true" Width="77px" ReadOnly="true" OnTextChanged="txtQTY_TextChanged"></asp:TextBox>
                            </td>
                            <td>
                                <asp:TextBox ID="txtBasicRate" runat="server" TabIndex="32" CssClass="TextBoxNo tdRight TextBoxDisplay SmallFont"
                                    ReadOnly="True" Width="78px"></asp:TextBox>
                            </td>
                            <td>
                                <asp:TextBox ID="txtpoRate" runat="server" TabIndex="33" CssClass="TextBoxNo tdRight TextBoxDisplay SmallFont"
                                    ReadOnly="True" Width="79px"></asp:TextBox>
                            </td>
                            <td>
                                <asp:Button ID="btnDisTaxAdj" runat="server" TabIndex="34" Text="Dis/Tax" Width="50px" CssClass="SmallFont"
                                    OnClick="btnDisTaxAdj_Click" />
                            </td>
                            <td>
                                <asp:TextBox ID="txtFinalRate" runat="server" TabIndex="35" CssClass="TextBoxNo tdRight TextBoxDisplay SmallFont"
                            ...
                            <td>
                                <asp:TextBox ID="txtDetRemarks" runat="server" TabIndex="36" CssClass="TextBox SmallFont" Width="158px"
                                    MaxLength="200"></asp:TextBox>
                            </td>
                            <td>
                                <asp:Button ID="btnsaveTRNDetail" runat="server" TabIndex="38" CssClass="SmallFont" OnClick="btnsaveTRNDetail_Click"
                        ...
                        <tr>
                            <td colspan="10">
                                <asp:Button ID="btnSubDetail" runat="server" TabIndex="37" OnClick="btnSubDetail_Click" Text="Sub Details" CssClass="SmallFont"
                                    Width="80px" />
                                WO Numb :
                            ...
                            <td>
                                <asp:Button ID="btnTRNCancel" runat="server" TabIndex="39" CssClass="SmallFont" OnClick="btnTRNCancel_Click"
                ...
                <td width="100%" class="td">
                    <asp:Panel ID="pnlGrid" runat="server" Width="100%">
                        <asp:GridView ID="grdMaterialItemReceipt" Width="99%" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="WO #" HeaderStyle-CssClass="tdRight">
                                    <ItemTemplate>
                            ...
                            <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="WO Rate" HeaderStyle-CssClass="tdRight">
                                    <ItemTemplate>
     ...
     <%--   <asp:RangeValidator ID="rvbill" runat="server" ControlToValidate="txtPartyBillDate"
       ...
       <%-- <asp:RangeValidator ID="rvlr" runat="server" ControlToValidate="txtLRDate" Display="Dynamic"
        ...
        <cc1:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd/MM/yyyy" TargetControlID="txtMRNDate">
        </cc1:CalendarExtender>
    </ContentTemplate>
</asp:UpdatePanel>