<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Yarn_Receipt_UnApproval.ascx.cs" Inherits="Module_Yarn_SalesWork_Controls_Yarn_Receipt_UnApproval" %>
...
<table align="left" class="tContentArial" width="100%">
    ...
    <tr>
        <td align="center" class="TableHeader td" width="100%">
            <b class="titleheading">Yarn Tranaction UnApproval</b>
        </td>
    </tr>
    <tr>
        <td align="left" class="td" valign="top" width="100%">
