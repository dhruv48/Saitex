<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PackedYarnReciept_Direct.ascx.cs"
    Inherits="Module_Yarn_SalesWork_Controls_PackedYarnReciept_Direct" %>
                    ...
                    <td align="left" valign="top" width="15%" class="style2">
                                            <asp:DropDownList ID="ddlPackingType" runat="server" CssClass="SmallFont" 
                                                Font-Size="8"    Width="150px" 
                                                 >   
                                             <asp:ListItem Selected="True" Text="In Carton" Value="RYS31"></asp:ListItem>
                                             <asp:ListItem  Text="In Carrate" Value="RYS32"></asp:ListItem>
                                             </asp:DropDownList>
        ...
        <td width="100%" class="td">
            <table width="100%">
                ...
                <tr>
                    <td>
                        <cc2:ComboBox ID="cmbPOITEM" runat="server" CssClass="SmallFont" EmptyText="select..."
                            AutoPostBack="True" EnableLoadOnDemand="true" MenuWidth="650px"  Width="80px"
              ...
              &nbsp; 
                            ...
                            Remarks&nbsp; <asp:TextBox ID="txtDetRemarks" runat="server" CssClass="TextBox SmallFont" Width="120px" TabIndex="11"
                            MaxLength="200" ></asp:TextBox>
