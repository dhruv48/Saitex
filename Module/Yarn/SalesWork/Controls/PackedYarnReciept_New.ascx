<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PackedYarnReciept_New.ascx.cs"
    Inherits="Module_Yarn_SalesWork_Controls_PackedYarnReciept_New" %>
        ...
        <table class="tdMain" width="100%">
                        ...
                        <tr>
                            <td id="tdSave" runat="server">
                                <asp:ImageButton ID="imgbtnSave" OnClick="imgbtnSave_Click" runat="server" ToolTip="Save"
                                    ImageUrl="~/CommonImages/save.jpg" ValidationGroup="gg" Style="height: 41px"></asp:ImageButton>
                            </td>
            ...
            <tr>
                <td align="center" class="TableHeader td" width="100%">
                    <b class="titleheading">Yarn Packing Against MRN</b>
                </td>
            </tr>
            <tr>
                ...
                <td width="100%" class="td SmallFont">
                    <table width="100%">
                        <tr>
                            ...
                            <td align="left" valign="top" width="17%">
                                <asp:DropDownList ID="ddlReceiptShift" CssClass="SmallFont" runat="server"  Width="150px">
                                </asp:DropDownList>
                            </td>
                            <td align="right" valign="top" width="17%">
                            ...
                            <td align="left" valign="top" width="15%">
                                ...
                                <asp:TextBox ID="txtMRNDate" runat="server"  ValidationGroup="M1" Width="150px"
                        ...
                        <tr id="trParty" runat="server" visible="false">
                            ...
                            <td align="right" valign="top" width="17%">Party Details :
                            </td>
                            ...
                            <td align="right" valign="top" width="17%">Transporter Details :
                            </td>
                            <td align="left" valign="top" colspan="1" style="width: 32%">
                        ...
                        <tr>
                            ...
                            <td class="tdLeft" width="15%">
                                <asp:DropDownList ID="ddlPackingType" runat="server" CssClass="SmallFont"
                                    ...
                                    <asp:ListItem Text="In MRN" Value="RYS13" Selected="True"></asp:ListItem>
                                </asp:DropDownList>
                            ...
                            <td class="tdRight" width="15%">
                                <asp:Label ID="Label23" runat="server" Text="Source Location : " CssClass="LabelNo SmallFont"></asp:Label>
                            </td>
                            <td class="tdLeft" width="15%">
                                <asp:DropDownList ID="ddlFromLocation" CssClass="SmallFont" AppendDataBoundItems="true"
                                    Width="150px" runat="server" TabIndex="1" >
                                </asp:DropDownList>
                            </td>
                            <td align="right" valign="top" width="17%" class="style2">
                                <asp:Label ID="Label27" runat="server" Text="Location :" CssClass="Label SmallFont"></asp:Label>
                            </td>
                            <td align="left" valign="top" width="15%" class="style2">
                                <asp:DropDownList ID="ddlLocation" runat="server" CssClass="SmallFont" Font-Size="8" Width="150px" TabIndex="3" ></asp:DropDownList>
                            </td>
                        ...
                        <tr>
                            ...
                            <td align="right" valign="top" width="17%" class="style2">
                                <asp:Label ID="Label25" runat="server" Text="Issue Numb :" CssClass="Label SmallFont"></asp:Label>
                            ...
                            <td align="right" valign="top" width="17%" class="style2">
                                <asp:Label ID="Label24" runat="server" Text="Source Store : " CssClass="LabelNo SmallFont"></asp:Label>
                            </td>
                            <td align="left" valign="top" width="15%" class="style2">
                                <asp:DropDownList ID="ddlFromStore" CssClass="SmallFont" AppendDataBoundItems="true"
                                    Width="150px" runat="server" TabIndex="2" >
                                </asp:DropDownList>
                            </td>
                            ...
                            <td align="left" valign="top" width="15%" class="style2">
                                <asp:DropDownList ID="ddlStore" runat="server" CssClass="SmallFont" Font-Size="8" Width="150px" TabIndex="4" ></asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td class="tdRight" width="20%">
                                <asp:Label ID="Label26" runat="server" Text="Receive Numb :" CssClass="Label SmallFont"></asp:Label>
                            </td>
                            <td class="tdLeft" width="15%">
                        ...
                        <tr id="trPartyBill" runat="server" visible="false">
                            ...
                            <td align="left" valign="top" width="17%">
                                <asp:TextBox ID="txtPartyBillNo" runat="server"  Width="150px" CssClass="TextBox SmallFont"
                            ...
                            <td align="left" valign="top" width="17%">
                                <asp:TextBox ID="txtPartyBillDate" runat="server"  Width="150px" CssClass="TextBox SmallFont"></asp:TextBox>
                            </td>
                            <td align="right" valign="top" width="17%">
                                <asp:Label ID="Label3" runat="server" Text="Party Bill Amount :" CssClass="Label SmallFont"></asp:Label>
                            </td>
                            <td align="left" valign="top" width="15%">
                                <asp:TextBox ID="txtTotalPartyAmt" runat="server"  Width="150px" CssClass="TextBoxNo SmallFont"
                                ...
                                <asp:TextBox ID="txtPartyBillAmount" runat="server"  Width="150px" CssClass="TextBoxNo SmallFont"
                                    AutoPostBack="True" OnTextChanged="txtPartyBillAmount_TextChanged" MaxLength="6"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            MaxLength="15" ></asp:TextBox>--%>
                                <cc2:ComboBox ID="txtFormType" runat="server" AutoPostBack="True" CssClass="smallfont"
                                    ...
                                    OnSelectedIndexChanged="txtFormType_SelectedIndexChanged" TabIndex="5">
                                    <HeaderTemplate>
                                        <div class="header c2">
                                            CODE
                                        </div>
                            ...
                            MaxLength="15"></asp:TextBox>--%>
                                <cc2:ComboBox ID="txtFormRefNo" runat="server" AutoPostBack="True" CssClass="smallfont"
                                    ...
                                    EnableVirtualScrolling="true" OpenOnFocus="true"
                                     Width="150px" Height="200px"
                                    OnSelectedIndexChanged="txtFormRefNo_SelectedIndexChanged" TabIndex="6">
                                    <HeaderTemplate>
                                        <div class="header c2">
                                            CODE
                                        </div>
                            ...
                            <td align="left" valign="top" width="15%">
                                <asp:TextBox ID="txtRemarks" runat="server" Width="150px"  CssClass="TextBox SmallFont"
                        ...
                        <tr id="trLr" runat="server" visible="false">
                            ...
                            <td align="left" valign="top" width="17%">
                                <asp:TextBox ID="txtLRNo" runat="server"  Width="150px" CssClass="TextBoxNo SmallFont"
                                    MaxLength="15"></asp:TextBox>
                            </td>
                            <td align="right" valign="top" width="17%">
                            ...
                            <td align="left" valign="top" width="17%">
                                <asp:TextBox ID="txtLRDate" runat="server"  Width="150px" CssClass="TextBox SmallFont"></asp:TextBox>
                            ...
                            <td align="right" valign="top" width="17%">Other Charges:
                            </td>
                            <td align="left" valign="top" width="15%">
                                <asp:TextBox ID="txtTotalAmount" runat="server"  Width="150px" CssClass="TextBoxDisplay TextBoxNo SmallFont"
                                    ReadOnly="true"></asp:TextBox>
            ...
            <tr>
                        ...
                        <tr>
                            <td>
                                <cc2:ComboBox ID="cmbPOITEM" runat="server" CssClass="SmallFont" EmptyText="select..."
                                    ...
                                    Height="200px" OnPreRender="cmbPOITEM_PreRender" TabIndex="8" >
                                    <HeaderTemplate>
                                        <div class="header c2">
                                            MRN NO
                                        </div>
                ...
                DataTextField="LOT_NO" DataValueField="Item_trn" EmptyText="Select Lot No" EnableLoadOnDemand="true"
                Height="200px" MenuWidth="400px"  EnableVirtualScrolling="true"
                    ...
                    <%# Container.ItemsCount %>.
                            ...
                            <td>
                                <cc2:ComboBox ID="txtGrade" runat="server" EnableLoadOnDemand="true"
                                    ...
                                    EmptyText="Grade"
                                    EnableVirtualScrolling="true" Width="50px" MenuWidth="100px" Height="200px" TabIndex="9" >
                                    <HeaderTemplate>
                                        <div class="header c1">
                                            Grade
                                        </div>
                            ...
                            <td>
                                <asp:Button ID="btnSubDetail"  runat="server" Font-Size="8pt" Text="Cartons Detail" CssClass="SmallFont"
                                    Width="100px" OnClick="btnSubDetail_Click1" TabIndex="10" /></td>
                            <td>

                                <asp:DropDownList Width="60px" CssClass="SmallFont" 
                                    ID="ddlFinishedType" runat="server" Visible="false">
                            ...
                            <td>
                                <asp:TextBox ID="txtDetRemarks" runat="server" CssClass="TextBox SmallFont" Width="120px" 
                                    MaxLength="200" TabIndex="11" ></asp:TextBox>

                            </td>
                            <td>
                                <asp:Button ID="btnsaveTRNDetail" runat="server" CssClass="SmallFont" OnClick="btnsaveTRNDetail_Click"
                                    OnClientClick="getConfirmation();" Text="Add" Width="60px" TabIndex="12" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="12" class="SmallFont titleheading" valign="top">

                                <%--  PO&nbsp;No:--%>
                                <asp:TextBox ID="txtPONumb" runat="server" CssClass="TextBoxNo TextBoxDisplay SmallFont"
                                    ReadOnly="true" Width="50px" Visible="false" Text="999999"></asp:TextBox>
                                Remaining Qty
                         ...
                         <asp:TextBox ID="txtICODE" runat="server" CssClass="TextBox TextBoxDisplay SmallFont"
                             Width="70px" ReadOnly="true"></asp:TextBox>
                                ...
                                &nbsp; Shade Family:<asp:TextBox ID="txtShadeFamily" runat="server" CssClass="TextBox TextBoxDisplay SmallFont"
                                    ReadOnly="true" Width="60px" Visible="true"></asp:TextBox>
                    ...
                    <%# Container.ItemsCount %>.
                            ...
                            <td>
                                <asp:Button ID="btnTRNCancel" runat="server" CssClass="SmallFont" OnClick="btnTRNCancel_Click" 
                                    Text="Cancel" Width="60px" TabIndex="13" />
                            </td>
                        </tr>
                    </table>
                </td>
