<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Yarn_Issue_Against_PI.ascx.cs"
    Inherits="Module_Yarn_SalesWork_Controls_Yarn_Issue_Against_PI" %>
        ...
        <table class="tdMain" width="100%">
            ...
            <tr>
                <td align="center" class="TableHeader td" width="100%">
                    <b class="titleheading">Yarn Issue Against PA (SALES)</b>
                </td>
            </tr>
            <tr>
