<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ReturnMiss.ascx.cs" Inherits="Module_Yarn_SalesWork_Controls_ReturnMiss" %>
...
<table class="tdMain" width="800px">
    ...
    <tr>
        <td align="center" class="TableHeader td" width="100%">
            <b class="titleheading">Yarn Return Misc.</b>
        </td>
    </tr>
    <tr>
        ...
        <td class="td" width="100%">
            <table width="100%">
                <tr>
                    ...
                    <td class="tdRight" width="17%">
                        <asp:Label ID="Label16" runat="server" CssClass="Label SmallFont" Text="Return Date : "></asp:Label>
                    </td>
                    <td class="tdLeft" width="17%">
                ...
                <tr><td class="tdRight" width="17%">
                      <asp:Label ID="Label4" runat="server" CssClass="Label SmallFont" Text="Department&nbsp;:&nbsp;"></asp:Label>  
                    </td>
                    <td class="tdLeft" width="15%">
                    ...
                    <td class="tdRight" width="17%">
                        <asp:Label ID="Label1" runat="server" CssClass="Label SmallFont" Text="Location :"></asp:Label>
                    </td>
                    <td class="tdLeft" width="17%">
                    ...
                    <td class="tdRight" width="17%">
                        <asp:Label ID="Label3" runat="server" CssClass="Label SmallFont" Text="Store :"></asp:Label>
                    </td>
                    <td class="tdLeft" width="17%">
                 ...
                 <tr>
                            <td class="tdRight" width="15%">
                                <asp:Label ID="Label6" runat="server" Text="Party&nbsp;:&nbsp;" CssClass="Label SmallFont"></asp:Label>
                            </td>
                            <td class="tdLeft" width="15%">
                            ...
                            <td class="tdLeft" colspan="1" style="width: 15%">
                             ...
                             <td class="tdRight" width="17%">
                        <asp:Label ID="Label5" runat="server" CssClass="Label SmallFont" Text="Reprocess :"></asp:Label>
                    </td>
                    <td class="tdLeft" width="17%">
   ...
   <tr>
                            ...
                            <td valign="top" align="left" width="15%">
                                <cc2:ComboBox ID="txtTransporterCode" runat="server" AutoPostBack="True" EnableLoadOnDemand="true"  EmptyText="Select Transporter"
                                    OnLoadingItems="txtTransporterCode_LoadingItems" DataTextField="PRTY_CODE" DataValueField="PRTY_CODE"
                                    OnSelectedIndexChanged="txtTransporterCode_SelectedIndexChanged" Width="150px"
                                    Height="200px" MenuWidth="450px" TabIndex="5">
                                    <HeaderTemplate>
                                        <div class="header c1">
                                            Code</div>
                                        <div class="header c5">
                            ...
                            <asp:TextBox ID="txtTransporterCode1" TabIndex="6" runat="server" Width="100px" CssClass="TextBox TextBoxDisplay SmallFont"
                                    ReadOnly="True" TextMode="SingleLine"></asp:TextBox>
                               
                            </td>
                            <td>
                              <asp:TextBox ID="txtTransporterAddress" TabIndex="6" runat="server" Width="150px" CssClass="TextBox TextBoxDisplay SmallFont"
                                    ReadOnly="True" TextMode="SingleLine"></asp:TextBox>
                            </td>
                            <td class="tdRight" width="17%">
                        <asp:Label ID="Label2" runat="server" CssClass="Label SmallFont" Text="Returnable :"></asp:Label>
                    </td>
                    <td class="tdLeft" width="17%">
                    <asp:DropDownList ID="ddlReturnable" runat="server" TabIndex="9" Width="150px">
        ...
        <td class="td" width="100%">
            <table width="99%">
                ...
                <tr>
                    ...
                    <td width="9%">
                        <asp:TextBox ID="txtCostCode" runat="server" CssClass="TextBox SmallFont" Width="99%" TabIndex="17"></asp:TextBox>
                    </td>
                    <td width="9%">
                        <asp:TextBox ID="txtMacCode" runat="server" CssClass="TextBox SmallFont" Width="99%" TabIndex="18"></asp:TextBox>
                    </td>
                    <td width="15%">
