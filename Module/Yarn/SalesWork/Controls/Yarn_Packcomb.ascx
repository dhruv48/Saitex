<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Yarn_Packcomb.ascx.cs" Inherits="Module_Yarn_SalesWork_Controls_Yarn_Packcomb" %>
...
<table class="tContentArial">
    ...
    <tr>
        <td class="TableHeader td" align="center" width="100%">
            <span class="titleheading"><b>Daily Packing & Loose Stock Report
