<%@ Control Language="C#" AutoEventWireup="true" CodeFile="YarnIssueAgainstProductionOrder.ascx.cs"
    Inherits="Module_Yarn_SalesWork_Controls_YarnIssueAgainstProductionOrder" %>
        ...
        <table class="tdMain" width="100%">
            ...
            <tr>
                <td align="center" class="TableHeader td" width="100%">
                    <b class="titleheading">Invoice Against Customer Request To Depot (Yarn)</b>
                </td>
            </tr>
            <tr>
