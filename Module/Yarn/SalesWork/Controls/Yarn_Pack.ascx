<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Yarn_Pack.ascx.cs" Inherits="Module_Yarn_SalesWork_Controls_Yarn_Pack" %>
...
<table class="tContentArial">
    ...
    <tr>
        <td class="TableHeader td" align="center" width="100%">
            <span class="titleheading"><b>Print Yarn Packing Order
