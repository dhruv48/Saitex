<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Yarn_QC_Checking.ascx.cs"
    Inherits="Module_Yarn_SalesWork_Controls_Yarn_QC_Checking" %>
            ...
            <table align="left" class="tContentArial" width="100%">
                ...
                <tr>
                    <td align="center" class="TableHeader td" width="100%">
                        <span class="titleheading"><b>Yarn QC Checking</b></span>
                    </td>
                </tr>
                <tr>
                            ...
                            <table width="90%">
                                <tr>
                                    ...
                                    <td class="tdRight" width="17%">
                                        <asp:Label ID="Label18" runat="server" CssClass="LabelNo SmallFont" Text=" Yarn Code:"></asp:Label>
                                    </td>
