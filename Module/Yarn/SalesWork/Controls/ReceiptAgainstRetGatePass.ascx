<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ReceiptAgainstRetGatePass.ascx.cs" Inherits="Module_Yarn_SalesWork_Controls_ReceiptAgainstRetGatePass" %>
...
<table class="tdMain" width="100%">
    ...
    <tr>
        <td align="center" class="TableHeader td" width="100%">
            <b class="titleheading">Yarn Receiving Against Gate Pass</b>
        </td>
    </tr>
    <tr>
        ...
        <td width="100%" class="td SmallFont">
            <table width="100%">
                ...
                <tr>
                    ...
                    <td align="left" valign="top" width="17%">
                        <asp:TextBox ID="txtFormType" runat="server" TabIndex="7" Width="150px" CssClass="TextBox SmallFont"
                    ...
                    <td align="left" valign="top" width="17%">
                        <asp:TextBox ID="txtFormRefNo" runat="server" TabIndex="8" Width="150px" CssClass="TextBox SmallFont"
                            MaxLength="15"></asp:TextBox>
                    </td>
                    <td align="right" valign="top" width="17%">
                        Total Amount:
        ...
        <td width="100%" class="td">
            <table width="100%">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtCostCode" runat="server" CssClass="TextBox SmallFont" Width="50px" TabIndex="19"
                            MaxLength="15"></asp:TextBox>
                    </td>
                    <td>
                ...
                <tr>
                    <td colspan="15" class="SmallFont titleheading" >
                        <asp:Button ID="btnSubDetail" TabIndex="21" runat="server" Font-Size="8pt" Text="Sub-Detail" CssClass="SmallFont"
                        ...
                        &nbsp;UOM:<asp:TextBox ID="txtUOm" runat="server" CssClass="TextBoxNo TextBoxDisplay SmallFont"
                            ReadOnly="true" Width="50px"></asp:TextBox>
                             ...
                             <asp:HiddenField ID="txtTareWt" runat="server" />
                              <asp:HiddenField ID="txtCartons" runat="server" /><asp:HiddenField ID="txtNoOfPallet" runat="server"   />
                    </td>
                    <td>
