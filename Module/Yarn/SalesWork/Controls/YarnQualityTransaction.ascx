<%@ Control Language="C#" AutoEventWireup="true" CodeFile="YarnQualityTransaction.ascx.cs" Inherits="Module_Yarn_SalesWork_Controls_YarnQualityTransaction" %>
        ...
        <td align="left" width="100%" valign="top">
            ...
            <table cellpadding="0" cellspacing="0" border="0" width="60%" align="left" class="tContentArial tablebox">
                ...
                <tr>
                    ...
                    <td align="left" valign="top" width="70%">
                        <asp:TextBox ID="txtMstDesc" runat="server" CssClass="gCtrTxt TextBoxDisplay" Width="150px" TabIndex="3"
                            Rows="2" MaxLength="50" TextMode="MultiLine" ReadOnly="True"></asp:TextBox>
                    </td>
                </tr>
            </table>
        </td>
