...
<script type="text/javascript">
    ...
    function assignEventsToCheckboxes() {
        ...
        if(document.getElementById('ChkSelector').checked == null)
        {
...
<table width="100%"  class="tContentArial">
    ...
    <tr>
        <td align="center" class="TableHeader td" width="100">
            <b class="titleheading">Yarn Purchase Order Closing</b>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td align="left" class="td" width="100%">
            <asp:GridView ID="grdPOMST" runat="server"  CallbackMode="false" Serialize="true" AllowAddingRecords="false"
                AutoGenerateColumns="false" AllowRecordSelection="false" AllowFiltering="True" OnRowDataBound="grdPOMST_RowDataBound"
                    ...
                    <asp:TemplateField HeaderText="Confirm Date">
                        <ItemTemplate>
                            <asp:TextBox ID="txtConfirmDate" runat="server" CssClass="TextBox SmallFont " 
                                Text='<%# Bind("CONF_DATE","{0:dd/MM/yyyy}") %>' Width="55px" Height="16px"></asp:TextBox>
