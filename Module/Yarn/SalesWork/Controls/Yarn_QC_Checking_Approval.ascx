<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Yarn_QC_Checking_Approval.ascx.cs"
    Inherits="Module_Yarn_SalesWork_Controls_Yarn_QC_Checking_Approval" %>
...
<table width="100%" align="left" class="tContentArial">
    ...
    <tr>
        <td align="center" class="TableHeader td" width="100%">
            <b class="titleheading">Yarn QC Checking Approval</b>
        </td>
    </tr>
    <tr>
