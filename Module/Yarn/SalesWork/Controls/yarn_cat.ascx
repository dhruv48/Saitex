<%@ Control Language="C#" AutoEventWireup="true" CodeFile="yarn_cat.ascx.cs" Inherits="Module_Yarn_SalesWork_Controls_yarn_cat" %>
    ...
    <tr>
        <td align="left" width="100%" valign="top" class="td">
            ...
            <table cellpadding="0" cellspacing="0" border="0" width="60%" align="left" class="tContentArial tablebox">
                ...
                <tr id="trCategory" visible="false" runat="server">
                    <td align="right" valign="top" width="30%">
                ...
                <tr>
                    ...
                    <td align="left" valign="top" width="70%">
                        <asp:TextBox ID="txtMstDesc" runat="server" CssClass="gCtrTxt" Width="150px" TabIndex="3"
