<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CRQueryYarn.ascx.cs" Inherits="Module_Yarn_SalesWork_Controls_CRQueryYarn" %>
        ...
        <table align="left" class="tContentArial" width="100%">
            ...
            <tr width="100%">
                <td align="center" class="TableHeader td">
                    <b class="titleheading">Customer Request For Yarn Query Form</b>
                </td>
            </tr>
            <tr>
                            ...
                            <tr>
                                ...
                                <td align="left" style="width: 12%;">
                                    <cc2:ComboBox ID="ddlShadeCode" runat="server" AutoPostBack="True" CssClass="smallfont"
                                        DataTextField="MST_CODE" DataValueField="MST_CODE" EnableLoadOnDemand="True"
                                        MenuWidth="150" EnableVirtualScrolling="true" OpenOnFocus="true" TabIndex="5"
                                ...
                                <td align="left" style="width: 4%;">
                                    <asp:Button ID="btnShow" runat="Server" Text="Get Records" OnClick="btnShow_Click" CssClass="AButton" />
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
                        ...
                        <div id="divPrint" runat="server">
                            ...
                            <EmptyDataRowStyle Font-Bold="True" Font-Size="Medium" />
                                <Columns>
                                   ...
                                   <ItemTemplate>
                                   <asp:Label ID="LblArticleNo" Text='<%#Eval("YARN_DESC") %>' ToolTip='<%#Eval("ARTICLE_NO") %>' runat="server"></asp:Label>
                                   </ItemTemplate>
                                   </asp:TemplateField>
