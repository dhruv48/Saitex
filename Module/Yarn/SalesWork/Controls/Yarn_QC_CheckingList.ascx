<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Yarn_QC_CheckingList.ascx.cs"
    Inherits="Module_Yarn_SalesWork_Controls_Yarn_QC_CheckingList" %>
        ...
        <td>
            ...
            <tr>
                <td align="center" class="TableHeader td">
                    <span class="titleheading"><strong>Yarn QC Checking List</strong> </span>
                </td>
            </tr>
            <tr>
                <td align="left">
