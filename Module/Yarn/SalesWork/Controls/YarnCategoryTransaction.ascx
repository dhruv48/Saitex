<%@ Control Language="C#" AutoEventWireup="true" CodeFile="YarnCategoryTransaction.ascx.cs"
    Inherits="Module_Inventory_Controls_YarnCategoryTransaction" %>
                ...
                <tr>
                    ...
                    <td align="left" valign="top" width="70%">
                        <asp:TextBox ID="txtMstDesc" runat="server" CssClass="gCtrTxt TextBoxDisplay" Width="150px" TabIndex="3"
                            Rows="2" MaxLength="100" TextMode="MultiLine" ReadOnly="True"></asp:TextBox>
                    </td>
                </tr>
