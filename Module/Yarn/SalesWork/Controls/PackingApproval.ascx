<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PackingApproval.ascx.cs" Inherits="Module_Yarn_SalesWork_Controls_PackingApproval" %>
...
<table align="left" class="tContentArial" width="100%">
                ...
                <tr>
                    ...
                    <td id="tdDelete" runat="server" align="left">
                        <asp:ImageButton ID="imgbtnDelete" runat="server" Height="41" 
                            ...
                            ImageUrl="~/CommonImages/export.png" onclick="imgBtnExportExcel_Click" TabIndex="7" ></asp:ImageButton>--%>&nbsp;
                    </td>
    ...
    <tr>
        <td align="center" class="TableHeader td" width="100%">
            <b class="titleheading">Dyed Yarn Packing Approval</b>
        </td>
    </tr>
    <tr>
        <td align="left" class="td" valign="top" width="100%">
