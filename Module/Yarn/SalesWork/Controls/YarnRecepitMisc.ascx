<%@ Control Language="C#" AutoEventWireup="true" CodeFile="YarnRecepitMisc.ascx.cs"
    Inherits="Module_Yarn_SalesWork_Controls_YarnRecepitMisc" %>
        ...
        <table class="tdMain tContentArial" width="900px">
            ...
            <tr>
                <td align="center" class="TableHeader td" width="100%">
                    <b class="titleheading">Yarn Receiving Misc.</b>
                </td>
            </tr>
            <tr>
                            ...
                            <td class="tdLeft">                                
                               <cc2:ComboBox ID="cmbShade" runat="server" AutoPostBack="True" CssClass="smallfont"
                                    ...
                                    OpenOnFocus="true" TabIndex="13"
                                                Height="200px" Visible="true" Width="150px" 
                     ...
                     <td>
                        ...
                        <tr>
                            <td colspan="11" cssclass="LabelNo SmallFont tdLeft">
                                <asp:Label ID="Label20" runat="server" CssClass="Label SmallFont" Text="Yarn Code/Desc :"></asp:Label>
