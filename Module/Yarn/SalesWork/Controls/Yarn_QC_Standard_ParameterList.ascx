<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Yarn_QC_Standard_ParameterList.ascx.cs" Inherits="Module_Yarn_SalesWork_Controls_Yarn_QC_Standard_ParameterList" %>
        ...
        <td>
            ...
            <tr>
                <td align="center" class="TableHeader td">
                    <span class="titleheading"><strong>Yarn QC Standard Master List</strong> </span>
                </td>
            </tr>
            <tr>
                <td align="left">
                        ...
                        <asp:GridView ID="grdITEMMasterQuery" runat="server" AutoGenerateColumns="False"
                            ...
                            <asp:TemplateField HeaderText="Inward&nbsp;Type">
                                ...
                                <asp:TemplateField HeaderText="Yarn&nbsp;Category">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblYARN_CATEGORY" runat="server" Text='<%#Eval("YARN_CATEGORY") %>'
                                            ToolTip='<%#Eval("YARN_CATEGORY") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Yarn&nbsp;Code">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblYARN_CODE" runat="server" Text='<%#Eval("YARN_CODE") %>' ToolTip='<%#Eval("YARN_CODE") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Yarn&nbsp;Desc">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblYARN_DESC" runat="server" Text='<%#Eval("YARN_DESC") %>' ToolTip='<%#Eval("YARN_DESC") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
