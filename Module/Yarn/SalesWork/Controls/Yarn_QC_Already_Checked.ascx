<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Yarn_QC_Already_Checked.ascx.cs"
    Inherits="Module_Yarn_SalesWork_Controls_Yarn_QC_Already_Checked" %>
            ...
            <table align="left" class="tContentArial" width="100%">
                ...
                <tr>
                    <td align="center" class="TableHeader td" width="100%">
                        <span class="titleheading"><b>Yarn QC Already Checked</b></span>
                    </td>
                </tr>
                <tr>
                            ...
                            <asp:GridView ID="gvMaterialReceiptApproval" Width="99%" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="QC&nbsp;No" HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <asp:Label ID="lblQC_Year" runat="server" Text='<%#Eval("TRN_YEAR") %>' Visible="false"></asp:Label>
                                    ...
                                    <asp:TemplateField HeaderText="Yarn&nbsp;Code" HeaderStyle-HorizontalAlign="Left"
                                        ItemStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <asp:Label ID="lblYarn_Code" runat="server" CssClass="LabelNo SmallFont" Text='<%# Bind("YARN_CODE") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Yarn&nbsp;Count" HeaderStyle-HorizontalAlign="Left"
                                        ItemStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="QC&nbsp;Value" HeaderStyle-HorizontalAlign="Right"
                                        ItemStyle-HorizontalAlign="Right">
                                        <ItemTemplate>
                                            <asp:Label ID="lblQCValue" runat="server" CssClass="LabelNo SmallFont" Width="90%"
                                                Text='<%# Bind("QC_VALUE") %>' TabIndex="2"></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle Width="10%" />
                                    ...
                                    <asp:TemplateField HeaderText="Remarks" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <asp:Label ID="lblREMARKS" runat="server" Width="97%" MaxLength="200" CssClass="Label SmallFont"
                                                Text='<%# Bind("QC_REMARKS") %>' TabIndex="3"></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle Width="20%" />
