<%@ Control Language="C#" AutoEventWireup="true" CodeFile="StockTransfer.ascx.cs" Inherits="Module_Yarn_SalesWork_Controls_StockTransfer" %>
...
<table class="tdMain" width="100%">
    ...
    <tr>
        <td align="center" class="TableHeader td" width="100%">
            <b class="titleheading">Yarn Stock Transfer</b>
        </td>
    </tr>
    <tr>
                    ...
                    <td width="20%" align="left" valign="top">
                        <cc2:ComboBox ID="txtICODE" runat="server" CssClass="SmallFont" EmptyText="select..."
                            ...
                            <ItemTemplate>
                                ...
                                <div class="item c4">
                                    <asp:Literal runat="server" ID="Container3" Text='<%# Eval("ASS_YARN_DESC") %>' />
                                </div>
                                <div class="item c3">
                                    <asp:Literal runat="server" ID="Literal4" Text='<%# Eval("SHADE_FAMILY") %>' />
                                    </div>
                                    <div class="item c3">
                                    <asp:Literal runat="server" ID="Literal7" Text='<%# Eval("SHADE_CODE") %>' />
                                </div>
                ...
                <tr>
                    <td colspan="7" align="left" valign="top">
                        <asp:TextBox ID="txtDESC" runat="server" CssClass="TextBox TextBoxDisplay SmallFont"
                            ...
                            <asp:HiddenField ID="txtUnitUome" runat="server" />
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Description">
                          ...
                          <asp:TemplateField HeaderText="Shade Family">
                            <ItemTemplate>
                                <asp:Label ID="lblShadeFamily" runat="server" CssClass="Label SmallFont" Text='<%# Bind("SHADE_FAMILY") %>'
                                    ReadOnly="True"></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" />
                            <HeaderStyle HorizontalAlign="Left" />
