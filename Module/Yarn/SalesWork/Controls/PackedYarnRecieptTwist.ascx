<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PackedYarnRecieptTwist.ascx.cs"
    Inherits="Module_Yarn_SalesWork_Controls_PackedYarnRecieptTwist" %>
                ...
                <tr>
                    <td colspan="12" class="SmallFont titleheading" >
                        ...
                        &nbsp; Shade:<asp:TextBox ID="txtShadeCode" runat="server" CssClass="TextBox TextBoxDisplay SmallFont"
                            ...
                            <cc2:ComboBox ID="ddlMachineCode" runat="server" DataTextField="MACHINE_CODE" DataValueField="MACHINE_CODE" Visible="false"
