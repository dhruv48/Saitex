<%@ Control Language="C#" AutoEventWireup="true" CodeFile="loose_yarnpack.ascx.cs" Inherits="Module_Yarn_SalesWork_Controls_loose_yarnpack" %>
...
<table class="tContentArial">
    ...
    <tr>
        <td class="TableHeader td" align="center" width="100%">
            <span class="titleheading"><b>Print loose Packing Order
