<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Po_Unapproval.ascx.cs" Inherits="Module_Yarn_SalesWork_Controls_Po_Unapproval" %>
...
<table width="100%" align="left" class="tContentArial">
    ...
    <tr>
        <td align="center" class="TableHeader td" width="100%">
            <b class="titleheading">Approved Yarn Purchase Order For Unapproval</b>
        </td>
    </tr>
    <tr>
        ...
        <td align="left" class="td" width="100%">
            <asp:GridView ID="gvMaterialpoApproval" CssClass="SmallFont" runat="server" AllowSorting="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Unapproved Date">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Unapproved By">
                        <ItemTemplate>
