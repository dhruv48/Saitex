<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Yrn_Recipt_AdjustmentByLotNo.aspx.cs"
    Inherits="Module_Yarn_SalesWork_Pages_Yrn_Recipt_AdjustmentByLotNo" %>
                  ...
                  <%--  <asp:Panel ID="pnlIndentAdjustment" runat="server" BackColor="#afcae4" Height="400px"
                        ...
                        <asp:GridView ID="grdReceiptAdjustment" runat="server" AutoGenerateColumns="False"
                            ...
                            <asp:TemplateField HeaderText="Trn Date">
                                    <ItemTemplate>
                                        <asp:Label ID="lblTRN_DATE" runat="server" Text='<%# Bind("TRN_DATE","{0:dd/MM/yyyy}") %>'></asp:Label>
