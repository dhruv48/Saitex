<%@ Page Language="C#" MasterPageFile="~/CommonMaster/admin.master" AutoEventWireup="true" CodeFile="YarnPendingIndents.aspx.cs" Inherits="Module_Yarn_SalesWork_Pages_YarnPendingIndents" Title="Untitled Page" %>
                                ...
                                <table class="tContentArial" cellspacing="0" width="10%" cellpadding="0" border="0"
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td width="41">
                                <asp:ImageButton ID="ImageButton1" runat="server" Width="41" Height="41" ToolTip="Print Excel"
                                    ImageUrl="~/CommonImages/export.png" OnClick="imgbtnPrint_Clickexcel"></asp:ImageButton>
                            </td>
...
<td  align="right" width="10%" >
    ...
    <td align ="left" width: 15%">
                        ...
                        DataTextField="YARN_CODE" DataValueField="YARN_CODE" MenuWidth="650px" EnableVirtualScrolling="true"
...
<td  align="right" width="15%" >
    ...
    <asp:Button ID="btnSubmit"  runat="server" CssClass="AButton"  Text=" Get Record "
         ...
         <tr>
            ...
            CellPadding="3"   GridLines="Both" Width="100%" ForeColor="#333333"   OnRowDataBound = "grdrpt_RowDataBound"
            CssClass = "smallfont"   
                    ...
                    <Columns>                   
                        ...
                        <asp:TemplateField HeaderText="Lot No.">
                            <ItemTemplate>
                                <asp:Label ID="lblLotNo" Text='<%#Eval("LOT_NO") %>' runat="server"></asp:Label>
                            </ItemTemplate>
                            <ItemStyle Width="3%" HorizontalAlign="Center" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Quality Description">
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:Label ID="lblDOJ" Text='<%#Eval("YARN_DESC") %>' runat="server"></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Indent Qty.">
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:Label ID="lblQTY_INDENTED" Text='<%#Eval("QTY_INDENTED") %>' runat="server"></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Approved Qty.">
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:Label ID="lblQTY_APPROVED" Text='<%#Eval("QTY_APPROVED") %>' runat="server"></asp:Label>
                            </ItemTemplate>
                            <ItemStyle Width="2%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Pending Qty.">
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:Label ID="lblQTY_PENDING" Text='<%#Eval("QTY_PENDING") %>' runat="server"></asp:Label>
                            </ItemTemplate>
                            <ItemStyle Width="2%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Pending Since (Days)">
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                               <asp:Label ID="lblPENDING_DAYS" Text='<%#Eval("PENDING_DAYS") %>' runat="server"></asp:Label>
                              <%--  <asp:TextBox ID = "txtlblPENDING_DAYS" Text = '<%#Eval("PENDING_DAYS") %>' runat="server" ></asp:TextBox>--%>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Approved By">
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:Label ID="lblApproveby" Text='<%#Eval("PUR_CONF_BY") %>' runat="server"></asp:Label>
                            </ItemTemplate>
                            <ItemStyle Width="3%" HorizontalAlign="Left" />
                        </asp:TemplateField>
