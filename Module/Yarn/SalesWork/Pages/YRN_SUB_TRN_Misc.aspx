<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YRN_SUB_TRN_Misc.aspx.cs"
    Inherits="Module_Yarn_SalesWork_Pages_YRN_SUB_TRN_Misc" %>
                                ...
                                <tr>
                                    ...
                                    <td align="left" valign="top">
                                        <asp:TextBox ID="txtNoofUnit" runat="server" class="SmallFont" Width="70px" AutoPostBack="True"
                                            OnTextChanged="txtNoofUnit_TextChanged"  TabIndex="3"></asp:TextBox>
                                       ...
                                       <td align="left" valign="top">
                                        <asp:TextBox ID="txtGrossWt" Width="70px" class="SmallFont" runat="server" AutoPostBack="True"
                                             MaxLength="6"  TabIndex="4" ontextchanged="txtGrossWt_TextChanged"></asp:TextBox>
                                        ...
                                        <asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="txtGrossWt"
                                            ...
                                            <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server"  TargetControlID="txtGrossWt"   FilterType="Custom, Numbers" ValidChars="." />
                                                                                   ...
                                                                                   <td align="left" valign="top">
                                        <asp:TextBox ID="txtTareWt" Width="70px" class="SmallFont" runat="server" AutoPostBack="True"  TabIndex="5"
                                            MaxLength="6" ontextchanged="txtTareWt_TextChanged"></asp:TextBox>
                                    ...
                                    <td align="left" valign="top">
                                        <asp:TextBox ID="txtQty" Width="70px" class="SmallFont" runat="server" AutoPostBack="True"
                                            OnTextChanged="txtQty_TextChanged" MaxLength="6"  TabIndex="6"></asp:TextBox>
