<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Yrn_PO_Return_Adjustment.aspx.cs" Inherits="Module_Yarn_SalesWork_Pages_Yrn_PO_Return_Adjustment" %>
                  ...
                  <%--  <asp:Panel ID="pnlIndentAdjustment" runat="server" BackColor="#afcae4" Height="400px"
                        ...
                        <asp:GridView ID="grdReceiptAdjustment" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Prty Challan">
                                    <ItemTemplate>
                                        <asp:Label ID="lblDyedBatch" runat="server" Text='<%# Bind("PRTY_CH_NUMB") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                 <asp:TemplateField HeaderText="Bill Num">
                                    <ItemTemplate>
                                        <asp:Label ID="lblbillnumb" runat="server" Text='<%# Bind("BILL_NUMB") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
