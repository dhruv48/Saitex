<%@ Page Language="C#" MasterPageFile="~/CommonMaster/admin.master" AutoEventWireup="true"
    CodeFile="YarnMaster_Opening_Party.aspx.cs" Inherits="Module_Yarn_SalesWork_Pages_YarnMaster_Opening_Party"
            ...
            <table>
                <tr>
                        ...
                        <table align="left" class="tContentArial">
                            ...
                            <tr>
                                <td align="center" class="TableHeader td">
                                    <span class="titleheading"><b>Yarn Opening (Jobwork Party)</b></span>
                                </td>
                            </tr>
                            <tr>
                                <td align="left" class="td" valign="top">
                                ...
                                <td class="td" width="100%">
                                    <table width="100%">
                                        ...
                                        <cc2:ComboBox ID="ddlyarncode" runat="server" AutoPostBack="True" CssClass="SmallFont"
                                                    ...
                                                    Height="200px" MenuWidth="650" OnLoadingItems="ddlyarncode_LoadingItems" OnSelectedIndexChanged="ddlyarncode_SelectedIndexChanged1" EnableVirtualScrolling="true"
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <%--<div class="item c3">
                                                            ...
                                                            <div class="item c3">
                                                            <asp:Literal ID="Container2" runat="server" Text='<%# Eval("ASS_YARN_DESC") %>' /></div>
                 ...
                 <td  width="5%" class="tdLeft SmallFont"> 
                  ...
                  <td  width="5%" class="tdLeft SmallFont"> 
                  <span class="titleheading"><b>JOBER</b></span>
                 </td>
                 <td  width="5%" class="tdLeft SmallFont"> 
