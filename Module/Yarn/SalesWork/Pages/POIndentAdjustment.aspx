                        ...
                        <td class="tdCenter td SmallFont">
                            <asp:Panel ID="pnlIndentAdjustment" runat="server" ScrollBars="Vertical" Height="200px"
                                ...
                                <asp:GridView ID="grdIndentAdjustment" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                     <asp:TemplateField HeaderText="Indent Year">
                                            <ItemTemplate>
                                                <asp:Label ID="lblYear" CssClass="SmallFont Label" runat="server"        Text='<%# Bind("YEAR") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Indent Number">
                                         ...
                                         <asp:TemplateField HeaderText="LOT NO.">
                                            <ItemTemplate>
                                                <asp:Label ID="lblLotNo" CssClass="SmallFont Label" runat="server" ToolTip='<%# Bind("LOT_NO") %>'
                                                    Text='<%# Bind("LOT_NO") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                         <asp:TemplateField HeaderText="GRADE">
                                            <ItemTemplate>
                                                <asp:Label ID="lblGRADE" CssClass="SmallFont Label" runat="server" ToolTip='<%# Bind("GRADE") %>'
                                                    Text='<%# Bind("GRADE") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                          <asp:TemplateField HeaderText="Shade Family">
                                            <ItemTemplate>
                                                <asp:Label ID="lblShadeFamily" CssClass="SmallFont Label" runat="server" ToolTip='<%# Bind("SHADE_FAMILY") %>'
