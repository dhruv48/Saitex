<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YARN_OP_BAL_LOT_DETAILS.aspx.cs" Inherits="Module_Appaerals_Pages_YARN_OP_BAL_LOT_DETAILS" %>
                ...
                <table width="100%">
                    <tr>
                        <td align="center" class="td TableHeader" valign="top">
                            <strong class="titleheading">Sub Transaction of Yarn Opening :<asp:Label
                    ...
                    <tr>
                        <td align="center" class="td TableHeader" valign="top">
                         <strong class="titleheading">Lot NO :
                                <asp:Label ID="lblShowLotNO" runat="server"></asp:Label></strong>
                                &nbsp;
                                &nbsp;
                            ...
                            <table width="100%">
                                <tr bgcolor="#006699">
                                 <td align="left" class="tdLeft SmallFont" valign="top">
                                    ...
                                    <td align="left" class="tdLeft SmallFont" valign="top">
                                        <span class="titleheading"><b>Cheeses</b></span>
                                    </td>
                                    <td align="left" class="tdLeft SmallFont" valign="top">
                                ...
                                <tr>
                                  ...
                                  <td align="left" valign="top">
                                    ...
                                    <td align="left" valign="top">
                                        <asp:TextBox ID="txtGrade" class="SmallFont uppercase" Width="30px" runat="server"  TabIndex="3"></asp:TextBox>
                                        <br />
                                    </td>
                                    ...
                                    <td align="left" valign="top">
                                       ...
                                       <td align="left" valign="top">
                                        <asp:TextBox ID="txtGrossWt" Width="60px" class="SmallFont" runat="server" AutoPostBack="True"
                                             MaxLength="10"  TabIndex="5" ontextchanged="txtGrossWt_TextChanged"></asp:TextBox>
                                        ...
                                        <asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="txtGrossWt"
                                            ...
                                            <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server"  TargetControlID="txtGrossWt"   FilterType="Custom, Numbers" ValidChars="." />
                                                                                   ...
                                                                                   <td align="left" valign="top">
                                        <asp:TextBox ID="txtTareWt" Width="50px" class="SmallFont" runat="server" AutoPostBack="True"  TabIndex="6"
                                            MaxLength="10" ontextchanged="txtTareWt_TextChanged"></asp:TextBox>
                                    ...
                                    <td align="left" valign="top">
                                        <asp:TextBox ID="txtQty" Width="60px" class="SmallFont" runat="server" AutoPostBack="True"
                                            OnTextChanged="txtQty_TextChanged" MaxLength="10"  TabIndex="7"></asp:TextBox>
                                    ...
                                    <td align="left" valign="top">
                                        <asp:DropDownList ID="ddlUOM" class="SmallFont" runat="server"  TabIndex="8">
                                        </asp:DropDownList>
                                    </td>
                                    <td align="left" valign="top">
                                        <asp:TextBox ID="txtWeightofUnit" class="SmallFont" runat="server" Width="60px" Enabled="False"  TabIndex="9"></asp:TextBox>
                                    ...
                                    <td align="left" valign="top">
                                        <asp:TextBox ID="txtBarCode" class="SmallFont" runat="server" Width="70px"  TabIndex="10"></asp:TextBox>
                                        
                                    </td>
                                  <td align="left" valign="top">
                                       <asp:CheckBox ID="isPallet" runat="server" Checked="false"  Text=""  TabIndex="11" />
