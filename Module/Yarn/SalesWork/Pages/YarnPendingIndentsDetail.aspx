<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YarnPendingIndentsDetail.aspx.cs" Inherits="Module_Yarn_SalesWork_Pages_Yarn_Pending_Indents_Detail" %>
                ...
                <asp:GridView ID="gvPendIndDetails" runat="server" AllowPaging="False" PagerSettings-Position="Bottom"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Shade Family">
                            <ItemTemplate>
                                <asp:Label ID="lbllocation" Text='<%#Eval("SHADE_FAMILY")%>' runat="server"></asp:Label>
                            </ItemTemplate>
                            <ItemStyle Width="200px" HorizontalAlign="Left" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Shade Code">
                            <ItemTemplate>
                                <asp:Label ID="lbllocation" Text='<%#Eval("SHADE_CODE")%>' runat="server"></asp:Label>
                            </ItemTemplate>
                            <ItemStyle Width="200px" HorizontalAlign="Left" />
                        </asp:TemplateField>
