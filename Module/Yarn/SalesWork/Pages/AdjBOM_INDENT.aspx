<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdjBOM_INDENT.aspx.cs" Inherits="Module_Yarn_SalesWork_Pages_AdjBOM_INDENT" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Adjust Yarn BOM</title>
                ...
                <table class="tContentArial" style="background-color: #afcae4">
                    <tr>
                        <td class="TableHeader td tdCenter">
                            <span class="titleheading">Adjust Yarn BOM</span>
                        </td>
                    </tr>
                    <tr>
