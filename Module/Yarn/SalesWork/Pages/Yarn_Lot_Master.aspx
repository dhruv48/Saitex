<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CommonMaster/admin.master" CodeFile="Yarn_Lot_Master.aspx.cs" Inherits="Module_Yarn_SaleWork_Pages_Yarn_Lot_Master" %>
                 ...
                 <%--   added by Nishant rai at 26/07/2013--%>
                    ...
                    <tr>
                        ...
                        <cc2:ComboBox ID="txtPartyCode" runat="server"  EnableLoadOnDemand="true"
                            ...
                            EnableVirtualScrolling="true" Width="150px" MenuWidth="700px" Height="200px" TabIndex="5" AutoPostBack="true" >
                            <HeaderTemplate>
                                <div class="header c1">
                                   Party Code</div>
                                <div class="header c3">
