...
using Common;
using System.Data;
public partial class Module_Yarn_SalesWork_Reports_Default : System.Web.UI.Page
{
    ...
    private void BindStockAgeingGrid()
    {
        try
        {
            ...
            if (CheckValidation())
            {
                ...
                DataTable dt = SaitexBL.Interface.Method.YRN_PROD_MST.GetYarnStockAgingReport(oUserLoginDetail.COMP_CODE, strBranch, strItemType, strCatCode, iDay1, iDay2, iDay3,LOCATION,STORE);
                if (dt != null && dt.Rows.Count > 0)
                {
