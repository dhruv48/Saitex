<%@ Page Title="" Language="C#" MasterPageFile="~/CommonMaster/admin.master" AutoEventWireup="true" CodeFile="YarnItemStockAgeingQuery.aspx.cs" Inherits="Module_Yarn_SalesWork_Reports_Default" %>
        ...
        <table class="td tContent" style="width: 945px">
            ...
            <tr>
                <td class="TableHeader td" align="center">
                    <span class="titleheading">Yarn Stock Ageing</span>
                </td>
            </tr>
            <tr>
                <td class="tdLeft td">
            ...
            <tr>
                <td>
                    <table style="width: 945px">
                        ...
                        <tr>
                         <td class="tdRight">
                                <asp:Label ID="Label3" runat="server" Text="Yarn Type :" CssClass="Label"></asp:Label>
                            </td>
                            <td class="tdLeft">
                               ...
                               <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" Width="100%" />
                                ...
                                <Columns>
                                    <asp:BoundField DataField="BRANCH_NAME" HeaderText="Branch"    HeaderStyle-HorizontalAlign ="Left" ItemStyle-HorizontalAlign ="Left" />
                                     ...
                                     <asp:BoundField DataField="STORE" HeaderText="Store"    HeaderStyle-HorizontalAlign ="Left" ItemStyle-HorizontalAlign ="Left" />
                                     <asp:BoundField DataField="YARN_CODE" HeaderText="Yarn Code"  HeaderStyle-HorizontalAlign ="Left" ItemStyle-HorizontalAlign ="Left" />                                     <asp:BoundField DataField="YARN_DESC" HeaderText="Yarn Description" HeaderStyle-HorizontalAlign ="Left" ItemStyle-HorizontalAlign ="Left" />
