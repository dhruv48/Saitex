<%@ Page Language="C#" MasterPageFile="~/CommonMaster/admin.master" AutoEventWireup="true" CodeFile="YRN_ReceiptPermRPT.aspx.cs" Inherits="Module_Yarn_SalesWork_Reports_YRN_ReceiptPermRPT" Title="Untitled Page" %>
        ...
        <tr>
            <td class="td">
                <table>
                    ...
                    <tr>
                    <td  class="tdRight"> <asp:Label ID="lblCorton" runat="server"> Carton Report</asp:Label></td>
                    <td class="tdLeft"> <asp:CheckBox ID="CBCorton" runat="server"  Checked="false" AutoPostBack="true" OnCheckedChanged="CBCorton_CheckedChanged"/>
                    </td>
                    </tr>

                     <tr>
                    <td  class="tdRight"> <asp:Label ID="lblList" runat="server"> List Report</asp:Label></td>
                    <td class="tdLeft"> <asp:CheckBox ID="CBList" runat="server"  Checked="false" AutoPostBack="true" OnCheckedChanged="CBList_CheckedChanged"/>
                    </td>
                    </tr>
