<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RequestY.aspx.cs" Inherits="Module_Yarn_SalesWork_Queries_RequestY" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Sainath Texport Ltd. :: Receipt Details</title>
...
<body bgcolor="#afcae4"">
    ...
    <table border="1" cellpadding="3" cellspacing="0" width="100%" class="tContentArial"
        ...
        <tr>
            <td colspan="4">
                <asp:GridView ID="gvReceiptDetails"   runat="server"  
            ...
            CssClass = "smallfont"   
                    PagerStyle-HorizontalAlign="Left" onpageindexchanging="gvReceiptDetails_PageIndexChanging"                   
