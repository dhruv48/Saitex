<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IssueY.aspx.cs" Inherits="Module_Yarn_SalesWork_Queries_IssueY" %>
...
<body bgcolor="#afcae4"">
    ...
    <table border="1" cellpadding="3" cellspacing="0" width="100%" class="tContentArial"
        ...
        <td width="30%">
            ...
            <td width="50%">
                Quality Description : <asp:Label ID="lblItemDesc"  Font-Bold=true runat="server"></asp:Label>
            </td>
