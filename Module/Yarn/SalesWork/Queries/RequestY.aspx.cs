...
public partial class Module_Yarn_SalesWork_Queries_RequestY : System.Web.UI.Page
{
    ...
    private void Load_Item_Receipt_Data()
    {
        ...
        {
            STORE = " and M.STORE='" + Request.QueryString["STORE"] + "'";
        }
        else
        {
            STORE = "";
        ...
        try
        {
            ...
            DataTable Dtable = SaitexBL.Interface.Method.YRN_IR_MST.Load_Item_Receipt_Data(branch, yarncode, yr, Transtype, sdate, edate, Comp_Code,shade_family,shade,STORE);
