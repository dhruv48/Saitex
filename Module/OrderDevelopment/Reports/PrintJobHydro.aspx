<%@ Page Title="" Language="C#" MasterPageFile="~/CommonMaster/admin.master" AutoEventWireup="true" CodeFile="PrintJobHydro.aspx.cs" Inherits="Module_OrderDevelopment_Reports_PrintJobHydro" %>
            ...
            <td class="td">
                <table>
                    <tr>
                        ...
                        <td class="tdLeft">
                            <asp:TextBox ID="txtFDATE" CssClass="TextBoxNo SmallFont" runat="server" ValidationGroup="M1"></asp:TextBox>
                        ...
                        <td class="tdLeft">
                            <asp:TextBox ID="txtTDATE" CssClass="TextBoxNo SmallFont" runat="server" ValidationGroup="M1"></asp:TextBox>
