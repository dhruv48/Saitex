                    ...
                    <tr>
                        ...
                        <td class="tdLeft">
                            ...
                            <asp:DropDownList ID="ddlProductType" runat="server" AutoPostBack="True" MenuWidth="200px"
                                Width="98%" Visible="true" OnSelectedIndexChanged="ddlProductType_SelectedIndexChanged">
                                <asp:ListItem Value="IYS26" > SALE WORK</asp:ListItem>
                                <asp:ListItem Value="IYS27" > JOB WORK</asp:ListItem>
                                 <asp:ListItem Value="IYS29" > FROM STOCK</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
