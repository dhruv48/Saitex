<%@ Page Title="" Language="C#" MasterPageFile="~/CommonMaster/admin.master" AutoEventWireup="true" CodeFile="MachineWiseData.aspx.cs" Inherits="Module_OrderDevelopment_Reports_MachineWiseData" %>
      ...
      <table class="td tContentArial" width="95%">
            <tr>
                <td class="td tContentArial">
                  ...
                  <td id="tdPrint" runat="server" align="left" width="48">
                                <asp:ImageButton ID="imgbtnPrint" runat="server" Height="41" ImageUrl="~/CommonImages/print.jpg"
            ...
            <tr class="TableHeader">
                <td align="center" valign="top" class="td">
                    <span class="titleheading"><b>Machine Planning Report</b></span>
                </td>
            </tr>
            <tr>
                <td class="td">
                        ...
                        <tr>
                            ...
                            <td align="left" valign="top">
                                <asp:DropDownList ID="ddlmachine" runat="server" CssClass="SmallFont TextBox UpperCase"
                                    TabIndex="3" Width="120px" OnSelectedIndexChanged="ddlmachine_SelectedIndexChanged">
