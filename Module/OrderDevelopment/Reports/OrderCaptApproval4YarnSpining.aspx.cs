...
public partial class Module_OrderDevelopment_Reports_OrderCaptApproval4YarnSpining : System.Web.UI.Page
{
    ...
    private void SetFromAndTo()
    {
        try
        {
           ...
           OrderPrefix = OrderNo.Substring(0, 6);
            //OrderPrefix = OrderNo.Substring(6, 6);
            int ii = int.Parse(OrderNo.Substring(6)) - 1;
            //int ii = (int.Parse(OrderPrefix)-1);
