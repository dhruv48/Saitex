<%@ Page Title="" Language="C#" MasterPageFile="~/CommonMaster/admin.master" AutoEventWireup="true" CodeFile="YarnDyeingApprovalReport.aspx.cs" Inherits="Module_OrderDevelopment_Reports_YarnDyeingApprovalReport" %>
...
<table align="left">
            ...
            <td class="tdRight" >
            <asp:Label CssClass="Label SmallFont" Text="Business Type" runat="server"></asp:Label>
            </td>
            <td>
