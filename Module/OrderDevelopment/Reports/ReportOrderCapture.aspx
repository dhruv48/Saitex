<%@ Page Title="" Language="C#" MasterPageFile="~/CommonMaster/admin.master" AutoEventWireup="true" CodeFile="ReportOrderCapture.aspx.cs" Inherits="Module_OrderDevelopment_Reports_ReportOrderCapture" %>
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td class="style1 tdLeft" width="98%" >
                            <cc3:OboutDropDownList ID="ddlBusinessType" runat="server" AutoPostBack="True" 
                                MenuWidth="200px" OnSelectedIndexChanged="ddlBusinessType_SelectedIndexChanged">
                    ...
                    <tr>
                        ...
                        <cc3:OboutDropDownList ID="ddlProductType" runat="server" AutoPostBack="True" 
                                MenuWidth="200px" OnSelectedIndexChanged="ddlProductType_SelectedIndexChanged">
                        </cc3:OboutDropDownList>
                        </td>
