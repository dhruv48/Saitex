<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RecipeEntry.ascx.cs" Inherits="Module_OrderDevelopment_LabDip_Controls_RecipeEntry" %>
...
<table class="tContentArial">
    ...
    <tr>
        <td align="center" valign="top" class="tRowColorAdmin td">
            <span class="titleheading">Recipe Entry Report</span>
        </td>
    </tr>
