<%@ Control Language="C#" AutoEventWireup="true" CodeFile="LRApproval.ascx.cs" Inherits="Module_OrderDevelopment_LabDip_Controls_LRApproval" %>
        ...
        <table class="tContentArial">
            ...
            <tr class="TableHeader">
                <td align="center" valign="top" class="td">
                    <span class="titleheading">LR Approval</span>
                </td>
            </tr>
            <tr>
                <td class="tdLeft td">
