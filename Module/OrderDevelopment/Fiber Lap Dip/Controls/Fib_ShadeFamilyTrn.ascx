<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Fib_ShadeFamilyTrn.ascx.cs" Inherits="Module_OrderDevelopment_Fiber_Lap_Dip_Controls_Fib_ShadeFamilyTrn" %>
