<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Fib_LabDipSubmission.ascx.cs" Inherits="Module_OrderDevelopment_Fiber_Lap_Dip_Controls_Fib_LabDipSubmission" %>
        ...
        <table class="tContentArial">
            ...
            <tr class="TableHeader">
                <td align="center" valign="top" class="td">
                    <span class="titleheading">Lab Dip Submission & Recipe Entry</span>
                </td>
            </tr>
            <tr>
                <td class="tdLeft td">
            ...
            <tr>
                <td class="td">
                    <table>
                        <tr>
                            <td class="tdRight">Customer Req. No. :
                            </td>
                            <td class="tdLeft">
                                <cc2:ComboBox ID="ddlOrderNo" runat="server" AutoPostBack="True" CssClass="smallfont"
                                    ...
                                    EmptyText="Select CR No" MenuWidth="450px" OnLoadingItems="ddlOrderNo_LoadingItems"
                            ...
                            <td class="tdRight">Submission Date :
                            </td>
                            <td class="tdLeft">
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0" width="100%">
                                    <tr bgcolor="#336699" class="titleheading">
                                        ...
                                        <td id="trQuality" runat="server">Quality
                                        </td>
                                        <td>Recipe
                                        </td>
                                        <td>Recipe Cost
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:TextBox ID="ddlShade" CssClass="SmallFont TextBox UpperCase" runat="server"
                                                ValidationGroup="M1" Width="100px"></asp:TextBox>
                                            <div id="divwidth">
                                            </div>
                                        ...
                                        <td>
                                            <cc2:ComboBox ID="txtLotNo" runat="server" EnableLoadOnDemand="true"
                                                ...
                                                EmptyText="Lot No"
                                                EnableVirtualScrolling="true" Width="110px" MenuWidth="300px" Height="200px" TabIndex="28" style="top: 0px; left: 0px">
                                                <HeaderTemplate>
                                                    <div class="header c5">
                                                        Lot No
                                                    </div>
                                                ...
                                                <ItemTemplate>
                                                    <div class="item c5">
                                                        <asp:Literal runat="server" ID="Container1" Text='<%# Eval("LOT_NO") %>' />
                                                    </div>
                                                    <div class="item c5">
                                                        <asp:Literal runat="server" ID="Container2" Text='<%# Eval("FIBER_CODE") %>' />
                                                    </div>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    Displaying items
                                ...
                                <%# Container.ItemsCount %>.
                                        ...
                                        <td>
                                            <asp:Button ID="btnDyeName" runat="server" Text="Dye & Dose" Width="90px" TabIndex="16"
                                                ValidationGroup="M1" OnClick="btnDyeName_Click"></asp:Button>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtRecipeCost" runat="server" TabIndex="17" CssClass="TextBoxNo TextBoxDisplay"
                                                Width="70px" OnTextChanged="txtRecipeCost_TextChanged" ReadOnly="True"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtDepth" runat="server" TabIndex="18"
                                                CssClass="TextBoxNo TextBoxDisplay" Width="70px"
                                                OnTextChanged="txtDepth_TextChanged" ReadOnly="True"></asp:TextBox>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="tdRight">Quality Description :
                                        </td>
                                        <td class="tdLeft" colspan="7">
                                            <%--<asp:TextBox ID="TextBox1" runat="server" CssClass="TextBox TextBoxDisplay"
