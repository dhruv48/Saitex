<%@ Control Language="C#" AutoEventWireup="true" CodeFile="fiberShadeFamilyMaster.ascx.cs" Inherits="Module_OrderDevelopment_Fiber_Lap_Dip_Controls_fiberShadeFamilyMaster" %>
