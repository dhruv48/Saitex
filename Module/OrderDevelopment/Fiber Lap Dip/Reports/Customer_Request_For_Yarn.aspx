<%@ Page Language="C#" MasterPageFile="~/CommonMaster/UserMaster.master" AutoEventWireup="true" CodeFile="Customer_Request_For_Yarn.aspx.cs" Inherits="Module_OrderDevelopment_LabDip_Reports_Customer_Request_For_Yarn" Title="Untitled Page" %>
                        ...
                        <table align="left" class="tContentArial">
                            <tr>
                                <td align="center" class="TableHeader" colspan="4">
                                    <span style="font-size: 13pt" class="titleheading"><strong>Customer Request For Yarn (Lab Dip)</strong> </span>
                                </td>
                            </tr>
                            <tr>
                              <td >Business Type : 	</td>
                              ...
                              <td>  
                                   ...
                                   <asp:DropDownList ID="ddlReportFor"  runat="server" AutoPostBack="true" 
                                    CssClass="SmallFont" Width="150px" TabIndex="2" onselectedindexchanged="ddlReportFor_SelectedIndexChanged" 
                                      >
