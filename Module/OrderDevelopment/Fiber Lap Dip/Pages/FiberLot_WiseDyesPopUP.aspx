<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FiberLot_WiseDyesPopUP.aspx.cs" Inherits="Module_OrderDevelopment_Fiber_Lap_Dip_Pages_FiberLot_WiseDyesPopUP" %>
            ...
            <ContentTemplate>
                <table>
                        ...
                        <td class="td tdLeft">
                            <table>
                                <tr bgcolor="#006699">
                                    ...
                                    <td align="left" class="tdLeft SmallFont" valign="top">
                                        <span class="titleheading"><b>Marge No/Lot</b></span>
                                    </td>
                                    ...
                                    <td align="left" colspan="7" valign="top">
                                        <asp:GridView ID="grdDyeName" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                            ...
                                            <asp:TemplateField HeaderText="" Visible="true">
                                                    <ItemTemplate>
                                                       <asp:CheckBox id=chkDose runat="server"    />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                    ...
                    <td>
                      ...
                      <asp:Button ID="bntAdd" runat="server" Text="Increase" OnClick="btnAdd_Click"/>
                      <asp:Button ID="bntDel" runat="server" Text="Decrease" OnClick="btnDel_Click"/>
                    </td >
