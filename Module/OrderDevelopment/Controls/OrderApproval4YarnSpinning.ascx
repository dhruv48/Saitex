<%@ Control Language="C#" AutoEventWireup="true" CodeFile="OrderApproval4YarnSpinning.ascx.cs" Inherits="Module_OrderDevelopment_Controls_OrderApproval4YarnSpinning" %>
...
<script type="text/javascript">
    ...
    function openPopup() {
        ...
        window.open("../../../Module/Production/Pages/Raw_Finish_Availablilty.aspx", "_blank", "WIDTH=1200,HEIGHT=790,scrollbars=no, menubar=no,resizable=yes,directories=no,location=no");
    ...
    <ContentTemplate>--%>
        <table class="td tContentArial" width="95%">
            <tr>
                <td class="td tContentArial">
                    <table style="width: 262px">                    
                        <tr>
                            <td id="tdUpdate" runat="server" class="style1">
                            ...
                            <td id="td1" runat="server" align="left" width="48">
                                <asp:ImageButton ID="Imgbtnforward" runat="server" Height="41" ImageUrl="~/CommonImages/forward.jpg"
                                    ToolTip="Print" Width="48" onclick="imgbtnforward_Click" />
                            </td>
            ...
            <tr class="TableHeader">
                <td align="center" valign="top" class="td">
                    <span class="titleheading"><b> <asp:Literal ID=ltrProductType runat="server"></asp:Literal> Production Order Approval</b></span>
                </td>
            </tr>
            <tr>
                <td class="td">
                    <table width="100%">
                        <tr>
                            ...
                            <td align="left" valign="top">
                                <asp:TextBox ID="txtOrderNo" runat="server" CssClass="TextBox" TabIndex="1" MaxLength="12" Width="150px"></asp:TextBox>
                            </td>
                            <td align="right" valign="top">
                                Party Code :
                            </td>
                            <td align="left" valign="top">
                                <uc1:PartyCodeLOV ID="ddlprtycode" runat="server" TabIndex="4" Width="150px" />
                            </td>
                            <td align="right" valign="top">
                                Order Type :
                            </td>
                            <td align="left" valign="top">
                                <asp:DropDownList ID="ddlordertype" runat="server" TabIndex="3" Width="150px" CssClass="SmallFont TextBox UpperCase">
                                </asp:DropDownList>
                                <asp:LinkButton ID="lnkStock" runat="server" Text="Stock" onclientclick="return openPopup()" 
                                    ></asp:LinkButton>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td align="left" valign="top">
                                <asp:TextBox ID="TxtFdate" runat="server" CssClass="TextBox" TabIndex="5" Width="150px"></asp:TextBox>
                            </td>
                            <td align="right" valign="top">
                                To Date:
                            </td>
                            <td align="left" valign="top">
                                <asp:TextBox ID="TxtTdate" runat="server" CssClass="TextBox" TabIndex="4" Width="150px"></asp:TextBox>
                            </td>
                            <td align="right">
                                Status:
                            </td>
                            ...
                            <td align="left" valign="top">
                                <asp:DropDownList ID="ddlStatus" runat="server" CssClass="SmallFont TextBox UpperCase"
                                    ...
                                    <asp:ListItem Selected="True">Un-Approved</asp:ListItem>
            ...
            <tr>
                <td class="td" width="100%">
                    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Refresh Grid Data"
                        ...
                        <span class="titleheading">
                            <asp:GridView ID="OrderCapt_Grid" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="ASS.ARTICAL&nbsp;DESC" ItemStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="View SO" ItemStyle-HorizontalAlign="Left">
                                        <ItemTemplate>                                           
                                    ...
                                    <asp:TemplateField HeaderText="COST" ItemStyle-HorizontalAlign="Left" Visible="false">
                                        <ItemTemplate>
        ...
        <cc1:MaskedEditExtender ID="MaskedEditExtender2" runat="server" Mask="99/99/9999"
         ...
         <cc1:MaskedEditExtender ID="MaskedEditExtender1" runat="server" Mask="99/99/9999"
            MaskType="Date" TargetControlID="TxtFdate" PromptCharacter="_">
        </cc1:MaskedEditExtender>
<%--    </ContentTemplate>
</asp:UpdatePanel>--%>