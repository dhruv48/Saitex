...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="OC_YARN_SPINING.ascx.cs" Inherits="Module_OrderDevelopment_Controls_OC_YARN_SPINING" %>
...
<%--<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>--%>
                        ...
                        <tr>
                            ...
                            <td class="tdLeft" width="12%">
                                <cc2:ComboBox ID="txtPartyCodecmb" runat="server" AutoPostBack="True" EnableLoadOnDemand="true"
                                    ...
                                    EnableVirtualScrolling="true" Width="150px" MenuWidth="500px" Height="200px" TabIndex="5">
                                    <HeaderTemplate>
                                        <div class="header c1">
                                            Code</div>
                                        <div class="header c3">
                ...
                <td width="100%" class="td">
                    <table width="100%">
                        <tr>
                            ...
                            <td class="tdLeft" width="12%">
                                <uc1:PartyCodeLOV ID="ddlConsignee" runat="server" TabIndex="6" />
                            </td>
                            <td class="tdRight" width="12%">
                        ...
                        <tr>
                            ...
                            <td class="tdLeft" width="88%">
                                <asp:TextBox ID="txtRemarks" runat="server" CssClass="TextBox SmallFont" Width="100%"
                                    MaxLength="2000" TabIndex="7"> </asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="tdRight" width="12%">
                            ...
                            <td class="tdLeft" width="88%">
                                <asp:TextBox ID="txtGenInstruction" runat="server" CssClass="TextBox SmallFont" Width="100%"
                                    MaxLength="800" TabIndex="8"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="tdRight" width="12%">
                            ...
                            <td class="tdLeft" width="88%">
                                <asp:TextBox ID="txtSplInstruction" runat="server" CssClass="TextBox SmallFont" Width="100%"
                                    MaxLength="800" TabIndex="9"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                </td>
                            ...
                            <FooterTemplate>
                                ...
                                <%# Container.ItemsCount %>.
                                        ...
                                        <td  align="center">
                                            ...
                                            <asp:Button ID="btnTrnCancel" runat="server" Text="Cancel" OnClick="btnTrnCancel_Click" TabIndex="15" CssClass="SmallFont" Width="60px"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Shade Code">
                                               ...
                                               <asp:TemplateField HeaderText="LAB DIP NO">
                                                <ItemTemplate>
                                                    <asp:Label ID="txtLabDipNo" runat="server" CssClass="LabelNo SmallFont"
                                                        Text='<%# Bind("LAB_DIP_NO") %>'></asp:Label></ItemTemplate>
                                                <ItemStyle VerticalAlign="Top" HorizontalAlign="Left" />
                                                <HeaderStyle VerticalAlign="Top" HorizontalAlign="Left" />
                                            </asp:TemplateField>
                                             <asp:TemplateField HeaderText="Grey Lot No">
                                                <ItemTemplate>
                                                    <asp:Label ID="txtGreyLotNo" runat="server" CssClass="LabelNo SmallFont"
                                                        Text='<%# Bind("GREY_LOT_NO") %>'></asp:Label></ItemTemplate>
                                                <ItemStyle VerticalAlign="Top" HorizontalAlign="Left" />
                                                <HeaderStyle VerticalAlign="Top" HorizontalAlign="Left" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Order Quantity">
                                             ...
                                             <asp:TemplateField HeaderText="Remarks">
                                                <ItemTemplate>
                                                    <asp:Label ID="txtTRNYyarnRemarks" runat="server" CssClass="LabelNo SmallFont"
                                                        Text='<%# Bind("REMARKS") %>'></asp:Label></ItemTemplate>
                                                <ItemStyle VerticalAlign="Top" HorizontalAlign="Right" />
                                                <HeaderStyle VerticalAlign="Top" HorizontalAlign="Right" />
                                            </asp:TemplateField>
        ...
        <cc1:CalendarExtender ID="cetxtDeliverySchedule" 
