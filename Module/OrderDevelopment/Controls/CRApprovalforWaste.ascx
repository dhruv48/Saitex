<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CRApprovalforWaste.ascx.cs" Inherits="Module_OrderDevelopment_Controls_CRApprovalforWaste" %>
...
Sales Contract Approval for Waste
</b>
</td>
</tr>
<tr>
...
<Columns>
                                ...
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Right" HeaderText="Waste">
                                    <HeaderTemplate>
                                        <table width="100%">
                                            <tr>
                                                <td colspan="2" width="100%">
                                ...
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Shade Code" Visible="false">
                                    <HeaderTemplate>
                                        <table width="100%">
                                            <tr>
                                                <td colspan="2" width="100%">
