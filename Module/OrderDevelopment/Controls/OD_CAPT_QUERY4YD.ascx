<%@ Control Language="C#" AutoEventWireup="true" CodeFile="OD_CAPT_QUERY4YD.ascx.cs" Inherits="Module_OrderDevelopment_Controls_OD_CAPT_QUERY4YD" %>
...
<table align="left" class="tContentArial" width="970px">
    ...
    <tr>
        <td align="center" class="TableHeader td" width="100%">
            <b class="titleheading">Order Capture Query For Yarn Dyeing</b>
        </td>
    </tr>
    <tr>
