<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ORDER_CAPTURE_QUERY.ascx.cs"
    Inherits="Module_OrderDevelopment_Controls_ORDER_CAPTURE_QUERY" %>
        ...
        <table class="td tContentArial" width="95%">
            ...
            <tr class="TableHeader">
                <td align="center" valign="top" class="td">
                    <span class="titleheading"><b>Sewing Thread Production Order Approval</b></span>
                </td>
            </tr>
            <tr>
                <td class="td">
                        ...
                        <span class="titleheading"><b>
                            <asp:GridView ID="OrderCapt_Grid" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField Visible="false" HeaderText="LOT NO" ItemStyle-HorizontalAlign="Left"
                                        ItemStyle-Width="20px">
                                        <ItemTemplate>
