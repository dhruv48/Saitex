...
Sales Contract Approval for <asp:Literal ID=ltrProductType runat="server"></asp:Literal>
</b>
</td>
</tr>
<tr>
...
<Columns>
                                ...
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Party Name......">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblPRTY_Name" runat="server" Text='<%# Bind("PRTY_Name") %>' ToolTip='<%# Bind("PRTY_CODE") %>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle CssClass="label smallfont" HorizontalAlign="Left" VerticalAlign="Top"
                                        Wrap="true" />
                                ...
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Right" HeaderText="Sale Price">
                                    ...
                                    <ItemTemplate>
                                        <asp:TextBox ID="lblSALE_PRICE" runat="server" Text='<%# Eval("SALE_PRICE") %>' MaxLength="6" Width="50px"></asp:TextBox>
