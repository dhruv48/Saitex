<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Production_Planning_Query.ascx.cs" Inherits="Module_OrderDevelopment_Controls_Production_Planning_Query" %>
        ...
        <table align="left" class=" td tContentArial" width="100%">
            ...
            <tr>
                <td align="center" class="TableHeader td" colspan="8">
                    <span class="titleheading"><strong>Production Planning Query Form</strong></span>
                </td>
            </tr>
            <tr>
                ...
                <td class="td tContentArial" colspan="8" >
                    <%--<asp:Panel ID="pnlShowHover" runat="server" Width="100%" ScrollBars="Auto" Height="300px" >--%>
                       <asp:GridView ID="grdLabDipSubmission" runat="server" AutoGenerateColumns="False" AllowPaging="true"
                               ...
                               OnPageIndexChanging="Grid1_PageIndexChanging"  >
                                    ...
                                    <Columns >
                                      ...
                                      <asp:TemplateField HeaderText="Planned Quantity" Visible="true" 
                                          ...
                                          <%--<asp:TemplateField HeaderText="Quality Stock">
                                            <ItemTemplate>
                                                <asp:Label ID="lblYarnStockQty" runat="server" Font-Size="X-Small" Text='<%# Bind("YARN_STOCK_QTY") %>' 
                                                    CssClass="LabelNo"></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Width="30px" HorizontalAlign="Center" />
                                        </asp:TemplateField>--%>
                        ...
                        <ItemTemplate>
                            <asp:LinkButton ID="lbtnViewPOOD" runat="server" Text="Mearge Details"></asp:LinkButton>
                            <asp:Panel ID="pnlPOOD" runat="server"  BackColor="Beige" BorderWidth="2px">
                                <asp:GridView ID="grdPOOD" runat="server" AutoGenerateColumns="False" Width="700px"
                                    CssClass="SmallFont" >
                                    <Columns>
                                     ...
                                     <asp:BoundField DataField="PI_NO" HeaderText="PI NO" >
                                        ...
                                        <asp:BoundField DataField="CR_ST_ORDER_NO" HeaderText="Sale's Order No" >
                                            <ItemStyle HorizontalAlign="Center" Wrap="true" CssClass="labelNo smallfont" VerticalAlign="Top" />
                                        </asp:BoundField>
                                        
                                        <asp:BoundField DataField="ORDER_DATE" HeaderText="Sale's Order Date" >
                                            <ItemStyle HorizontalAlign="Center" Wrap="true" CssClass="labelNo smallfont" VerticalAlign="Top" />
                                        </asp:BoundField>
                                        
                                        <asp:BoundField DataField="REQ_DATE" HeaderText="Fianl Date" >
                                            <ItemStyle HorizontalAlign="Center" Wrap="true" CssClass="labelNo smallfont" VerticalAlign="Top" />
                                        </asp:BoundField>
                            ...
                            <cc7:HoverMenuExtender ID="hmePOOD" runat="server" PopupPosition="Left" PopupControlID="pnlPOOD"
                                TargetControlID="lbtnViewPOOD">
                            </cc7:HoverMenuExtender>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Left" Wrap="true" VerticalAlign="Top" Width="20px"/>
                                        ...
                                        <asp:TemplateField HeaderText="">
                        <ItemTemplate>
                            <asp:LinkButton ID="lbtnViewPOTRN" runat="server" Text="BOM Details"></asp:LinkButton>
                            <asp:Panel ID="pnlPOTRN" runat="server"  BackColor="Beige" BorderWidth="2px">
                                <asp:GridView ID="grdPOTRN" runat="server" AutoGenerateColumns="False" Width="700px"
                                    ...
                                    <asp:BoundField DataField="ARTICAL_DESC" HeaderText="Product Description">
                                            <ItemStyle HorizontalAlign="Center" Wrap="true" CssClass="labelNo smallfont" VerticalAlign="Top" />
                                        </asp:BoundField>
                                       <asp:BoundField DataField="ARTICAL_TYPE" HeaderText="Article Type">
                                            <ItemStyle HorizontalAlign="Center" Wrap="true" CssClass="labelNo smallfont" VerticalAlign="Top" />
                                        </asp:BoundField>
                                        ...
                                        <asp:BoundField DataField="UOM" HeaderText="UOM">
                                         ...
                                         <asp:BoundField DataField="VALUE_QTY" HeaderText="Value %">
                                            <ItemStyle HorizontalAlign="Center" Wrap="true" CssClass="labelNo smallfont" VerticalAlign="Top" />
                                        </asp:BoundField>
                                        
                                        
                                         <asp:BoundField DataField="REQ_QTY" HeaderText="Required Quantity">
                                            <ItemStyle HorizontalAlign="Center" Wrap="true" CssClass="labelNo smallfont" VerticalAlign="Top" />
                                        </asp:BoundField>
                        ...
                        <ItemStyle HorizontalAlign="Left" Wrap="true" VerticalAlign="Top" Width="20px"/>
                                 ...
                                 <asp:TemplateField HeaderText="">
                        <ItemTemplate>
                            <asp:LinkButton ID="lbtnViewMAC" runat="server" Text="Machine Details"></asp:LinkButton>
                            <asp:Panel ID="pnlPOTRNMAC" runat="server"  BackColor="Beige" BorderWidth="2px">
                                <asp:GridView ID="grdPOTRNMAC" runat="server" AutoGenerateColumns="False" Width="500px"
                                    CssClass="SmallFont" >
                                    <Columns>
                            ...
                            <cc5:HoverMenuExtender ID="hmePOTRNMAC" runat="server" PopupPosition="Left" PopupControlID="pnlPOTRNMAC"
                                TargetControlID="lbtnViewMAC">
                            </cc5:HoverMenuExtender>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Left" Wrap="true" VerticalAlign="Top" Width="20px"/>
                    </asp:TemplateField>
                      ...
                      <asp:TemplateField HeaderText="">
                        <ItemTemplate>
                            <asp:LinkButton ID="lbtnViewROUTE" runat="server" Text="Route Details"></asp:LinkButton>
                            <asp:Panel ID="pnlPOTRNROUTE" runat="server"  BackColor="Beige" BorderWidth="2px">
                                <asp:GridView ID="grdPOTRNROUTE" runat="server" AutoGenerateColumns="False" Width="500px"
                                    CssClass="SmallFont" >
                                    <Columns>
                                   ...
                                   <asp:BoundField DataField="PROS_ROUTE_CODE" HeaderText="Process Route" >
                                            <ItemStyle HorizontalAlign="Center" Wrap="true" CssClass="labelNo smallfont" VerticalAlign="Top" />
                                        </asp:BoundField>
                                        
                                        
                                        
                                         <asp:BoundField DataField="MAC_CODE" HeaderText="Machine Code" >
                                            <ItemStyle HorizontalAlign="Center" Wrap="true" CssClass="labelNo smallfont" VerticalAlign="Top" />
                                        </asp:BoundField>
                                        
                                        
                                        
                                         <asp:BoundField DataField="PROS_CODE" HeaderText="Process Code" >
                                            <ItemStyle HorizontalAlign="Center" Wrap="true" CssClass="labelNo smallfont" VerticalAlign="Top" />
                                        </asp:BoundField>
                                        ...
                                        <asp:BoundField DataField="S_NO" HeaderText="Serial Number" >
                                         ...
                                         <asp:BoundField DataField="PROS_DESC" HeaderText="Process Description" >
                                            <ItemStyle HorizontalAlign="Center" Wrap="true" CssClass="labelNo smallfont" VerticalAlign="Top" />
                                        </asp:BoundField>
                            ...
                            <cc6:HoverMenuExtender ID="hmePOTRNROUTE" runat="server" PopupPosition="Left" PopupControlID="pnlPOTRNROUTE"
                                TargetControlID="lbtnViewROUTE">
                            </cc6:HoverMenuExtender>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Left" Wrap="true" VerticalAlign="Top" Width="20px"/>
                    </asp:TemplateField>
