...
public partial class Module_OrderDevelopment_Controls_CRApprovalforYarnSpinning : System.Web.UI.UserControl
{
    SaitexDM.Common.DataModel.UserLoginDetail oUserLoginDetail;
    public string PRODUCT_TYPE { get; set; }
    // private string PRODUCT_TYPE = "TEXTURISED YARN"; 
    ...
    public void SearchbyKeywords()
    {
        ...
        try
        {
            ...
            string PartyGrayYarn = ((TextBox)gvCustomerApproval.HeaderRow.FindControl("txthPartyGrayYarnDtl")).Text;
            ...
            custapp ocustapp = new custapp();
            DataTable dt = ocustapp.GetCRBySearchFilterUnApprovedOnly(oUserLoginDetail.COMP_CODE, oUserLoginDetail.DT_STARTDATE.Year, PRODUCT_TYPE, BranchName, CRDate, CustNo, Party, GrayYarn, ShadeFamily, ShadeCode, transPrice, SalePrice, UOM, CRQty,PartyGrayYarn);
            ...
            else
            {
                ...
                lblTotalRecord.Text = "0";
                CommonFuction.ShowMessage("No Customer Request for approval");
                AutofillSearchContent(BranchName, CRDate, CustNo, Party, GrayYarn, ShadeFamily, ShadeCode, transPrice, SalePrice, UOM, CRQty, PartyGrayYarn);
    ...
    private void AutofillSearchContent(string BranchName, string CRDate, string CustNo, string Party, string GrayYarn, string ShadeFamily, string ShadeCode, string transPrice, string SalePrice, string UOM, string CRQty,string partyGreyYarn)
    {
        try
        {
            ...
            TextBox txtPartyGrayYarn = ((TextBox)gvCustomerApproval.HeaderRow.FindControl("txthPartyGrayYarnDtl"));
            ...
            txtPartyGrayYarn.Text = partyGreyYarn;
