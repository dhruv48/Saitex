<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Quality_Shade_Group_Master.ascx.cs" Inherits="Module_OrderDevelopment_Controls_Quality_Shade_Group_Master" %>
                    ...
                    <table>
                        <tr>
                                            ...
                                            <cc2:ComboBox ID="ddlyarncode" runat="server" AutoPostBack="True" CssClass="SmallFont"
                                                    DataTextField="YARN_CODE" DataValueField="YARN_DESC" EmptyText="Find Yarn Code" EnableLoadOnDemand="true"
                        ...
                        <tr >
                            <td>
                                <asp:GridView ID="gvShadefamily" runat="server" AllowPaging="True" AllowSorting="True"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="YARN_CODE" HeaderText="Quality Code" ItemStyle-HorizontalAlign="left"
                                            ItemStyle-VerticalAlign="top">
                                            <ItemStyle HorizontalAlign="Left" VerticalAlign="Top"></ItemStyle>
                                        </asp:BoundField>
                                        <asp:BoundField DataField="YARN_DESC" HeaderText="Quality Desc.." ItemStyle-HorizontalAlign="left"
                                            ItemStyle-VerticalAlign="top">
                                            <ItemStyle HorizontalAlign="Left" VerticalAlign="Top"></ItemStyle>
                                        </asp:BoundField>
