<%@ Control Language="C#" AutoEventWireup="true" CodeFile="OC_APPR_FABRIC.ascx.cs"
    Inherits="Module_OrderDevelopment_Controls_OC_APPR_FABRIC" %>
        ...
        <table class="td tContentArial" width="95%">
            ...
            <tr class="TableHeader">
                <td align="center" valign="top" class="td">
                    <span class="titleheading"><b>Fabric Production Order Approval</b></span>
                </td>
            </tr>
            <tr>
                <td class="td">
