<%@ Control Language="C#" AutoEventWireup="true" CodeFile="approved_prod.ascx.cs" Inherits="Module_OrderDevelopment_Controls_approved_prod" %>
...
--%>
                   ...
                   <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="ARTICLE Name">
                    ...
                    --%>
                     <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="ARTICLE Name">
                        <HeaderTemplate>
                            <table width="100%">
                                ...
                                <tr>
                                    <td colspan="2">
                                        <asp:TextBox ID="TXTFIBERDESC" Width="65px" Height="10px" runat="server" Font-Size="X-Small"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </HeaderTemplate>
                        <ItemTemplate>
                            ...
                            <asp:LinkButton ID="lnkbtnFIBERCODE" Font-Size="Smaller" runat="server" Text='<%# Bind("BASE_ARTICAL_CODE") %>'></asp:LinkButton>
                            <asp:Panel ID="pnlParty1" runat="server" BackColor="Red">
                                <asp:Label ID="lblFIBERDESC" Font-Size="Smaller" runat="server" Text='<%# Bind("BASE_ARTICAL_CODE") %>'></asp:Label>
                            </asp:Panel>
                          <%-- <cc1:HoverMenuExtender ID="hmeParty1" runat="server" PopupPosition="Top" TargetControlID="lnkFIBERCODE"
                                PopupControlID="pnlParty1" PopDelay="50">
                            </cc1:HoverMenuExtender>--%>
                     ...
                     <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Fiber Code" Visible="false">
                        
                        <ItemTemplate>
                            <asp:Label ID="lblFIBERCODE" runat="server" Text='<%# Bind("BASE_ARTICAL_CODE") %>'></asp:Label>
                        </ItemTemplate>
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle CssClass="label smallfont" HorizontalAlign="Left" VerticalAlign="Top"   Wrap="true" />
                    </asp:TemplateField>
                     <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="App.Qty Fiber">
                        <HeaderTemplate>
                            <table width="100%">
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td colspan="2">
                                        ...
                                        <%--<asp:TextBox ID="txtUOM" Width="65px" Height="10px" runat="server" Font-Size="X-Small"></asp:TextBox>--%>
                                      <asp:TextBox ID="txtWEIGHT" Width="65px" Height="10px" runat="server" Font-Size="X-Small"></asp:TextBox>
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lblWeight" CssClass=" SmallFont" runat="server" Text='<%# Eval("REQ_QTY") %>'></asp:Label>
                        &nbsp; <asp:Label ID="lblWeightUom" CssClass=" SmallFont" runat="server" Text='<%# Eval("UOM1") %>'></asp:Label>
                      ...
                      <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="App.Qty Fiber">
                            ...
                            <table width="100%">
                                <tr>
                                    ...
                                    <td>
                                       <%-- <asp:ImageButton ID="btnUom" CssClass="SmallFont" runat="server" ImageUrl="~/CommonImages/Icons/search.png"
                                            Text="Go" OnClick="FilterGrid_Click" Height="16px" Width="16px" />--%>
                                              <asp:ImageButton ID="btnWEIGHT1" CssClass="SmallFont" runat="server" ImageUrl="~/CommonImages/Icons/search.png"
                                            Text="Go" OnClick="FilterGrid_Click" Height="16px" Width="16px" />
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        ...
                                        <%--<asp:TextBox ID="txtUOM" Width="65px" Height="10px" runat="server" Font-Size="X-Small"></asp:TextBox>--%>
                                      <asp:TextBox ID="txtWEIGHT1" Width="65px" Height="10px" runat="server" Font-Size="X-Small"></asp:TextBox>
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lblWeight1" CssClass=" SmallFont" runat="server" Text='<%# Eval("REMQTY") %>'></asp:Label>
                        &nbsp; <asp:Label ID="lblWeightUom1" CssClass=" SmallFont" runat="server" Text='<%# Eval("UOM1") %>'></asp:Label>
