...
using errorLog;
using System.Data;
public partial class Module_OrderDevelopment_Queries_ViewCost : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                DataTable dt = SaitexDL.Interface.Method.OD_CAPTURE_MST.GetCostTable(oOD_CAPTURE_MST, PI_NO, ARTICAL_CODE, SHADE_CODE, PI_TYPE);
                BindGrid(dt);
