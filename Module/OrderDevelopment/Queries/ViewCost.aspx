<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewCost.aspx.cs" Inherits="Module_OrderDevelopment_Queries_ViewCost" %>
                ...
                <table width="100%" class="tContentArial">
                    <tr>
                        <td align="center" class="td TableHeader" valign="top" width="100%">
                            <strong class="titleheading">View Cost</strong>
                        </td>
                    </tr>
                    <tr>
                            ...
                            <asp:Panel ID="Panel2" runat="server" Width="750px" Height="200px" ScrollBars="Horizontal">
                                <asp:GridView ID="grdViewCR" runat="server" AutoGenerateColumns="False" CssClass="SmallFont"
                                    ...
                                    <Columns>
                                      ...
                                      <asp:BoundField DataField="INCENTIVES" HeaderText="INCENTIVES" />
                                      <asp:BoundField DataField="BROKERAGE" HeaderText="BROKERAGE" />
                                      <asp:BoundField DataField="EX_MILL_RATE" HeaderText="EX_MILL_RATE" />
