<%@ Control Language="C#" AutoEventWireup="true" CodeFile="OrderCaptureQuery.ascx.cs"
    Inherits="Module_OrderDevelopment_Queries_OrderCaptureQuery" %>
...
<%--<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>--%>
<table align="left" class="tContentArial" width="970">
    <tr>
    ...
    <tr>
        <td align="left" class="td" width="100%">
            <asp:GridView ID="gvOrder" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvOrder_RowDataBound"
                Font-Size="Smaller" Width="100%" OnRowCommand="gvOrder_RowCommand" ShowFooter="True"
                OnSelectedIndexChanged="gvOrder_SelectedIndexChanged" 
                onpageindexchanging="gvOrder_PageIndexChanging" AllowPaging="True" 
                AllowSorting="True">
                    ...
                    <asp:TemplateField HeaderText="View">
                        <ItemTemplate>
                            <asp:Panel ID="pHeader" runat="server" CssClass="cpHeader">
                                <%--<asp:Label ID="lblText" runat="server" Text="Detail" />--%>
                                <asp:LinkButton ID="lblText" runat="server" CommandName="view">Detail</asp:LinkButton>
                            </asp:Panel>
                            <asp:Panel ID="pBody" runat="server" BackColor="Coral">
                                <table>
                                    <tr>
                                        <td>
                                            <asp:LinkButton ID="lnkViewPacking" CommandName="ViewPacking" runat="server">View Packing</asp:LinkButton>
                                        </td>
                                        <td>
                                            <asp:LinkButton ID="lnkViewProcessRoute" CommandName="ViewProcessRoute" runat="server">View Process Route</asp:LinkButton>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:LinkButton ID="lnkviewCr" CommandName="ViewCR" runat="server">View CR</asp:LinkButton>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:LinkButton ID="lnkViewMachineEntries" CommandName="ViewMachineEntries" runat="server">View Machine Entries</asp:LinkButton>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:LinkButton ID="lnkViewWIPStock" CommandName="ViewWIPStock" runat="server">View WIP Stock</asp:LinkButton>
                                        </td>
                                        <td>
                                            <asp:LinkButton ID="lnkViewIssueAgainstPA" runat="server" CommandName="ViewIssueAgainstPA">Issue Against PA</asp:LinkButton>
                                        </td>
                                    </tr>
                                </table>
                            </asp:Panel>
                            <cc1:HoverMenuExtender ID="hme2d" runat="Server" TargetControlID="lblText" PopupControlID="pBody"
        ...
        <td align="left" width="100%">
            <fieldset>
                ...
                <table class="style1">
                    ...
                    <tr>
                        <td>
                            <asp:DropDownList ID="ddlBranch" runat="server" CssClass="SmallFont" AutoPostBack="True"
                                OnSelectedIndexChanged="ddlBranch_SelectedIndexChanged">
                            </asp:DropDownList>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlBussinesstype" runat="server" CssClass="SmallFont" AutoPostBack="True"
                                OnSelectedIndexChanged="ddlBranch_SelectedIndexChanged">
                            </asp:DropDownList>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlProductType" runat="server" CssClass="SmallFont" AutoPostBack="True"
                                OnSelectedIndexChanged="ddlBranch_SelectedIndexChanged">
                            </asp:DropDownList>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlOrderCat" runat="server" CssClass="SmallFont" AutoPostBack="True"
                                OnSelectedIndexChanged="ddlBranch_SelectedIndexChanged">
                            </asp:DropDownList>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlOrderType" runat="server" CssClass="SmallFont" AutoPostBack="True"
                                OnSelectedIndexChanged="ddlBranch_SelectedIndexChanged">
                            </asp:DropDownList>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlPiType" runat="server" CssClass="SmallFont" AutoPostBack="True"
                                OnSelectedIndexChanged="ddlBranch_SelectedIndexChanged">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td colspan="5">
                            <asp:TextBox ID="txtPartyName" Width="100%" runat="server" CssClass="SmallFont"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td colspan="5">
                            <asp:TextBox ID="txtShadeCode" Width="100%" runat="server" CssClass="SmallFont"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td colspan="5">
                            <asp:TextBox ID="txtArticleCode" Width="100%" runat="server" CssClass="SmallFont"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
