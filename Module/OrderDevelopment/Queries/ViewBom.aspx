<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewBom.aspx.cs" Inherits="Module_OrderDevelopment_Queries_ViewBom" %>
                ...
                <table width="100%" class="tContentArial">
                    <tr>
                        <td align="center" class="td TableHeader" valign="top" width="100%">
                            <strong class="titleheading">View BOM</strong>
                        </td>
                    </tr>
                    <tr>
                                ...
                                <asp:GridView ID="grdViewCR" runat="server" AutoGenerateColumns="False" CssClass="SmallFont"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="CR Shade Code" HeaderStyle-HorizontalAlign="Left">
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblCR_ST_SHADE_CODE" runat="server" CssClass="LabelNo SmallFont" Text='<%# Bind("BASE_SHADE_CODE") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                      <asp:BoundField DataField="REQ_QTY" HeaderText="REQ QTY" />
                                      <asp:BoundField DataField="UOM" HeaderText="UOM" />
                                      <asp:BoundField DataField="BASE_ARTICAL_CODE" HeaderText="BASE_ARTICAL_CODE" />
                                      <asp:BoundField DataField="BRANCH_NAME" HeaderText="BRANCH NAME" />
                                      <asp:BoundField DataField="BASE_ARTICAL_TYPE" HeaderText="BASE_ARTICAL_TYPE" />
                                      <asp:BoundField DataField="ISS_QTY"  HeaderText="ISS QTY" />
                                      <asp:BoundField DataField="VALUE_QTY" HeaderText="VALUE QTY" />
