<%@ Control Language="C#" AutoEventWireup="true" CodeFile="OrderApproval4FiberSppinning.ascx.cs" Inherits="Module_OrderDevelopment_Yarn_Spining_Controls_OrderApproval4FiberSppinning" %>
        ...
        <table class="td tContentArial" width="95%">
            ...
            <tr class="TableHeader">
                <td align="center" valign="top" class="td">
                    <span class="titleheading"><b>Yarn Spinning Production Order Approval</b></span>
                </td>
            </tr>
            <tr>
                <td class="td">
                    <table width="100%">
                        <tr>
                            ...
                            <td align="left" valign="top">
                                <asp:TextBox ID="txtOrderNo" runat="server" CssClass="TextBox" TabIndex="1" MaxLength="12"></asp:TextBox>
                            </td>
                            <td align="right" valign="top">
                                Party Code :
                            </td>
