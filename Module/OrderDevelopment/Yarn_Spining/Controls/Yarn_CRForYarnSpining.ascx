<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Yarn_CRForYarnSpining.ascx.cs" Inherits="Module_OrderDevelopment_Yarn_Spining_Controls_Yarn_CRForYarnSpining" %>
