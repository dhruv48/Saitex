...
using System.Data; 
public partial class Module_OrderDevelopment_Pages_OCFabricCustAdjustment : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["FABR_CODE"] != null)
            {
                ...
                GetDataForItemAdjustment(FABR_CODE);
            }

        }
    }

    private void GetDataForItemAdjustment(string FABR_CODE)
    {
        try
        {
            SaitexDM.Common.DataModel.UserLoginDetail oUserLoginDetail = (SaitexDM.Common.DataModel.UserLoginDetail)Session["LoginDetail"];

            DataTable dtCustReqAdjustment = SaitexBL.Interface.Method.OD_CAPTURE_MST.GetCustomerRequestAdjustmentByArticleCode(oUserLoginDetail.COMP_CODE, FABR_CODE, SHADE_CODE, PRODUCT_TYPE, oUserLoginDetail.CH_BRANCHCODE, BUSINESS_TYPE, ORDER_CAT, ORDER_TYPE, ORDER_NO,"",oUserLoginDetail.DT_STARTDATE.Year);
            if (dtCustReqAdjustment != null && dtCustReqAdjustment.Rows.Count > 0)
            {
                ...
                lblAdjustArticleCode.Text = FABR_CODE;
