<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GetDepotDisTex.aspx.cs" Inherits="Module_OrderDevelopment_Pages_GetDepotDisTex" %>
                ...
                <table>
                    ...
                    <tr>
                        <td class="td" align="center" valign="top">
                            Basic Rate : <asp:Label ID="lblBasicRate" runat="server" Text=""></asp:Label>
                        </td>
                    </tr>
                    <tr>
