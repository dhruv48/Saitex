'<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProcessRouteBOM.aspx.cs" Inherits="Module_OrderDevelopment_Pages_ProcessRouteBOM" %>
                ...
                <table width="100%">
                    ...
                    <tr>
                        <td align="left" class="td" valign="top" width="100%">
                            <asp:CheckBox ID="CheckBox1" runat="server" CssClass="SmallFont"  Visible="false"  />
                            <asp:Button ID="btnupdateflag" runat="server" Text="Update Flag"  Visible="false"
