...
public partial class Module_OrderDevelopment_CustomerRequest_Controls_CustomerRequestApproval : System.Web.UI.UserControl
{
    ...
    {
        int Tranprice = int.Parse(lblTRANS_PRICE.ToString()); 
        int SalePrice = int.Parse(lblSALE_PRICE.ToString());
        bool result = false;
    ...
    private void SearchbyKeywords()
    {
        try
        {
            ...
            AutoComplete o = new AutoComplete();
            DataTable dt = o.GetCRBySearchFilterUnApprovedOnly(oUserLoginDetail.COMP_CODE, oUserLoginDetail.DT_STARTDATE.Year, PRODUCT_TYPE, BranchName, CRDate, CustNo, Party, GrayYarn, ShadeFamily, ShadeCode, transPrice, SalePrice, UOM, CRQty,"");
