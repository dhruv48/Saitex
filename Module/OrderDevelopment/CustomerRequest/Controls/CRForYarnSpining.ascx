...
<td id="tdSave" runat="server">
    ...
    <asp:ImageButton ID="imgbtnSave" runat="server" 
        ...
        onclick="imgbtnSave_Click" TabIndex="49" />
</td>
...
<span class="titleheading"><b>Sales Contract For <asp:Literal ID=ltrProductType runat="server"></asp:Literal></b></span>
</td>
</tr>
<tr>
...
<tr  class="td">
 ...
 <td align="right" width="17%" >
                            ...
                            <td align="left" width="17%" >
                                <asp:DropDownList Width="150px" CssClass="SmallFont TextBox UpperCase" ID="ddlBusinessType"  AutoPostBack="true"
...
<td align="left" width="17%">
                       <asp:DropDownList Width="150px" TabIndex="2" CssClass="SmallFont TextBox UpperCase"
                            ...
                            <cc2:ComboBox ID="cmbOrderNo" TabIndex="4" runat="server" AutoPostBack="True" CssClass="smallfont"
                                    DataTextField="ORDER_NO" DataValueField="Combined" EnableLoadOnDemand="True" EmptyText="Select CR No"
...
<asp:TextBox ID="txtCrLocation" runat="server" ReadOnly="true" TabIndex="6" Width="150px"
                            ...
                            <td align="left" width="17%">
                                <asp:TextBox ID="txtDate" runat="server" TabIndex="5" Width="150px" MaxLength="10"
                                    ...
                                    <cc3:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="txtDate" Format="dd/MM/yyyy">
        ...
        <tr  >
                ...
                <td align="right" width="17%">
                            ...
                            <td align="left" width="17%">
                                <asp:TextBox ID="txtConversionRate" runat="server" Width="150px" MaxLength="4"
                            ...
                            <td align="left" width="17%">
                                <asp:TextBox ID="txtShipment" runat="server" Width="150px" MaxLength="250"
                        ...
                        Agent:
                            ...
                            OnLoadingItems="txtBrokerCode_LoadingItems" DataTextField="PRTY_NAME" DataValueField="PRTY_CODE"
                            EmptyText="Select Agent" 
                            EnableVirtualScrolling="true" Width="150px" MenuWidth="400px" Height="200px" TabIndex="11" ValidationGroup="M1">
                            <HeaderTemplate>
                                <div class="header c1">
                                    Code</div>
                                <div class="header c3">
                        ...
                        <tr >
                            ...
                            TabIndex="29" Width="150px" EnableVirtualScrolling="true" >
                            <HeaderTemplate>
                                <div class="header c1">
                                    Code</div>
                                <div class="header c3">
                      ...
                      <%--  </td>--%>
                           <%-- <td align="left" colspan="4" class="tdLeft" width="66%">--%>
                                ...
                                <asp:TextBox ID="txtAddress" runat="server" CssClass="SmallFont TextBox TextBoxDisplay"
                                    ReadOnly="true"  ValidationGroup="M1" Width="450px"></asp:TextBox>
                          </td>
                        </tr>
                        <tr >
                            <td align="right" width="17%">
                            ...
                            <td align="left" width="15%">
                                ...
                                <asp:RequiredFieldValidator ID="rfvod" runat="server" ControlToValidate="TxtDocumentDate"
                                    Display="Dynamic" ErrorMessage="*Please select the PO Date" Font-Bold="False" ValidationGroup="CR"></asp:RequiredFieldValidator>
                            ...
                            <td class="tdLeft" width="12%">
                                <asp:DropDownList ID="ddlPaymentMode" runat="server"  MenuWidth="150px"
                           ...
                           <tr  >
                            ...
                            <td class="tdLeft" width="88%" colspan="5">
                           ...
                           <tr  >
                            ...
                            <td class="tdLeft" width="88%" colspan="5">
                                <asp:TextBox ID="txtDeleveredTo" runat="server" CssClass="TextBox SmallFont" Width="99%"
                           ...
                           <tr  >
                            ...
                            <td class="tdLeft" width="17%" >
                                    ...
                                    <asp:DropDownList ID="ddlTaxAgainst" runat="server" Width="150px" CssClass="SmallFont" TabIndex="37"></asp:DropDownList>
                            </td>
                            <td align="right" width="17%">
                                &nbsp;Remarks:
                            </td>
                            <td align="left" width="83%" colspan="3">
                                <asp:TextBox ID="txtMstRemarks" runat="server" TabIndex="38" CssClass="SmallFont TextBox UpperCase"
                                    ValidationGroup="M1" Width="99%" MaxLength="450"></asp:TextBox>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="td" width="100%">
                                    ...
                                    <tr>
                                        <td align="left" valign="top" width="10%">
                                            <cc2:ComboBox ID="cmbArticleNo" runat="server" AutoPostBack="True" CssClass="smallfont"
                                                ...
                                                MenuWidth="750" OnLoadingItems="cmbArticleNo_LoadingItems" OnSelectedIndexChanged="cmbArticleNo_SelectedIndexChanged"
                                        ...
                                        <asp:DropDownList ID="ddlYarnShade" runat="server" AppendDataBoundItems="True" CssClass="SmallFont"
                                                    TabIndex="40" Width="127" onselectedindexchanged="ddlYarnShade_SelectedIndexChanged" AutoPostBack="true"  Visible="false"
                                                   >
                                                </asp:DropDownList>
                                        ...
                                        <td align="left" valign="top" width="10%">
                                            <asp:TextBox ID="txtNoofUnit" runat="server" CssClass="SmallFont TextBoxNo" Width="95%" AutoPostBack="true"
                                                TabIndex="41" OnTextChanged="txtNoofUnit_TextChanged" MaxLength="8"></asp:TextBox>
                                        ...
                                        <asp:TextBox ID="txtSaleRate" runat="server"  CssClass="SmallFont TextBoxNo" 
                                                MaxLength="6"  OnTextChanged="txtsalerate_TextChanged"   AutoPostBack="True"  Width="95%"
                                ...
                                <asp:Button ID="btnDisc" runat="server" Text="Disc/Taxes" OnClick="btnDisc_Click"
                                    CssClass="SmallFont " Width="100%" TabIndex="43" />
                            ...
                            Width="95%" ontextchanged="txtTotalCost_TextChanged" AutoPostBack="true"></asp:TextBox>
                                        ...
                                        <td align="left" valign="top" width="10%">
                                    <asp:TextBox ID="txtReqDate" runat="server" TabIndex="44" Width="95%"
                                        ...
                                        <td align="left" valign="top" width="10%">
                                            <asp:Button ID="btnSTSave" runat="server" CssClass="SmallFont" TabIndex="47" OnClick="btnSTSave_Click"
                                                Text=" Save "   Width="60px"/>
                                          
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left" valign="top" colspan="9" width="90%">
                                             Party&nbsp;Yarn&nbsp;Desc&nbsp;:
                                                <asp:TextBox ID="txtParyItemDesc" runat="server" Width="250px" CssClass="TextBox  SmallFont"
                                                Font-Bold="False"  TabIndex="46"></asp:TextBox>&nbsp;
                                             Yarn Code/Desc :<asp:TextBox ID="txtItemCodeLabel" runat="server" Width="100px" CssClass="TextBox TextBoxDisplay SmallFont"
                                                Font-Bold="False" ReadOnly="True"></asp:TextBox><asp:TextBox ID="txtItemDesc" runat="server" Width="250px" CssClass="TextBox TextBoxDisplay SmallFont"
                                        ...
                                        <td align = "right">
                                            <asp:Button ID="btnSTCancel" runat="server" CssClass="SmallFont" TabIndex="48" OnClick="btnSTCancel_Click"
...
<Triggers >
 <asp:PostBackTrigger ControlID="txtNoofUnit" />
 <asp:PostBackTrigger ControlID="txtSaleRate" />
