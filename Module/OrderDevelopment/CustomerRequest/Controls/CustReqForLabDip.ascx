<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CustReqForLabDip.ascx.cs"
    Inherits="Module_OrderDevelopment_CustomerRequest_Controls_CustReqForLabDip" %>
        ...
        <table align="left" class="tContentArial">
            ...
            <tr>
                <td align="center" class="TableHeader td">
                    <span class="titleheading"><b>Customer Request For Yarn (Lab Dip)</b></span>
                </td>
            </tr>
            <tr>
                    ...
                    <table width="100%">
                        <tr>
                            <td class="td">
                             ...
                             <cc2:ComboBox ID="cmbFabricCode" runat="server" AutoPostBack="True" CssClass="smallfont"      DataTextField="YARN_CODE" 
                             DataValueField="YARN_CODE" EnableLoadOnDemand="True"   MenuWidth="750px" OnLoadingItems="Item_LOV_LoadingItems" 
