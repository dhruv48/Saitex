<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CustomerReqcls4Yarn.ascx.cs" Inherits="Module_OrderDevelopment_CustomerRequest_Controls_CustomerReqcls4Yarn" %>
