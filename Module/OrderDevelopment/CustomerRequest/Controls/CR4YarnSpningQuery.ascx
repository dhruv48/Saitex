<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CR4YarnSpningQuery.ascx.cs" Inherits="Module_OrderDevelopment_CustomerRequest_Controls_CR4YarnSpningQuery" %>
