<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CRForWaste.ascx.cs" Inherits="Module_OrderDevelopment_CustomerRequest_Controls_CRForWaste" %>
...
<span class="titleheading"><b>Sales Contract For Waste</b></span>
</td>
</tr>
<tr>
        ...
        <tr  >
                ...
                <td align="right" width="17%">
                        ...
                        <tr >
                            ...
                            TabIndex="13" Width="120px" EnableVirtualScrolling="true" >
                            <HeaderTemplate>
                                <div class="header c1">
                                    Code</div>
                                <div class="header c2">
                      ...
                      <%--  </td>--%>
                        ...
                        <tr  >
                            ...
                            <td align="left" width="17%">
                                <asp:TextBox ID="txtDirectBilling" runat="server" TabIndex="16" Width="120px" CssClass="SmallFont TextBox UpperCase"
                                    ValidationGroup="M1" MaxLength="45" Visible="false"></asp:TextBox>
                                    
                                    
                                      <asp:TextBox ID="txtTolerance" runat="server" TabIndex="16" Width="120px" CssClass="SmallFont TextBox UpperCase"
                            ...
                            <td align="left" width="17%">
                                <asp:TextBox ID="txtCustomerReffNo" TabIndex="17" runat="server" Width="120px" CssClass="SmallFont TextBox UpperCase"
                            ...
                            <td align="left" width="15%">
                                <asp:TextBox ID="TxtDocumentDate" runat="server" TabIndex="18" Width="120px" CssClass="SmallFont TextBox UpperCase"
                            ...
                            <td class="tdLeft" width="12%">
                                <asp:DropDownList ID="ddlPaymentMode" runat="server"  MenuWidth="200px"
                                    ...
                                    onselectedindexchanged="ddlPaymentMode_SelectedIndexChanged" TabIndex="19">
                            ...
                            <td class="tdLeft" width="64%" colspan=4>
                                <asp:TextBox ID="txtPaymentTerm" runat="server" CssClass="TextBox SmallFont" Width="100%"
                                    MaxLength="450" TabIndex="20"></asp:TextBox>
                            </td>
                        </tr>
                           <tr  >
                            <td class="tdRight" width="12%">
                            ...
                            <td class="tdLeft" width="88%" colspan="6">
                                <asp:TextBox ID="txtBillTo" runat="server" CssClass="TextBox SmallFont" Width="100%"
                                    MaxLength="450" TabIndex="21"></asp:TextBox>
                            </td>
                        </tr>
                           <tr  >
                            <td class="tdRight" width="12%">
                        ...
                        <tr  >
                            ...
                            <td align="left" width="83%" colspan="5">
                                &nbsp;<asp:TextBox ID="txtMstRemarks" runat="server" TabIndex="22" CssClass="SmallFont TextBox UpperCase"
                ...
                <td width="100%" class="td">
                    <table width="100%" >
                        <tr>
                                ...
                                <table width="100%" class="td">
                                    <tr bgcolor="#006699">
                                        <td width="20%" align="center">
                                            <span class="titleheading"><b>Waste</b></span>
                                        </td>
                                        <td width="20%" align="center" runat="server"  id="tdyarnshadehead">
                                            <span class="titleheading">
                                            <b><%--Shade&nbsp;Family/Shade&nbsp;Code--%> Qty&nbsp;(in&nbsp;CarryType)</b>
                                        ...
                                        <td class="tdRight" width="10%" align="center">
                                            <span class="titleheading"><b>Qty&nbsp;(in&nbsp;KG)</b></span>
                                        </td>
                                    ...
                                    <tr>
                                        <td align="left" valign="top" width="20%">
                                            <cc2:ComboBox ID="cmbArticleNo" runat="server" AutoPostBack="True" CssClass="smallfont"
                                                ...
                                                MenuWidth="300" OnLoadingItems="cmbArticleNo_LoadingItems" OnSelectedIndexChanged="cmbArticleNo_SelectedIndexChanged"
                                                EnableVirtualScrolling="true" OpenOnFocus="true" TabIndex="23" Visible="true"
                                        ...
                                        <td align="left" valign="top" width="20%" runat="server"  id="tdyarnshadecol">
                                        
                                        <asp:DropDownList ID="ddlYarnShade" runat="server" AppendDataBoundItems="True" CssClass="SmallFont"
                                                    TabIndex="24" Width="127" onselectedindexchanged="ddlYarnShade_SelectedIndexChanged" AutoPostBack="true"  Visible="false"
                                                   >
                                                </asp:DropDownList>
                                           <asp:TextBox ID="txtCarryQty" runat="server" CssClass="SmallFont TextBoxNo" Width="95%"
                                                TabIndex="25"  MaxLength="100"></asp:TextBox>
                                        </td>
                                        ...
                                        <td align="left" valign="top" width="10%">
                                            <asp:TextBox ID="txtNoofUnit" runat="server" CssClass="SmallFont TextBoxNo" Width="95%"
                                                TabIndex="25" OnTextChanged="txtNoofUnit_TextChanged" MaxLength="6"></asp:TextBox>
                                        ...
                                        <td align="left" valign="top" width="10%">
                                        <asp:TextBox ID="txtSaleRate" runat="server"  CssClass="SmallFont TextBoxNo" MaxLength="6"  OnTextChanged="txtsalerate_TextChanged"   AutoPostBack="True" TabIndex="19" Width="95%"></asp:TextBox>
                                        <cc3:FilteredTextBoxExtender ID="FilteredTexttxtSaleRate" runat="server"  TargetControlID="txtSaleRate"   FilterType="Custom, Numbers" ValidChars="."/>
                                            <asp:DropDownList CssClass="SmallFont TextBox UpperCase" TabIndex="26" ID="txtEndUse"
                            ...
                            Width="80px" ontextchanged="txtTotalCost_TextChanged"></asp:TextBox>
                                </td>
                                
                                        <td align="left" valign="top" width="10%">
                                    <asp:TextBox ID="txtReqDate" runat="server" TabIndex="27" Width="60px" CssClass="SmallFont TextBox UpperCase"></asp:TextBox>
                                          </td>
                                        <td align="left" valign="top" width="20%" rowspan="2">
                                            <asp:TextBox ID="txtRemarks" runat="server" TabIndex="28" CssClass="SmallFont" 
                                                Width="95%" Height="40px"></asp:TextBox>
                                        </td>
                                        <td align="left" valign="top" width="10%">
                                            <asp:Button ID="btnSTSave" runat="server" CssClass="SmallFont" TabIndex="29" OnClick="btnSTSave_Click"
                                                Text=" Save "  />
                                    ...
                                    <tr>
                                        <td align="left" valign="top" colspan="6" width="90%">
                                            Waste Code :<asp:TextBox ID="txtItemCodeLabel" runat="server" Width="150px" CssClass="TextBox TextBoxDisplay SmallFont"
                                           ...
                                           <asp:TextBox ID="txtShadeFamilyName" runat="server" CssClass="TextBoxDisplay SmallFont"
                                            ...
                                            &nbsp<asp:TextBox ID="txtShadeName" runat="server" CssClass="TextBoxDisplay SmallFont"
                                        ...
                                        <td align = "right" colspan="5">
                                            <asp:Button ID="btnSTCancel" runat="server" CssClass="SmallFont" TabIndex="30" OnClick="btnSTCancel_Click"
                                            ...
                                            <asp:GridView ID="GridSpinningThread" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Article No">
                                                       ...
                                                       <asp:TemplateField HeaderText="Carry Qty">
                                                        <ItemTemplate>
                                                            <asp:Label ID="txtCarryQty" runat="server" CssClass="LabelNo SmallFont" Text='<%# Bind("CARRY_QTY") %>'></asp:Label>
                                                        </ItemTemplate>
                                                        <HeaderStyle HorizontalAlign="Left" VerticalAlign="Top" />
                                                        <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Matching Reff." Visible="false">
                                                        <ItemTemplate>
