<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CrFabricApproval.ascx.cs"
    Inherits="Module_OrderDevelopment_CustomerRequest_Controls_CrFabricApproval" %>
...
<table align="left" class="tContentArial" width="100%">
    ...
    <tr>
        <td align="center" class="TableHeader td" width="100%">
            <b class="titleheading">Customer Request Approval For Fabric Knitting </b>
        </td>
    </tr>
    <tr>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Right" HeaderText="Article Detail">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:Panel ID="pnlarticledetail" runat="server" BackColor="Red">
                                <asp:Label ID="lblYARN_DESC" runat="server" Text='<%# Eval("FABR_DESC") %>'></asp:Label>
                            </asp:Panel>
