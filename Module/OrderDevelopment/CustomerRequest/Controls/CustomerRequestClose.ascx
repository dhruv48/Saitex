<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CustomerRequestClose.ascx.cs"
    Inherits="Module_OrderDevelopment_CustomerRequest_Controls_CustomerRequestClose" %>
        ...
        <table align="left" class="tContentArial" width="100%">
            ...
            <tr>
                <td align="center" class="TableHeader td" width="100%">
                    <b class="titleheading">Customer Request Closing For Sewing Thread</b>
                </td>
            </tr>
            <tr>
