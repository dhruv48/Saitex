<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CustomerRequestApproval.ascx.cs"
    Inherits="Module_OrderDevelopment_CustomerRequest_Controls_CustomerRequestApproval" %>
...
//        var table = document.getElementById('<%=gvCustomerApproval.ClientID %>');
//        for (var i = 1; i < table.rows.length; i++) //setting the incrementor=0, but if you have a header set it to 1
//        {
//            table.rows[i].cells[10].innerText = table.rows[i].cells[9].innerText;
...
<table align="left" class="tContentArial" width="100%">
    <tr>
        <td align="left" valign="top" class="td" width="100%">
            <table align="left">
                <tr>
                    <td id="tdUpdate" runat="server" align="left" visible="false">
    ...
    <tr>
        <td align="center" class="TableHeader td" width="100%">
            <b class="titleheading">Customer Request Approval For Sewing Thread</b>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td align="left" class="td" width="100%">
            ...
            <asp:GridView ID="gvCustomerApproval" runat="server" AutoGenerateColumns="False"
                ...
                OnSelectedIndexChanging="gvCustomerApproval_SelectedIndexChanging" AllowPaging="True"
                PagerStyle-CssClass="pager" OnPageIndexChanging="gvCustomerApproval_PageIndexChanging"
                PageSize="12">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Party Name...">
                        ...
                        <ItemTemplate>
                            <asp:LinkButton ID="lblParty_Code" Font-Size="Smaller" runat="server" Text='<%# Bind("PRTY_CODE") %>'></asp:LinkButton>
                            <asp:Panel ID="pnlParty" runat="server" BackColor="Red">
                                <asp:Label ID="lblPRTY_Name" Font-Size="Smaller" runat="server" Text='<%# Bind("PRTY_Name") %>'></asp:Label>
                            </asp:Panel>
                            <cc1:HoverMenuExtender ID="hmeParty" runat="server" PopupPosition="Top" TargetControlID="lblParty_Code"
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Right" HeaderText="Article Detail">
                        ...
                        <ItemTemplate>
                            <asp:LinkButton ID="lblARTICLE_NO" Font-Size="Smaller" runat="server" Text='<%# Eval("ARTICLE_NO") %>'></asp:LinkButton>
                            <asp:Panel ID="pnlarticledetail" runat="server" BackColor="Red">
                                <asp:Label ID="lblYARN_DESC" runat="server" Text='<%# Eval("YARN_DESC") %>'></asp:Label>
                            </asp:Panel>
                            <cc1:HoverMenuExtender ID="hmeArticle" runat="server" PopupPosition="Top" TargetControlID="lblARTICLE_NO"
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Right" HeaderText="Trans Price">
                        ...
                        <ItemTemplate>
                            <asp:TextBox ID="lblTRANS_PRICE" Width="35px" Text='<%# Eval("TRANS_PRICE") %>' CssClass="SmallFont TextBoxNo"
                                Height="10px" runat="server"></asp:TextBox>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Right" HeaderText="Sale Price">
                        ...
                        <ItemTemplate>
                            <asp:TextBox ID="lblSALE_PRICE" Width="35px" Text='<%# Eval("SALE_PRICE") %>' CssClass="SmallFont TextBoxNo"
                                Height="10px" c runat="server"></asp:TextBox>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Right" HeaderText="Apr.CR Unit">
                        <ItemTemplate>
                            <asp:TextBox ID="lblNoOfUnit" runat="server" Width="60px" CssClass="SmallFont TextBoxNo"
                                OnTextChanged="lblNoOfUnit_TextChanged" onFocus="javascript:FillCrUnit(this.id);" 
                    ...
                    <asp:TemplateField HeaderText="Approve CR">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Right" HeaderText="Invoiced CR Unit"
                        Visible="false">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Close CR" Visible="false">
                        <ItemTemplate>
                    ...
                    <%--  <asp:TemplateField HeaderText="Confirm Date" Visible ="false" >
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Confirm By" Visible ="false" >
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtConfirmBy" runat="server" Font-Size="Smaller" Width="60px" CssClass="TextBox TextBoxDisplay SmallFont"
                                            ReadOnly="true" Text='<%# Bind("CONF_BY") %>' 
                                            ToolTip='<%# Bind("CONF_BY") %>'></asp:TextBox>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" Wrap="true" />
                                </asp:TemplateField>--%>
                    <asp:TemplateField HeaderText="Remarks">
                        <ItemTemplate>
                            <asp:TextBox ID="txtRemarks" CssClass="Smallfont" Width="50px" runat="server"></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
