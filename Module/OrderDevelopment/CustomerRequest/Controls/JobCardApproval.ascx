<%@ Control Language="C#" AutoEventWireup="true" CodeFile="JobCardApproval.ascx.cs" Inherits="Module_OrderDevelopment_CustomerRequest_Controls_JobCardApproval" %>
...
<table class="tdMain tContentArial" width="990px" align="left">
    <tr>
    ...
    <tr>
        <td align="center" class="TableHeader td" width="100%">
            <b class="titleheading"> Job Card Order Approval </b>
        </td>
    </tr>
    <tr>
   ...
   <td align="left" class="td" width="100%">
     <asp:GridView ID="gvJobCardApproval" CssClass="SmallFont" runat="server" AllowSorting="True"
       AutoGenerateColumns="False" OnRowDataBound="gvJobCardApproval_RowDataBound" Width="100%"  OnRowCommand="grdJobCardData_RowCommand" >
                <Columns>
                  ...
                  <asp:BoundField DataField="GREY_LOT_NO" HeaderText=" Grey Lot No">
                    ...
                    <asp:BoundField DataField="LAB_DIP_NO" HeaderText=" LAB DIP NO">
                        <ItemStyle HorizontalAlign="Left" Wrap="true" CssClass="label smallfont" VerticalAlign="Top" />
                    </asp:BoundField>
                    <asp:BoundField DataField="CUST_REQ_NO" HeaderText=" Order No">
                        <ItemStyle HorizontalAlign="Left" Wrap="true" CssClass="label smallfont" VerticalAlign="Top" />
                    </asp:BoundField>
                    ...
                    <asp:BoundField DataField="MACHINE_CODE" HeaderText="Machine Code">
                     ...
                     <asp:BoundField DataField="LOT_SIZE" HeaderText="Lot Size" Visible="false" >
                        <ItemStyle HorizontalAlign="Left" Wrap="true" CssClass="labelNo smallfont" VerticalAlign="Top" />
                    </asp:BoundField>
            ...
            <asp:TemplateField HeaderText=" View Chemical ">
                <ItemTemplate>
                    <asp:LinkButton ID="lbtnViewJobCardTRN" runat="server" Text="View Chemical " CommandName="JobCardDetails"></asp:LinkButton>
                    ...
                    <asp:GridView ID="grdJobCardTRN" runat="server" AutoGenerateColumns="False" Width="520px"
                        CssClass="SmallFont" Height="140px" ShowFooter="true" OnRowDataBound="grdJobCardTRN_RowDataBound">
                        <Columns>
            ...
            <asp:TemplateField HeaderText=" View Dyes">
                <ItemTemplate>
                    <asp:LinkButton ID="lbtnViewJobCardDyes" runat="server" Text="View Dyes " CommandName="JobCardEdit"></asp:LinkButton>
