<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CustomerRequestForSpinningThread.ascx.cs"
    Inherits="Module_OrderDevelopment_CustomerRequest_Controls_CustomerRequestForSpinningThread" %>
...
<table align="left" class="tContentArial">
    ...
    <tr>
        <td align="center" class="TableHeader td">
            <span class="titleheading"><b>Customer Request For Sewing Thread</b></span>
        </td>
    </tr>
    <tr>
        <td align="left" class="td" valign="top">
        ...
        <td style="width: 100%">
            <table width="100%" class="tdLeft">
                <tr>
                    ...
                    <td align="left" width="15%">
                        ...
                        <%-- <asp:DropDownList Width="120px" CssClass="SmallFont TextBox UpperCase" ID="ddlOrderCategory"
                                    runat="server" AutoPostBack="true" 1 OnSelectedIndexChanged="ddlOrderCategory_SelectedIndexChanged">
                                </asp:DropDownList>--%>
                        <br />
                ...
                <tr>
                    ...
                    <td align="left" colspan="3" class="tdLeft">
                ...
                <tr>
                    ...
                    <td align="left" colspan="6" class="tdLeft">
                    ...
                    <td>
                        <table width="100%">
                            <tr bgcolor="#006699">
                                ...
                                <td>
                                    <span class="titleheading"><b>Make/Tkt</b></span>
                                </td>
                                <td>
                                ...
                                <td class="tdRight">
                                    <span class="titleheading"><b>NoUnit</b></span>
                                </td>
                                <td>
                                    <span class="titleheading"><b>Packing Unit</b></span>
                                </td>
                                <td class="tdRight">
                                    <span class="titleheading"><b>Unit Weight/ Total Weight</b></span>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td align="left" valign="top">
                                    ...
                                    <br />
                                    <asp:TextBox ID="txtItemCodeLabel" runat="server" Width="100%" CssClass="TextBox TextBoxDisplay SmallFont"
                                        Font-Bold="False" ReadOnly="True"></asp:TextBox>
                                </td>
                                <td align="left" valign="top">
                                    <asp:TextBox ID="txtMake" runat="server" CssClass="TextBoxDisplay SmallFont UpperCase"
                                        ReadOnly="true" Width="100%"></asp:TextBox>
                                    <asp:TextBox ID="txtTktNo" runat="server" CssClass="TextBoxDisplay SmallFont UpperCase"
                                        ReadOnly="true" Width="100%"></asp:TextBox>
                                </td>
                                <td align="left" valign="top">
                                    <table>
                                        <tr>
                                            <td>
                                                <cc2:ComboBox ID="cmbShade" runat="server" AutoPostBack="True" CssClass="smallfont"
                                                    ...
                                                    Height="200px" Visible="true" Width="90px" OnLoadingItems="cmbShade_LoadingItems"
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <asp:TextBox ID="txtShadeName" runat="server" CssClass="TextBoxDisplay SmallFont"
                                                    ReadOnly="true" Width="100%"></asp:TextBox>
                                                <asp:TextBox ID="ddlShadeFamily" runat="server" CssClass="TextBoxDisplay SmallFont"
                                ...
                                <td align="left" valign="top">
                                    <asp:DropDownList ID="DDLCaseBox" TabIndex="20" CssClass="SmallFont TextBox UpperCase"
                                        runat="server" Width="100%" AutoPostBack="True" OnSelectedIndexChanged="DDLCaseBox_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </td>
                                <td align="left" valign="top">
                                    <asp:TextBox ID="txtWeightofUnit" ReadOnly="true" runat="server" CssClass="SmallFont TextBoxNo TextBoxDisplay"
                                        Width="50px" AutoPostBack="True" OnTextChanged="txtWeightofUnit_TextChanged"></asp:TextBox>
                                    <asp:TextBox ID="txtQuantity" ReadOnly="true" runat="server" CssClass="SmallFont TextBoxNo TextBoxDisplay"
                                        onKeyPress="pricevalidate(this);" Width="95%"></asp:TextBox>
                                </td>
                                <td align="left" valign="top">
                                ...
                                <td align="left" valign="top">
                                    <asp:TextBox ID="txtRemarks" runat="server" TabIndex="22" CssClass="SmallFont" Width="95%"
                                        Height="40px" Rows="2"></asp:TextBox>
                                </td>
                                <td align="left" valign="top">
...
<cc3:MaskedEditExtender ID="MaskedEditExtender2" runat="server" Mask="99/99/9999"
    MaskType="Date" TargetControlID="txtReqDate" PromptCharacter="_">
</cc3:MaskedEditExtender>
<cc3:CalendarExtender ID="CalendarExtender1" Format="dd/MM/yyyy" runat="server" TargetControlID="txtReqDate">
</cc3:CalendarExtender>
<%--<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtReqDate"
    Display="Dynamic" ErrorMessage="*Req Date Required" Font-Bold="False"></asp:RequiredFieldValidator>--%>
<%-- </ContentTemplate>
</asp:UpdatePanel>--%>