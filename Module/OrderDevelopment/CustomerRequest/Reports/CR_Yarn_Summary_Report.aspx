<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CommonMaster/admin.master" CodeFile="CR_Yarn_Summary_Report.aspx.cs" Inherits="Module_OrderDevelopment_CustomerRequest_Reports_CR_Yarn_Summary_Report" %>
        ...
        <table width="100%">
            ...
            <tr width="100%">
                <td align="center" class="TableHeader td">
                    <b class="titleheading">Sale Contract Summery Report For Yarn</b>
                </td>
            </tr>
        </table>
        <fieldset>
                    ...
                    <td align="left"  colspan="4">
                      <asp:Panel ID="Panel1" runat="server" >
                            <asp:RadioButtonList ID="redForQuery" runat="server" Height="16px"  
                               ...
                               >
                                <asp:ListItem  Selected="True"  Value="Yarn" Text="Yarn Wise">Yarn Wise</asp:ListItem>
