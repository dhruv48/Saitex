<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustAdjForyarn.aspx.cs" Inherits="Module_OrderDevelopment_CustomerRequest_Pages_CustAdjForyarn" %>
                        ...
                        <td class="td tdLeft">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtRate" runat="server" CssClass="SmallFont TextBox" AutoPostBack="true" 
                                            Width="50px"  MaxLength="5" ontextchanged="txtRate_TextChanged"></asp:TextBox>
