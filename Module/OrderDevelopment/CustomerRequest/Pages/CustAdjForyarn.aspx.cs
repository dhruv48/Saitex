...
public partial class Module_OrderDevelopment_CustomerRequest_Pages_CustAdjForyarn : System.Web.UI.Page
{
    ...
    private void AddRowInDataTable()
    {
        try
        {
            ...
            if (dtRate1.Rows.Count > 0)
            {
                ...
                dvRate.RowFilter = "YARN_CODE='" + YARN_CODE + "' and COMPO_CODE='" + Code + "' and SHADE_CODE='" + SHADE_CODE + "' and Uniqueid <> " + Uniqueid;
            ...
            if (!IsDuplicate)
            {
                ...
                if (dvRateComponent.Count > 0)
                {
                    ...
                    if (rate > 0)
                    {
                        ...
                        {
                            DataView dvv = new DataView(dtRate1);
                            dvv.RowFilter = "YARN_CODE='" + YARN_CODE + "' and COMPO_CODE='" + ddlBaseComponent.SelectedItem.Text.Trim() + "' and SHADE_CODE='" + SHADE_CODE + "'";
