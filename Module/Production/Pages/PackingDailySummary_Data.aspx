<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CommonMaster/admin.master" CodeFile="PackingDailySummary_Data.aspx.cs" Inherits="Module_Production_Pages_PackingDailySummary_Data" %>
...
<asp:ImageButton ID="imgBtnExportExcel" runat="server" Width="48" Height="41" ToolTip="Print"
            ...
            <tr>
                <td class="TableHeader td" align="center">
                    <span class="titleheading">Packing Daily Summary Form</span>
                </td>
            </tr>
            <tr>
                <td class="td">
        <table>
                <tr id="trRange" runat="server">
                    ...
                    <td>
              <asp:TextBox ID="txtPackingDate" runat="server" TabIndex="2" ValidationGroup="M1" Width="145px"
                    CssClass="TextBox SmallFont"></asp:TextBox>
  <cc4:CalendarExtender ID="CE1" runat="server" Format="dd/MM/yyyy" TargetControlID="txtPackingDate"> </cc4:CalendarExtender>                
                    </td>
                    <td>
                   &nbsp;
                    </td>
                    <td>
             <asp:Button ID="btnDailyRepoprt" runat="server" Text="Daily Report" OnClick="btnDailyRepoprt_Click"  CssClass="AButton" Width="87px" />
                    </td>
                </tr>
            </table>
                </td>
