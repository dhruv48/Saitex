<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Yrn_Production_Adjustment.aspx.cs" Inherits="Module_Production_Pages_Yrn_Production_Adjustment" %>
...
<body>   
   <link href="../../../StyleSheet/CommonStyle.css" rel="stylesheet" type="text/css" />
    <script language="javascript" type="text/javascript">
        ...
        function GetRowValue(val, TextBoxId,  txtQtyUnit, QtyUnit, txtQtyUom, QtyUom, txtQtyWeight, QtyWeight) {

//            txtBasicRate, Rate, AmountId, Amount,
        ...
        <table class="tContentArial" style="background-color: #afcae4" width="90%">
            <tr>
                <td class="TableHeader td tdCenter">
                    <strong>Cheese Adjustment</strong>
                </td>
            </tr>
            <tr>
