<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Loose_Packed_YarnRecQuery.ascx.cs" Inherits="Module_Production_Controls_Loose_Packed_YarnRecQuery" %>
...
<asp:ImageButton ID="imgBtnExportExcel" runat="server" Width="48" Height="41" ToolTip="Print"
               ...
               <table width="100%" class ="td">
                 ...
                 <td align="center" valign="top" class="tRowColorAdmin ">
                  <span class="titleheading">Yarn Packing Against Production Query</span>
                            </td>
                        </tr>
                    </table>
     <table width="95%" >
      ...
      <cc2:ComboBox ID="ddllotno" runat="server" CssClass="smallfont" Width="130px" MenuWidth="450px" EnableLoadOnDemand="true" EnableVirtualScrolling="true"
        ...
        <td>
         <asp:DropDownList ID="ddlLocation" runat="server" CssClass="SmallFont" 
                Font-Size="8" Width="150px" TabIndex="3" ></asp:DropDownList>
        </td>
        <td align="right">
           Packing Date :
         </td>
        ...
        <asp:GridView ID="GridYarnLoosePacking" runat="server" AutoGenerateColumns="False" Width="100%"
          ...
          OnPageIndexChanging="GridYarnLoosePacking_PageIndexChanging"
            ...
            <asp:TemplateField HeaderText="Date">
                                             <ItemTemplate>
                                            <asp:Label ID="lblDate" runat="server" CssClass="Label SmallFont" Text='<%# Bind("PACKING_DATE","{0:dd/MM/yyyy}") %>' ></asp:Label>
                                            </ItemTemplate>                                                                         
                                            </asp:TemplateField>     
            
            <asp:BoundField DataField="PACKING_NO" HeaderText="P&nbsp;No" />           
             <asp:TemplateField HeaderText="Yarn&nbsp;Desc">
                                             <ItemTemplate>
                                            <asp:Label ID="lblYarnCode" runat="server" CssClass="Label SmallFont" Text='<%# Bind("YARN_DESC") %>' ToolTip='<%# Bind("YARN_CODE") %>'></asp:Label>
                                            </ItemTemplate>                                                                         
                                            </asp:TemplateField>     
            ...
            <asp:BoundField DataField="GRADE" HeaderText="Grade" />             
              <asp:TemplateField HeaderText="Carton&nbsp;No">
                                             <ItemTemplate>
                                            <asp:Label ID="lblCortonNo" runat="server" CssClass="Label SmallFont" Text='<%# Bind("CARTON_NO") %>' ForeColor="Green" Font-Bold="true"></asp:Label>
                                            </ItemTemplate>
                                            <FooterTemplate>
                   ...
                   <asp:TemplateField HeaderText="Gross&nbsp;Wt">
                                             <ItemTemplate>
                                            <asp:Label ID="lblGrossWt" runat="server" CssClass="Label SmallFont" Text='<%# Bind("GROSS_WT") %>' ForeColor="DarkBlue" Font-Bold="true"></asp:Label>
                                            </ItemTemplate>
                                            <FooterTemplate>
             ...
             <asp:TemplateField HeaderText="Tare&nbsp;Wt">
                                             <ItemTemplate>
                                            <asp:Label ID="lblTareWt" runat="server" CssClass="Label SmallFont" Text='<%# Bind("TARE_WT") %>' ForeColor="DarkOrchid" Font-Bold="true"></asp:Label>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                             ...
                                             <ItemTemplate>
                                            <asp:Label ID="lblNetWt" runat="server" CssClass="Label SmallFont" Text='<%# Bind("NET_WT") %>' ForeColor="Green" Font-Bold="true"></asp:Label>
                                            </ItemTemplate>
                                            <FooterTemplate>
            ...
            <asp:BoundField DataField="AVG_WT" HeaderText="Avg&nbsp;Wt" />
             <asp:BoundField DataField="UOM" HeaderText="UOM" />           
                 ...
                 <%-- <asp:TemplateField HeaderText="Issue&nbsp;Wt">
                                             <ItemTemplate>
                                            <asp:Label ID="lblIssueWt" runat="server" CssClass="Label SmallFont" Text='<%# Bind("ISSUE_WT") %>' ForeColor="Red" Font-Bold="true"></asp:Label>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                             <asp:Label ID="lblTotalIssueWt" runat="server" CssClass="Label SmallFont" ForeColor="White" Font-Bold="true"></asp:Label>                                           
                                            </FooterTemplate>                                     
                                            </asp:TemplateField>              
              <asp:TemplateField HeaderText="Issue&nbsp;Cops">
                                             <ItemTemplate>
                                            <asp:Label ID="lblIssueCops" runat="server" CssClass="Label SmallFont" Text='<%# Bind("ISSUE_COPS") %>' ForeColor="DarkRed" Font-Bold="true"></asp:Label>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                             <asp:Label ID="lblTotalIssueCops" runat="server" CssClass="Label SmallFont" ForeColor="White" Font-Bold="true"></asp:Label>                                           
                                            </FooterTemplate>                                     
                                            </asp:TemplateField> --%>
