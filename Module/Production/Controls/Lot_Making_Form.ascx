<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Lot_Making_Form.ascx.cs" Inherits="Module_Production_Controls_LotMakingForm"  %>
    ...
    <tr class="td">
        ...
        <td align="left">
            <cc2:ComboBox ID="txtItemCode" runat="server"  CssClass="SmallFont"
                ...
                TabIndex="1" EnableVirtualScrolling="true" AutoPostBack="true" 
            ...
            <asp:RequiredFieldValidator ID="rfv4" runat="server" ControlToValidate="txtItemCode"
                Display="Dynamic" ErrorMessage="Pls enter POY." SetFocusOnError="True" ValidationGroup="M1"></asp:RequiredFieldValidator>
        </td>
        <td align="right">
            Merge No:
        </td>
        <td align="left">
          <%-- AutoPostBack="true" onselectedindexchanged="cmbLotNo_SelectedIndexChanged"--%>
            
            <cc2:ComboBox ID="cmbLotNo" runat="server"  CssClass="SmallFont"
                DataTextField="LOT_NO" DataValueField="PRTY_NAME" 
                EmptyText="Select Merge No" EnableLoadOnDemand="true"
                Height="200px" MenuWidth="350px" OnLoadingItems="cmbLotNo_LoadingItems" TabIndex="2"   
                EnableVirtualScrolling="true" onselectedindexchanged="cmbLotNo_SelectedIndexChanged"  AutoPostBack="true"
                >
                <HeaderTemplate>
                    <div class="header c1">
                        Merge No</div>
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="cmbLotNo"
                Display="Dynamic" ErrorMessage="Pls enter Merge No." SetFocusOnError="True" ValidationGroup="M1"></asp:RequiredFieldValidator>
