<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PackApprByFG.ascx.cs"
    Inherits="Module_Production_Controls_PackApprByFG" %>
        ...
        <table align="left" class="tContentArial" width="100%">
            ...
            <tr>
                <td align="center" class="TableHeader td" width="100%">
                    <b class="titleheading">Packed Goods Approval By FG</b>
                </td>
            </tr>
            <tr>
