<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MERGEWISE_DEPT_MACHINE_PRODUCTION_SUMMARY.ascx.cs" Inherits="Module_Production_Controls_MERGEWISE_DEPT_MACHINE_PRODUCTION_SUMMARY" %>
                    ...
                    <table width="100%" class ="td">
                        <tr>
                            <td align="center" valign="top" class="tRowColorAdmin ">
                                <span class="titleheading">MERGEWISE DEPT,MACHINE AND PRODUCTION SUMMARY</span>
                            </td>
                        </tr>
                    </table>
                    <table width="90%" >
                            ...
                            <EmptyDataRowStyle Font-Bold="True" Font-Size="Medium" />
                                        ...
                                        <Columns>                   
                                          ...
                                          <asp:BoundField DataField="DOFF_QTY" NullDisplayText="0" HeaderText="DOFF&nbsp;Production" />
                                           <asp:BoundField DataField="PRODUCTION_COPS" NullDisplayText="0" HeaderText="Production&nbsp;Cops" />
                                          <asp:BoundField DataField="ACTUAL_PACKING" NullDisplayText="0" HeaderText="Packing"/>
                                          <asp:BoundField DataField="PACKED_COPS" NullDisplayText="0" HeaderText="Packed&nbsp;Cops"/>
                                        </Columns>
