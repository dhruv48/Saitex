<%@ Control Language="C#" AutoEventWireup="true" CodeFile="YarnProductionDoffEntryFormTwistingNew.ascx.cs" Inherits="Module_Production_Controls_YarnProductionDoffEntryFormTwistingNew" %>
                ...
                <FooterTemplate>
                   ...
                   <tr>
                    ...
                    <cc2:ComboBox ID="cmbMachineGroup" runat="server" AutoPostBack="True" EnableLoadOnDemand="true"
                                    DataTextField="MACHINE_GROUP" DataValueField="MACHINE_GROUP"  Width="98%" MenuWidth="200px"
                                    Height="200px" CssClass="SmallFont" EmptyText="Select Machine Group" 
                    ...
                    <asp:TextBox ID="txtMachineCode" runat="server" Width="30%" ReadOnly="true" CssClass="TextBoxDisplay SmallFont"
             ...
             Lot Detail--%>
                            ...
                            <tr>
                                <td width="10%" class="tdLeft">
                                    <cc2:ComboBox ID="ddlLotNo" runat="server" DataTextField="LOT_NUMBER" DataValueField="LOT_DATA"
                                        ...
                                        <ItemTemplate>
                                        <div class="item c2">
                                                <asp:Literal ID="Literal10" runat="server" Text='<%# Eval("LOAD_DATE") %>' />
                                            </div>
                                            <div class="item c1">
                                                <asp:Literal ID="Literal11" runat="server" Text='<%# Eval("PROS_ID_NO") %>' />
                                            </div>
                                            <div class="item c6">
                                          ...
                                          <div class="item c5">
                                                <asp:Literal ID="Literal12" runat="server" Text='<%# Eval("MACHINE_CODE") %>' />
                                            </div>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                            Displaying items
                ...
                <FooterTemplate>
                    ...
                    <%# Container.ItemsCount %>.
                            ...
                            Font-Size="XX-Small" TabIndex="15"> 
