<%@ Control Language="C#" AutoEventWireup="true" CodeFile="YarnProductionDoffEntryFormTwisting.ascx.cs" Inherits="Module_Production_Controls_YarnProductionDoffEntryFormTwisting" %>
    ...
    <tr>
        <td align="left" class="td" width="100%">
            <table width="100%">
                ...
                Height="200px" MenuWidth="450px" TabIndex="1" EnableVirtualScrolling="true" Width="98%"
