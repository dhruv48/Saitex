<%@ Control Language="C#" AutoEventWireup="true" CodeFile="POYIssueToMachine.ascx.cs" Inherits="Module_Production_Controls_POYIssueToMachine" %>
                ...
                <tr>
                    <td id="tdSave" runat="server">
                        <asp:ImageButton ID="imgbtnSave" OnClick="imgbtnSave_Click" runat="server" ToolTip="Save"
                            ImageUrl="~/CommonImages/save.jpg" ValidationGroup="YM" TabIndex="19"></asp:ImageButton>
                    </td>
    ...
    <tr>
        <td align="center" class="TableHeader td" width="100%">
            <b class="titleheading">
                <asp:Label ID="lblFormHeading" runat="server" CssClass="SmallFont">POY ISSUE TO MACHINE FORM</asp:Label></b>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td align="left" class="td" width="100%">
            <table width="100%">
                ...
                DataTextField="MERGE_NO" DataValueField="TRN_DATA" EmptyText="Select Merge No" EnableLoadOnDemand="true"
                Height="200px" MenuWidth="600px" TabIndex="1" EnableVirtualScrolling="true" Width="98%"
                ...
                <ItemTemplate>
                    <div class="item c6">
                        <asp:Literal ID="ltr2" runat="server" Text='<%# Eval("MERGE_NO")%>'></asp:Literal>
                    </div>
                   <div class="item c4">
                        <asp:Literal ID="Literal10" runat="server" Text='<%# Eval("FIBER_DESC")%>'></asp:Literal>
                    </div>
                      <div class="item c4">
                        <asp:Literal ID="Literal11" runat="server" Text='<%# Eval("PRTY_NAME")%>'></asp:Literal>
                    </div>
                </ItemTemplate>
                <FooterTemplate>
                    Displaying items
                    ...
                    <td class="tdLeft" colspan="5" width="66%">
                     <asp:Label ID="txtMergeNo" runat="server"   CssClass="SmallFont" Font-Bold="true"></asp:Label>&nbsp;
                        &nbsp;    
                                            
                        <asp:Label ID="txtQuality" runat="server"    CssClass="SmallFont"    Font-Bold="true"></asp:Label> &nbsp;  
                         <asp:Label ID="txtLotType" runat="server"    CssClass="SmallFont" Font-Bold="true"></asp:Label>
                   ...
                   <tr>
                    ...
                    <td class="tdRight" width="17%" colspan="2">
                       <asp:TextBox ID="txtMachineDesc" runat="server" Width="90%" ReadOnly="true" CssClass="TextBoxNo SmallFont"
                            ></asp:TextBox>
                    
                         <asp:TextBox ID="txtProsDesc" runat="server" Width="1%" ReadOnly="true" CssClass="TextBoxNo SmallFont"
                ...
                <tr>
                    ...
                    <td class="tdLeft" width="17%">
                        <asp:TextBox ID="txtLoadingDate" runat="server"  CssClass="TextBoxNo SmallFont"  Width="40%" TabIndex="7"></asp:TextBox> <%--OnTextChanged="txtLoadingDate_TextChanged"--%>
                         ...
                         <cc1:TimeSelector ID="startTime" runat="server" SelectedTimeFormat="Twelve"      TabIndex="8" Width="50%" CssClass="TextBoxNo SmallFont"     DisplaySeconds="false" AmPm="AM"    > </cc1:TimeSelector>
                      ...
                      <%--  <cc1:MaskedEditExtender TargetControlID="txtLoadingDate" ID="meeLoadingDate" runat="server"
                        ...
                        <%--    <cc1:MaskedEditExtender TargetControlID="txtLoadingDate" ID="meeLoadingDate" runat="server"
                            ...
                            OnInvalidCssClass="MaskedEditError" MaskType="DateTime" CultureName="en-CA"  />
                    ...
                    <td class="tdLeft" width="17%">
                      <asp:TextBox ID="txtOperator" runat="server"  Width="99%" CssClass="TextBoxNo SmallFont" TabIndex="9"></asp:TextBox>
                    ...
                    <td class="tdLeft" width="15%">
                        <asp:TextBox ID="txtSupervisor" runat="server"  Width="99%" CssClass="TextBoxNo SmallFont" TabIndex="10"></asp:TextBox>
                    </td>
                ...
                <tr id="timetr" runat="server" visible="false">
                    ...
                    <td class="tdLeft" width="17%">
                        <asp:TextBox ID="txtMachineStopage" runat="server" AutoPostBack="True" OnTextChanged="txtMachineStopage_TextChanged"
                            CssClass="SmallFont"   Width="80px" TabIndex="11">0</asp:TextBox>Min.<asp:LinkButton ID="lbtnmacStopDetail" runat="server" OnClick="lbtnmacStopDetail_Click"
                            Text="Mac Stopage"  ></asp:LinkButton>
                    </td>
                    <td class="tdRight" width="17%">
                     End Time
                    </td>
                    <td class="tdLeft" width="17%">
                       <asp:TextBox ID="txtUnLoadingDate" runat="server" AutoPostBack="True" OnTextChanged="txtUnLoadingDate_TextChanged"
                            CssClass="SmallFont"  Width="99%" TabIndex="12"></asp:TextBox>
                   ...
                   <td class="tdRight" width="17%">
                    ...
                    <td class="tdLeft" width="15%">
                        <asp:TextBox ID="txtProcessTime" runat="server" ReadOnly="true" CssClass="TextBoxNo TextBoxDisplay"
                             Width="70%" TabIndex="13"></asp:TextBox>
                       Hours <%--Min.--%>
                    </td>
                </tr>
                <tr>    <td class="tdRight" width="17%">
                    ...
                    <td class="tdLeft" width="17%">
                          <asp:TextBox ID="txtRemarks" runat="server"  Width="100%" CssClass="TextBoxNo SmallFont" TabIndex="14"></asp:TextBox> 
                    </td>
                     <td class="tdRight" width="17%">
                    <%--  Net&nbsp;Wt.--%>
                    </td>
                    <td class="tdLeft" width="17%">
                        <asp:TextBox ID="txtDoffingNetWt" runat="server"   CssClass="TextBoxNo SmallFont"   Width="99%" Visible="false"></asp:TextBox>
                    </td>
                    <td class="tdRight" width="17%" colspan=2>
                ...
                <tr>
                    <td class="tdRight" width="100%">
                        <table width="100%">
                            ...
                            <tr>
                                <td width="10%" >
                                    <cc2:ComboBox ID="ddlLotNo" runat="server" DataTextField="LOT_NUMBER" DataValueField="LOT_DATA"
                                        EnableLoadOnDemand="true" Height="200px" MenuWidth="500px" OnLoadingItems="ddlLotNo_LoadingItems"
                                        OnSelectedIndexChanged="ddlLotNo_SelectedIndexChanged" Width="99%" AutoPostBack="True" TabIndex="15">
                                        <HeaderTemplate>
                                            <div class="header c6">
                                                Batch No</div>
                                        ...
                                        <ItemTemplate>
                                            <div class="item c6">
                                              ...
                                              <div class="item c4">
                                                <asp:Literal ID="Literal10" runat="server" Text='<%# Eval("ARTICLE_DESC") %>' />
                                            </div>
                                               <div class="item c3">
                                                <asp:Literal ID="Container1" runat="server" Text='<%# Eval("STOCK_QTY") %>' />
                                            </div>
                            ...
                            Width="60px" Text="Adj. Rec." />
                                </td>
                                <td width="5%" class="tdLeft">
                                    <asp:TextBox ID="txtLoadNoOfUnit" runat="server" CssClass="TextBoxNo SmallFont" Width="90%"
                                        Wrap="true" TabIndex="16"></asp:TextBox><%--AutoPostBack="True" OnTextChanged="txtLoadNoOfUnit_TextChanged" --%>
                                </td>
