<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PackApprByFG_YS.ascx.cs" Inherits="Module_Production_Controls_PackApprByFG_YS" %>
        ...
        <table align="left" class="tContentArial" width="100%">
            ...
            <tr>
                <td align="center" class="TableHeader td" width="100%">
                    <b class="titleheading">Yarn Spining Packed Goods Approval By FG</b>
                </td>
            </tr>
            <tr>
                        ...
                        <asp:GridView ID="grdFGTrans" runat="server" AutoGenerateColumns="False" CssClass="SmallFont"
                            ...
                            <Columns>
                               ...
                               <asp:TemplateField HeaderText="Yarn">
                                ...
                                <asp:BoundField HeaderText="Total_Cart" DataField="TOTAL_CART" />
                                <asp:BoundField HeaderText="Nt. Wt in Cartoon" DataField="NETTWT_C"  />
                                <asp:BoundField HeaderText="Total Weight(in KG.)" DataField="WEIGHT_IN_KG"  />
                            </Columns>
