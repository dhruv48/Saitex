<%@ Control Language="C#" AutoEventWireup="true" CodeFile="OrderPacking4YS1.ascx.cs" Inherits="Module_Production_Controls_OrderPacking4YS1" %>
...
<table id="tblMain" runat="server" align="left" width="99%" class="tContentArial tablebox"
    ...
    <tr>
        <td class="TableHeader td" align="center" width="100%">
            <b class="titleheading">Order Packing Yarn Spining</b></td>
    </tr>
    <tr>
        <td class="td" width="100%">
            <table cellpadding="0" cellspacing="0" border="0" align="left" class="tContentArial"
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <td align="left" valign="top" colspan="5" width="83%">
