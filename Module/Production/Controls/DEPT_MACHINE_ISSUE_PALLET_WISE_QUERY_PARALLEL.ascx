<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DEPT_MACHINE_ISSUE_PALLET_WISE_QUERY_PARALLEL.ascx.cs" Inherits="Module_Production_Controls_DEPT_MACHINE_ISSUE_PALLET_WISE_QUERY_PARALLEL" %>
                    ...
                    <table width="100%" class ="td">
                        <tr>
                            <td align="center" valign="top" class="tRowColorAdmin ">
                                <span class="titleheading">Department/Machine Issue Details Pallet Wise</span>
                            </td>
                        </tr>
                    </table>
                    <table width="75%" >
