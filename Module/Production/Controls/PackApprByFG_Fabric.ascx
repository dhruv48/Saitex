<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PackApprByFG_Fabric.ascx.cs" Inherits="Module_Production_Controls_PackApprByFG_Fabric" %>
        ...
        <table align="left" class="tContentArial" width="100%">
            ...
            <tr>
                <td align="center" class="TableHeader td" width="100%">
                    <b class="titleheading">Packed Goods Approval By FG (Fabric)</b>
                </td>
            </tr>
            <tr>
