<%@ Control Language="C#" AutoEventWireup="true" CodeFile="YarnProductionEntryForm.ascx.cs" Inherits="Module_Production_Controls_YarnProductionEntryForm" %>
                            ...
                            <tr>
                                    ...
                                    <cc2:ComboBox ID="ddlLotNo" runat="server" DataTextField="LOT_NUMBER" DataValueField="LOT_DATA"
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <div class="item c4">
                                              ...
                                              <div class="item c5">
                                                <asp:Literal ID="Literal10" runat="server" Text='<%# Eval("ORD_ASS_ARTICAL_DESC") %>' />
                                            </div>
                                          <%--  <div class="item c2">
                                ...
                                <td width="5%" class="tdLeft">
                                    <asp:TextBox ID="txtLoadNoOfUnit" runat="server" CssClass="TextBoxNo SmallFont" Width="90%"
                                        AutoPostBack="True" OnTextChanged="txtLoadNoOfUnit_TextChanged" Wrap="true" TabIndex="16"></asp:TextBox>
                                </td>
                            ...
                            <asp:GridView ID="grdLotDetail" runat="server" AutoGenerateColumns="False" CssClass="SmallFont"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="L/B.Number">
                                        <ItemTemplate>
                                            <asp:Label ID="lblFromLot" runat="server" CssClass="LabelNo SmallFont" Text='<%# Bind("FR_BATCH_NO") %>'></asp:Label>
                                        -
