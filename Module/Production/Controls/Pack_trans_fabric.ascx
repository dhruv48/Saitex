<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Pack_trans_fabric.ascx.cs" Inherits="Module_Production_Controls_Pack_trans_fabric" %>
        ...
        <table align="left" class="tContentArial" width="100%">
            ...
            <tr>
                <td align="center" class="TableHeader td" width="100%">
                    <b class="titleheading">Packed Goods transfer to FG (Fabric)</b>
                </td>
            </tr>
            <tr>
