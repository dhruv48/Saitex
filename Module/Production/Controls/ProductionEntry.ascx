<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ProductionEntry.ascx.cs"
    Inherits="Module_Production_Controls_ProductionEntry" %>
    ...
    <tr>
        ...
        <td colspan="5">
            <asp:DropDownList ID="ddlPItype" runat="server" DataTextField="PI_TYPE" DataValueField="PI_TYPE"
                Visible="false" Width="128px" AutoPostBack="True" CssClass="tContentArial">
            </asp:DropDownList>
        </td>
    </tr>
    <tr>
                    ...
                    <td class="td tContentArial">
                        <asp:Panel ID="pnlShowHover" runat="server" Width="950px" BackColor="Beige" BorderWidth="2px"
                            ...
                            <asp:GridView ID="GridProductEntry" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                                Width="400%" CellPadding="4" ForeColor="#333333" GridLines="None" HeaderStyle-Wrap="true"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="PROS_ID_NO" HeaderText="PROS ID_NO" ItemStyle-HorizontalAlign="Right" />
                                    ...
                                    <asp:BoundField DataField="LOAD_QTY" HeaderText="LOAD QTY" DataFormatString="{0:0.00}"
                                        ItemStyle-HorizontalAlign="Right" />
                                    <asp:BoundField DataField="LOAD_NO_OF_UNIT" HeaderText="LOAD NO OF UNIT" ItemStyle-HorizontalAlign="Right" />
                                    <asp:BoundField DataField="LOAD_UOM_OF_UNIT" HeaderText="LOAD UOM OF UNIT" ItemStyle-HorizontalAlign="Right" />
                                    ...
                                    <asp:BoundField DataField="UNLOAD_QTY" HeaderText="UNLOAD QTY" ItemStyle-HorizontalAlign="Right" />
                                    <asp:BoundField DataField="UNLOAD_NO_OF_UNIT" HeaderText="UNLOAD NO OF UNIT" ItemStyle-HorizontalAlign="Right" />
