<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Lot_Making_Form_Twisted.ascx.cs" Inherits="Module_Production_Controls_Lot_Making_Form_Twisted"  %>
    ...
    <tr class="td">
        ...
        <td align="left">
            ...
            <cc2:ComboBox ID="cmbLotNo" runat="server"  CssClass="SmallFont"
                ...
                Height="200px" MenuWidth="350px" OnLoadingItems="cmbLotNo_LoadingItems" TabIndex="2" AutoPostBack="true"  EnableVirtualScrolling="true" 
