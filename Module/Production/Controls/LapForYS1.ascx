<%@ Control Language="C#" AutoEventWireup="true" CodeFile="LapForYS1.ascx.cs" Inherits="Module_Production_Controls_LapForYS1" %>
    ...
    <tr>
        <td align="center" class="TableHeader td" width="100%">
            <b class="titleheading">
                <asp:Label ID="lblFormHeading" runat="server" CssClass="SmallFont"> Lap Form</asp:Label></b>
        </td>
    </tr>
    <tr>
