<%@ Control Language="C#" AutoEventWireup="true" CodeFile="OrderPacking.ascx.cs"
    Inherits="Module_Production_Controls_OrderPacking" %>
...
<table id="tblMain" runat="server" align="left" width="99%" class="tContentArial tablebox"
    ...
    <tr>
        <td class="TableHeader td" align="center" width="100%">
            <b class="titleheading">Order Packing</b>
        </td>
    </tr>
    <tr>
        <td class="td" width="100%">
