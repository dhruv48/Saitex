<%@ Control Language="C#" AutoEventWireup="true" CodeFile="YarnProductionDoffEntryForm.ascx.cs" Inherits="Module_Production_Controls_YarnProductionDoffEntryForm" %>
...
<table width="100%" align="left" class="tContentArial">
    ...
    <tr>
        <td align="center" class="TableHeader td" width="100%">
            ...
            <asp:CheckBox ID="chkProduction" runat="server" Checked="true"  
                AutoPostBack="true" Text="From Production Issue Lot" 
    ...
    <tr>
        <td align="left" class="td" width="100%">
            <table width="100%">
                ...
                DataTextField="LOT_NO" DataValueField="PROD_DATA" EmptyText="Select Lot No" EnableLoadOnDemand="true"
                Height="200px" MenuWidth="500px" TabIndex="1" EnableVirtualScrolling="true" Width="98%"
                ...
                <ItemTemplate>
                    ...
                    <div class="item c3">
                        <asp:Literal ID="Literal7" runat="server" Text='<%# Eval("QUALITY")%>'></asp:Literal>
                    </div>
                    <div class="item c3">
                        <asp:Literal ID="Literal8" runat="server" Text='<%# Eval("PROS_ID_NO")%>'></asp:Literal>
                    </div>
                    <div class="item c3">
                        <asp:Literal ID="Literal10" runat="server" Text='<%# Eval("LOAD_QTY")%>'></asp:Literal>
                    </div>
                    <div class="item c3">
                        <asp:Literal ID="Literal11" runat="server" Text='<%# Eval("LOAD_NO_OF_UNIT")%>'></asp:Literal>
                    </div>
                </ItemTemplate>
                <FooterTemplate>
                    Displaying items
                            ...
                            <tr>
                                <td width="10%" class="tdLeft">
                                    <cc2:ComboBox ID="ddlLotNo" runat="server" DataTextField="LOT_NUMBER" DataValueField="LOT_DATA"
                                        EnableLoadOnDemand="true" Height="200px" MenuWidth="650px" OnLoadingItems="ddlLotNo_LoadingItems"
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <div class="item c4">
                                             ...
                                             <div class="item c4">
                                                <asp:Literal ID="Literal1" runat="server" Text='<%# Eval("ORD_ARTICAL_DESC") %>' />
                                            </div>
                                            <div class="item c2">
                                                <asp:Literal ID="Container3" runat="server" Text='<%# Eval("FR_BATCH_NO") %>' />
                                            </div>
                                            <div class="item c2">
                                                <asp:Literal ID="Container4" runat="server" Text='<%# Eval("LOAD_QTY") %>' />
                                            </div>
                                            <div class="item c2">
                                                <asp:Literal ID="Literal3" runat="server" Text='<%# Eval("LOAD_NO_OF_UNIT") %>' />
                                            </div>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                            Displaying items
                                ...
                                <td width="8%" class="tdRight" >
                                    <asp:TextBox ID="txtUnloadQty" runat="server" CssClass="TextBoxNo  SmallFont"
                                        Width="90%"  Wrap="true" TabIndex="12"></asp:TextBox>
                                ...
                                <td width="8%" class="tdLeft" >
                                    <asp:DropDownList ID="ddlUnloadUOM" runat="server" Width="90%" CssClass="SmallFont" TabIndex="14">
                                    </asp:DropDownList>
                                </td>
