<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WIP_4_YS.ascx.cs" Inherits="Module_Production_Queries_WIP_4_YS" %>
...
<table class="td tContentArial"  align="center" width="45%">
    ...
    <tr>
        ...
        <td>
            <asp:DropDownList ID="ddlOrderNo" runat="server" DataTextField="PI_NO" DataValueField="PI_NO"
