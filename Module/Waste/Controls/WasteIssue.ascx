<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WasteIssue.ascx.cs"
    Inherits="Module_Waste_Controls_WasteIssue" %>
...
<%--<asp:UpdatePanel ID="UpdatePanel123452" runat="server">
    <ContentTemplate>--%>
        <table align="left" class=" td tContentArial" width="945px">
            ...
            <tr>
                <td align="center" class="TableHeader td" colspan="8">
                    <span class="titleheading"><strong>Waste Transaction Query Form</strong></span>
                </td>
            </tr>
            <tr>
                <td align="right">
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlItemType" runat="server" CssClass="gCtrTxt " Font-Size="8" Visible="false"
                        Width="160px">
                    </asp:DropDownList>
                </td>
                <td align="right">
                        ...
                        <asp:GridView ID="GridLedger" runat="server" AutoGenerateColumns="False" HeaderStyle-Font-Bold="true"
                          ...
                          <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White"  />
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="ITEM_DESC" HeaderText="DESC" />
                                ...
                                <asp:BoundField DataField="FINAL_RATE" HeaderText="FINAL RATE" HeaderStyle-HorizontalAlign="Right" Visible=false
                                    ItemStyle-HorizontalAlign="Right" DataFormatString="{0:0.00}">
                                    <HeaderStyle HorizontalAlign="Right" />
                                    <ItemStyle HorizontalAlign="Right" />
                                </asp:BoundField>
                                <asp:BoundField DataField="FINAL_AMOUNT" HeaderText="FINAL AMOUNT" HeaderStyle-HorizontalAlign="Right" Visible=false
                                    ItemStyle-HorizontalAlign="Right" DataFormatString="{0:0.00}">
                                    <HeaderStyle HorizontalAlign="Right" />
                                    <ItemStyle HorizontalAlign="Right" />
                                </asp:BoundField>
                                <asp:BoundField DataField="PRTY_NAME" HeaderText="PARTY NAME"  />
                                <asp:BoundField DataField="PO_NUMB" HeaderText="PO NUMBER" HeaderStyle-HorizontalAlign="Right" Visible=false
                                    ItemStyle-HorizontalAlign="Right" />
                                <asp:BoundField DataField="BILL_NUMB" HeaderText="BILL NUMBER" HeaderStyle-HorizontalAlign="Right" 
                                    ItemStyle-HorizontalAlign="Right" />
                                <asp:BoundField DataField="LORY_NUMB" HeaderText="LORRY NUMBER" HeaderStyle-HorizontalAlign="Right" Visible=false
                                    ItemStyle-HorizontalAlign="Right">
                                    <HeaderStyle HorizontalAlign="Right" />
                                    <ItemStyle HorizontalAlign="Right" />
                                </asp:BoundField>
                                <asp:BoundField DataField="DEPT_NAME" HeaderText="DEPARTMENT" />
                                <asp:BoundField DataField="COST_CENTER_CODE" HeaderText="COST CODE" Visible=false />
                            </Columns>
