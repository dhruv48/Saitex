<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WasteStockAgeing.ascx.cs"
    Inherits="Module_Waste_Controls_WasteStockAgeing" %>
        ...
        <table class="td tContent" style="width: 724px">
            ...
            <tr>
                <td class="TableHeader td" align="center">
                    <span class="titleheading">Waste Stock Ageing</span>
                </td>
            </tr>
            <tr>
                <td class="tdLeft td">
                ...
                <td>
                    <table style="width: 715px">
                        <tr>
                            ...
                            <td class="tdRight">
                                <asp:Label ID="Label3" runat="server" Text="Item Type :" CssClass="Label" Visible=false></asp:Label>
                            </td>
                            <td class="tdLeft">
