<%@ Control Language="C#" AutoEventWireup="true" CodeFile="StockAgeingQuery.ascx.cs"
    Inherits="Module_Waste_Controls_StockAgeingQuery" %>
        ...
        <table align="left" class="tContentArial" width="100%">
            ...
            <tr width="100%">
                <td align="center" class="TableHeader td">
                    <b class="titleheading">Waste Stock Ageing Query</b>
                </td>
            </tr>
            <tr>
                            ...
                            <tr>
                                ...
                                <td align="left" style="width: 7%;">
                                    <asp:DropDownList ID="ddlItemType" runat="server" CssClass="SmallFont" Width="150px"
                                        TabIndex="5" AutoPostBack="true" OnSelectedIndexChanged="ddlItemType_SelectedIndexChanged" Visible="false">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                        </table>
            ...
            <tr>
                <td align="left" class="td" width="100%">
                    <asp:Panel ID="Panel1" runat="server" ScrollBars="Both" Height="350px" Width="95%">
                        <div id="divPrint" Width="95%">
                            <asp:GridView ID="grdStockAgeing" runat="server" AutoGenerateColumns="False" CssClass="SmallFont"  Width="95%"
                                ShowFooter="true" CellPadding="4" ForeColor="#333333" BorderStyle="Ridge" GridLines="Both"
                                OnRowDataBound="grdStockAgeing_RowDataBound" Font-Size="X-Small">
