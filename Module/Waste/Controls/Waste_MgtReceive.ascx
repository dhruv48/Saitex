<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Waste_MgtReceive.ascx.cs" Inherits="Module_Waste_Controls_Waste_MgtReceive" %>
...
<table align="left" class="tContentArial" width="100%">
    ...
    <tr>
        <td align="center" class="TableHeader td" width="100%">
            <span class="titleheading"><b>WASTE RECEIVING</b></span>
        </td>
    </tr>
    <tr>
        <td align="left" class="td" valign="top" width="100%">
        ...
        <td width="100%">
            <table width="100%" class="tdLeft">
                <tr>
                    ...
                    <td align="left" width="17%">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="DDLOrderType"
                            Display="None" ErrorMessage="Please Select Product Type " InitialValue="0" ValidationGroup="CR"></asp:RequiredFieldValidator>
                    </td>
                    <td align="right" width="17%">
                        WR No :
                    </td>
                    <td align="left" width="15%">
                        ...
                        <cc2:ComboBox ID="cmbOrderNo" TabIndex="4" runat="server" AutoPostBack="True" CssClass="smallfont"
                            DataTextField="WR_NO" DataValueField="Combined" EnableLoadOnDemand="True"
                ...
                <tr>
                    ...
                    <td align="left" width="17%">
                        <asp:DropDownList Width="120px" TabIndex="2" CssClass="SmallFont TextBox UpperCase"
                            ID="ddlProcess" runat="server" AutoPostBack="True" 
                            AppendDataBoundItems="True">
                        </asp:DropDownList>
                        <br />
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="DDLOrderType"
                            Display="None" ErrorMessage="Please Select Process " InitialValue="0" ValidationGroup="CR"></asp:RequiredFieldValidator>
                    </td>
                     <td align="right" width="17%">
                       Trn No.:
                    </td>
                    <td align="left" width="15%">
                        <asp:Label ID="lblTrnNo" runat="server" Width="120px" CssClass="TextBox TextBoxDisplay" ></asp:Label>
              ...
              <%--  <tr>
                    ...
                    <td align="left" colspan="4" class="tdLeft" width="66%">
                        <asp:TextBox ID="
                        " TabIndex="7" runat="server" CssClass="SmallFont TextBox TextBoxDisplay"
                    ...
                    <td class="td" width="100%">
                        <table width="100%">
                            <tr bgcolor="#006699">
                                ...
                                <td width="10%">
                                    <span class="titleheading"><b>Cat.Type</b></span>
                                </td>
                                <td  width="8%">
                            ...
                            <tr>
                                <td align="left" valign="top" width="26%">
                                    <cc2:ComboBox ID="cmbArticleNo" runat="server" AutoPostBack="True" CssClass="smallfont"
                                        ...
                                        MenuWidth="400" OnLoadingItems="cmbArticleNo_LoadingItems" OnSelectedIndexChanged="cmbArticleNo_SelectedIndexChanged"
                                ...
                                <td align="left" valign="top" width="8%">
                                    <asp:TextBox ID="Txtcatcode" runat="server" Width="90%" CssClass="TextBox TextBoxDisplay SmallFont"
                                        Font-Bold="False" ReadOnly="True"></asp:TextBox>
                                </td>
                                 <td align="left" valign="top" width="10%">
                                     <asp:TextBox ID="txtWasteQty" runat="server" CssClass="SmallFont TextBoxNo" Width="95%"
                              ...
                              <%--  <td align="left" valign="top" width="8%">
                                 ...
                                 <td align="left" valign="top" width="10%">
                                    <asp:TextBox ID="txtUom" runat="server" CssClass="TextBox TextBoxDisplay SmallFont" Width="95%"
                                        AutoPostBack="True" TabIndex="19"></asp:TextBox>
                                </td>
                               <%-- <td align="left" valign="top" width="10%">
                            ...
                            <tr>
                              <td id="Td1" align="left" valign="top" width="5%" runat="server" visible = "False" >
                                    <asp:TextBox ID="Txtpino" runat="server" TabIndex="12" CssClass="SmallFont TextBox"
                                        Width="95%"></asp:TextBox>
                                </td>
                                <td id="Td2" align="left" valign="top" width="5%" runat="server" visible = "False" >
                                    <asp:TextBox ID="TxttrnType" runat="server" TabIndex="12" CssClass="SmallFont TextBox"
                                        Width="95%"></asp:TextBox>
                                </td>
                                <td id="Td3" align="left" valign="top" width="5%" runat="server" visible = "False" >
                                ...
                                <td id="Td4" runat="server" align="left" class="td" width="100%">
                                    <asp:GridView ID="GridSpinningThread" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Cat.Type">
                                                <ItemTemplate>
                                                    <asp:Label ID="Txtcatcode" runat="server" CssClass="LabelNo SmallFont" Font-Bold="true"
                                                        Text='<%# Bind("CAT_CODE") %>'></asp:Label>
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Waste_QTY.">
                                                <ItemTemplate>
                                                    <asp:Label ID="txtWasteQty" runat="server" CssClass="LabelNo SmallFont" Text='<%# Bind("WASTE_QTY") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Left" VerticalAlign="Top" />
                                                <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
                                            </asp:TemplateField>
