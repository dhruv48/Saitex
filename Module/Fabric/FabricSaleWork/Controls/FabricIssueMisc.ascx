<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FabricIssueMisc.ascx.cs" Inherits="Module_Fabric_FabricSaleWork_Controls_FabricIssueMisc" %>
        ...
        <td class="td" width="100%">
            <table width="99%">
                ...
                <tr>
                    ...
                    <td width="9%">
                    <asp:DropDownList ID="ddlCostCode" CssClass="SmallFont" runat="server"></asp:DropDownList>
