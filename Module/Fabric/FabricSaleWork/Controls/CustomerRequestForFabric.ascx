<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CustomerRequestForFabric.ascx.cs"
                ...
                <td style="width: 100%">
                    <table width="100%" class="tdLeft">
                        ...
                        <tr>
                            ...
                            <td align="left" width="15%">
                                <uc1:PartyCodeLOV ID="cmbPartyCode" TabIndex="6" runat="server" />
                            </td>
                            <td align="left" colspan="6" class="tdLeft" width="100%">
                            ...
                            <td class="td">
                                <table width="100%">
                                    <tr bgcolor="#006699">
                                        ...
                                        <td class="style4">
                                            <span class="titleheading"><b>Fabric Base</b></span>
                                        </td>
                                        <td class="style3">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" valign="top" width="12%">
                                            <asp:TextBox ID="txtWeightofUnit" ReadOnly="true" runat="server" CssClass="SmallFont TextBoxNo TextBoxDisplay"
                                                Width="95%" AutoPostBack="True" OnTextChanged="txtWeightofUnit_TextChanged"></asp:TextBox>
