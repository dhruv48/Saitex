<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Fabric_Indent_Approval.ascx.cs" Inherits="Module_Inventory_Controls_Fabric_Indent_Approval" %>
...
<table align="left" border="0" cellpadding="0" cellspacing="0"  class="tContentArial">
    ...
    <tr>
        <td align="center" class="TableHeader" colspan="3">
            <b class="titleheading">Fabric Indent Approval</b>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td align="left" colspan="3">
            <asp:GridView ID="gvMaterialIndentApproval" runat="server" AllowSorting="True"  AllowPaging="true"
                AutoGenerateColumns="False" BorderWidth="1px" 
                OnPageIndexChanging="gvMaterialIndentApproval_Paging" PageSize="12">
                <Columns>
                   <%-- <asp:BoundField DataField="DEPT_NAME" HeaderText="Dept Code">
                    ...
                    <asp:BoundField DataField="FDESC" HeaderText="Fabric Description">
                        <ItemStyle CssClass="label smallfont" HorizontalAlign="Left" 
