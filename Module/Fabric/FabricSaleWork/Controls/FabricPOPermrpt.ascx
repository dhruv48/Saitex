<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FabricPOPermrpt.ascx.cs" Inherits="Module_Inventory_Controls_FabricPOPermrpt" %>
<table class="tContentArial">
    ...
    <tr>
        <td class="TableHeader td" align="center" width="100%">
            <span class="titleheading"><b>Print  Fabric Purchase Order
