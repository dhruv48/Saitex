<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Fabric_Receipt_PO.ascx.cs" Inherits="Module_Fabric_FabricSaleWork_Controls_Fabric_Receipt_PO" %>
...
<table class="tContentArial" width="100%">
    ...
    <tr>
        <td align="center" class="TableHeader td" width="100%">
            <b class="titleheading">Fabric Receiving Against PO Credit</b>
        </td>
    </tr>
    <tr>
                ...
                <tr>
                    ...
                    <td align="left" valign="top" width="17%">
                        <asp:TextBox ID="txtPartyBillNo" runat="server" TabIndex="6" Width="80px" CssClass="TextBox SmallFont"
                            OnTextChanged="txtPartyBillNo_TextChanged" AutoPostBack="True" MaxLength="50"></asp:TextBox>
                    </td>
                    <td align="right" valign="top" width="17%">
                    ...
                    <td align="left" valign="top" width="17%">
                        ...
                        <cc1:MaskedEditExtender ID="MaskedEditExtender1" runat="server" Mask="99/99/9999" MaskType="Date" PromptCharacter="_" TargetControlID="txtPartyBillDate"></cc1:MaskedEditExtender>
                    ...
                    <td align="left" valign="top" width="15%">
                        <asp:TextBox ID="txtTotalPartyAmt" runat="server" TabIndex="8" Width="80px" CssClass="TextBoxNo SmallFont"
                            AutoPostBack="True" OnTextChanged="txtPartyBillAmount_TextChanged" MaxLength="8"></asp:TextBox>
                            <cc1:FilteredTextBoxExtender ID="FiltertxtRate" runat="server"  TargetControlID="txtTotalPartyAmt"   FilterType="Custom, Numbers" ValidChars="."/>
                ...
                <tr>
                    <td colspan="13" cssclass="SmallFont">
                        ...
                        <asp:TextBox ID="txtUNIT" runat="server" CssClass="TextBox TextBoxDisplay SmallFont"
                            ReadOnly="true" Width="60px"></asp:TextBox>
                        &nbsp; ShadeCode:<asp:TextBox ID="txtShadeCode" runat="server" CssClass="TextBox TextBoxDisplay SmallFont"
                            ReadOnly="true" Width="60px"></asp:TextBox>
                        &nbsp;UOM:<asp:TextBox ID="txtUOm" runat="server" CssClass="TextBoxNo TextBoxDisplay SmallFont"
                            ReadOnly="true" Width="50px"></asp:TextBox>
                    </td>
                    <td>
            ...
            <asp:Panel ID="pnlGrid" runat="server" Width="100%">
                <asp:GridView ID="grdMaterialItemReceipt" Width="99%" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Farbic Code">
                            <ItemTemplate>
                                <asp:LinkButton ID="txtICODE" runat="server" CssClass="Label SmallFont" Text='<%# Bind("FABR_CODE") %>'
...
<asp:RangeValidator ID="rvbill" runat="server" ControlToValidate="txtPartyBillDate"
     ErrorMessage="Invalid Party Bill Date" Type="Date" ValidationGroup="M1"
   ></asp:RangeValidator>
