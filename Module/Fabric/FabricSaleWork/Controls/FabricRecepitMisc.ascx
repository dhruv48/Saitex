<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FabricRecepitMisc.ascx.cs"
    Inherits="Module_Fabric_FabricSaleWork_Controls_FabricRecepitMisc" %>
...
<table class="tdMain tContentArial" width="900px">
    ...
    <tr>
        <td align="center" class="TableHeader td" width="100%">
            <b class="titleheading">Fabric Receiving Misc</b>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td class="td" width="100%">
            <table width="100%">
                ...
                <tr>
                    <td class="tdLeft">
                        <cc2:ComboBox ID="txtItemCode" runat="server" AutoPostBack="True" CssClass="smallfont"
                            EnableLoadOnDemand="True" DataTextField="FABR_CODE" DataValueField="Combined"
                    ...
                    <td class="tdLeft">
                        <asp:DropDownList ID="ddlshadeCode" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlshadeCode_SelectedIndexChanged"
                            AppendDataBoundItems="True">
                            <asp:ListItem Text="Select"></asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <td class="tdLeft">
                        <asp:Button ID="btnSubDetail" runat="server" Font-Size="8pt" OnClick="btnSubDetail_Click"
                ...
                <tr>
                    <td colspan="9" cssclass="LabelNo SmallFont tdLeft">
                        <asp:Label ID="Label20" runat="server" CssClass="Label SmallFont" Text="Fabric Code / Desc :"></asp:Label>
                        ...
                        <asp:TemplateField HeaderText="Fabric Code">
                            <ItemTemplate>
                                <asp:Label ID="txtICODE" runat="server" CssClass="Label SmallFont" ReadOnly="true"
                                    Text='<%# Bind("FABR_CODE") %>' Width="70px"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
