<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FabricReciptCredit.ascx.cs" Inherits="Module_Inventory_Controls_FabricReciptCredit" %>
        ...
        <table class="tdMain" width="100%">
            ...
            <tr>
                <td align="center" class="TableHeader td" width="100%">
                    <b class="titleheading">M.R.N.(Fabric) Against PO Credit</b>
                </td>
            </tr>
            <tr>
                        ...
                        <tr>
                            <td>
                                <cc2:ComboBox ID="cmbPOITEM" runat="server" CssClass="SmallFont" EmptyText="select..."
                                    AutoPostBack="True" EnableLoadOnDemand="true" MenuWidth="620px" Width="80px" DataTextField="PO_NUMB" DataValueField="PO_NUMB"
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <div class="item c3">
                                            <asp:Literal runat="server" ID="Container3" Text='<%# Eval("FDESC") %>' /></div>
                                        <div class="item c2">
                        ...
                        <asp:GridView ID="grdMaterialItemReceipt" Width="99%" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Description">
                                    <ItemTemplate>
                                        <asp:Label ID="txtDESC" runat="server" CssClass="Label SmallFont" Text='<%# Bind("FDESC") %>'
