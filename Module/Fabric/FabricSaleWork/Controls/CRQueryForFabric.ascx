<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CRQueryForFabric.ascx.cs"
    Inherits="Module_Fabric_FabricSaleWork_Controls_CRQueryForFabric" %>
...
<table align="left" class="tContentArial" width="100%">
    ...
    <tr width="100%">
        <td align="center" class="TableHeader td">
            <b class="titleheading">Customer Request For Fabric Query Form</b>
        </td>
    </tr>
    <tr>
            ...
            <asp:Panel ID="pnlFilter" runat="server">
                <table>
                    <tr>
                        ...
                        <td align="left" style="width: 12%;">
                            <cc2:ComboBox ID="txtPartyCode" runat="server" AutoPostBack="True" EnableLoadOnDemand="true"
                                ...
                                EmptyText="Select Party" EnableVirtualScrolling="true"
                                 MenuWidth="400px" Height="200px"  Width="100px" 
                        ...
                        <td align="left" style="width: 12%;">
                            <asp:Button ID="Button1" runat="server" OnClientClick="javascript:CallPrint('ctl00_cphBody_CRQueryForFabric1_divPrint');"
                                Text="Print Records" OnClick="Button1_Click" /></td>
                    </tr>
                    <tr>
                        <td align="right" style="width: 12%;">
                            Shade Code :
        ...
        <td align="left" class="td" width="100%">
            ...
            <div id="divPrint" runat="server">
                <asp:GridView ID="grdCustomerRequest" runat="server" AutoGenerateColumns="False"
                    ...
                    EmptyDataText="No Record Found" PageSize="15" BackColor="White" 
                    BorderStyle="Ridge" EnableViewState="False">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Party Code" HeaderStyle-HorizontalAlign="Left">
                            <ItemTemplate>
                                <asp:Label ID="LblPartyCode" Text='<%#Eval("PRTY_CODE") %>' ToolTip='<%#Eval("PRTY_NAME") %>'
...
<HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                        ...
                        <asp:TemplateField HeaderText="Article No" HeaderStyle-HorizontalAlign="Left">
                            <ItemTemplate>
                                <asp:Label ID="LblArticleNo" Text='<%#Eval("ARTICLE_NO") %>' ToolTip='<%#Eval("YARN_DESC") %>'
                                    runat="server"></asp:Label>
                            </ItemTemplate>
