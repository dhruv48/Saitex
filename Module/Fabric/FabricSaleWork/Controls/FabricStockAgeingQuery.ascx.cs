...
using Common;
using System.Data;
public partial class Module_Fabric_FabricSaleWork_Controls_FabricStockAgeingQuery : System.Web.UI.UserControl
{
        ...
        try
        {
            ...
            if (CheckValidation())
            {
                ...
                DataTable dt = SaitexBL.Interface.Method.TX_FABRIC_MST.GetFabricStockAgingReport(oUserLoginDetail.COMP_CODE, strBranch, strItemType, iDay1, iDay2, iDay3);
                    //SaitexBL.Interface.Method.YRN_PROD_MST.GetYarnStockAgingReport(oUserLoginDetail.COMP_CODE, strBranch, strItemType, iDay1, iDay2, iDay3);
