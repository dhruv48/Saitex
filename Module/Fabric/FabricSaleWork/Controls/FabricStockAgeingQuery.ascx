<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FabricStockAgeingQuery.ascx.cs" Inherits="Module_Fabric_FabricSaleWork_Controls_FabricStockAgeingQuery" %>
        ...
        <table class="td tContent" style="width: 724px">
            ...
            <tr>
                <td class="TableHeader td" align="center">
                    <span class="titleheading">Fabric Stock Ageing</span>
                </td>
            </tr>
            <tr>
                <td class="tdLeft td">
            ...
            <tr>
                <td>
                    <table style="width: 715px">
                        <tr>
                            ...
                            <td class="tdRight">
                                <asp:Label ID="Label3" runat="server" Text="Fabric Type :" CssClass="Label"></asp:Label>
                            </td>
                            <td class="tdLeft">
                        ...
                        <tr>
                        <td> 
                            <asp:Button ID="GetRecord" Text="GetRecord" runat="server" OnClick="txtGetRecord_Click" /></td>
                        </tr>
                    </table>
                </td>
            </tr>
             ...
             <tr><td colspan = "9" class ="tContent">
                ...
                <asp:GridView ID="grdAgin" runat="server" AutoGenerateColumns="False" CssClass="SmallFont" ShowFooter="true" CellPadding="4" ForeColor="#333333" 
                    BorderStyle="Ridge" GridLines="Both" ont-Size="X-Small" AllowPaging="True" 
                               ...
                               <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" Width="100%" />
                                ...
                                <Columns>
                                    <asp:BoundField DataField="BRANCH_NAME" HeaderText="Branch"    HeaderStyle-HorizontalAlign ="Left" ItemStyle-HorizontalAlign ="Left" />
                                     <asp:BoundField DataField="FABR_CODE" HeaderText="Fabric Code"  HeaderStyle-HorizontalAlign ="Left" ItemStyle-HorizontalAlign ="Left" />                                     
                                     <asp:BoundField DataField="FABR_DESC" HeaderText="Fabric Description" HeaderStyle-HorizontalAlign ="Left" ItemStyle-HorizontalAlign ="Left" />
