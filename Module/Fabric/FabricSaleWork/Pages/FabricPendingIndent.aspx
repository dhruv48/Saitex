<%@ Page Title="" Language="C#" MasterPageFile="~/CommonMaster/admin.master" AutoEventWireup="true" CodeFile="FabricPendingIndent.aspx.cs" Inherits="Module_Fabric_FabricSaleWork_Pages_FabricPendingIndent" %>
   ...
   function test()
    {
         ...
         $(".viresh").colorbox({width:"90%", height:"90%", iframe:true,href:"FabricPendingIndentsDetail.aspx?BCODE="+BCODE+"&DCODE="+DCODE+"&YEAR="+YEAR});
        return false;
    }
   function test1(arg1)
     {
...
//         var YEAR=$('#<%= ddlYear.ClientID %>').val();  
//       
          window.showModalDialog("FabricPendingIndentsDetail.aspx?BCODE="+BCODE+"&DCODE="+DCODE,null,"dialogheight:400px; dialogWidth:800px; center:yes");
        }
    </script>
            ...
            <td class="td" colspan="4">
                <table align="left">
                    <tr>
                        ...
                        <td valign="top" align="center">
                          <asp:ImageButton ID="imgbtnClear" OnClick="imgbtnClear_Click" runat="server" ImageUrl="~/CommonImages/clear.jpg" ToolTip="Clear" Height="41" Width="48" />
                        </td>
                        <td valign="top" align="center">
