<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FabricPOIndentAdjustment.aspx.cs" Inherits="Module_Inventory_Pages_FabricPOIndentAdjustment" %>
...
<head id="Head1" runat="server">
    <title>Adjust Fabric Indent</title>
...
<body bgcolor="#afcae4">
    <form id="form2" style="background-color: #afcae4" runat="server">
    <div>
                ...
                <table class="tContentArial" style="background-color: #afcae4">
                    <tr>
                        <td class="TableHeader td tdCenter">
                            <span class="titleheading">Fabric Indent Adjustment</span>
                        </td>
                    </tr>
                    <tr>
                        <td class="tdCenter td SmallFont">
                            Adjust Indent For Fabric :
                            <asp:Label ID="lblAdjustFabricCode" CssClass="SmallFont Label" runat="server"></asp:Label>
                        </td>
                        
                    <tr>
                        <td class="tdCenter td SmallFont">
                            <asp:Label ID="lblFabricIndentAdjustmentError" runat="server" CssClass="SmallFont Label"
                                Font-Bold="False" ForeColor="Red"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="tdCenter td SmallFont">
                            <asp:Panel ID="pnlFabricIndentAdjustment" runat="server" ScrollBars="Vertical" Height="200px"
                                BackColor="#afcae4">
                    ...
                    <tr>
                        <td class="tdCenter td SmallFont">
                            <asp:Button ID="btnAdjustIndentFabric" runat="server" Text="Adjust Fabric Indent" OnClick="btnAdjustIndentItem_Click" />
                        </td>
                    </tr>
                </table>
            </ContentTemplate>
