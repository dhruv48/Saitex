<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Tx_Farbric_Recipt_Adjustment.aspx.cs" Inherits="Module_Fabric_FabricSaleWork_Pages_Tx_Farbric_Recipt_Adjustment" %>
...
<body>
    ...
    <div>
        ...
        <table class="tContentArial" style="background-color: #afcae4">
            ...
            <tr>
                <td class="tdCenter td SmallFont">
                    <asp:Label ID="lblReceiptAdjustmentError" runat="server" Font-Bold="False" 
                        ForeColor="Red"></asp:Label>
                </td>
            </tr>
            <tr>
                <td class="tdCenter td SmallFont">
                    <asp:Panel ID="pnlIndentAdjustment" runat="server" BackColor="#afcae4" 
                        Height="400px" ScrollBars="Vertical">
                        <asp:GridView ID="grdReceiptAdjustment" runat="server" 
                            AutoGenerateColumns="False" OnRowCommand="grdReceiptAdjustment_RowCommand" 
                            ShowFooter="True">
                            <Columns>
                                <asp:TemplateField HeaderText="Receipt Number">
                                    <ItemTemplate>
                                        ...
                                        <asp:Label ID="lblAPPR_QTY" runat="server" Text='<%# Bind("QTY") %>' 
                                ...
                                <asp:TemplateField HeaderText="Adjust QTY Unit" Visible="false">
                                    ...
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtAdjustedReceiptQTYUnit" runat="server" AutoPostBack="True" 
                                            CssClass="TextBoxNo TextBoxDisplay SmallFont" Text='<%# Bind("NO_OF_UNIT") %>' 
                                            Width="50px"></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Adjust Uom Of Unit" Visible="false">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtAdjustedReceiptQTYUOM" runat="server" 
                                            CssClass="TextBoxDisplay SmallFont TextBox" ReadOnly="true" 
                                            Text='<%# Bind("UOM_OF_UNIT") %>' Width="70px"></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Adjust Weight Of Unit" Visible="false">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtAdjustedReceiptQTYWeight" runat="server" 
                                            AutoPostBack="True" CssClass="TextBoxDisplay SmallFont TextBoxNo" 
                                            ReadOnly="true" Text='<%# Bind("WEIGHT_OF_UNIT") %>' Width="70px"></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Adjust QTY">
                                    ...
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtAdjustedReceiptQTY" runat="server" AutoPostBack="True" 
                                            CssClass="SmallFont TextBoxNo" 
                                            OnTextChanged="txtAdjustedReceiptQTY_TextChanged1" Text="0" Width="50px"></asp:TextBox>
                                        <asp:RangeValidator ID="RangeValidator1" runat="server" 
                                            ControlToValidate="txtAdjustedReceiptQTY" 
                                            ErrorMessage="Only Numeric value allowed" MaximumValue="9999999999" 
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnAdjAll" runat="server" 
                                            CommandArgument='<%# Bind("TRN_NUMB") %>' CommandName="AdjAll" 
                                            Text="Adjust All" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
            ...
            <tr>
                <td class="tdCenter td SmallFont">
                    <asp:Button ID="btnAdjustReceiptItem" runat="server" 
                        OnClick="btnAdjustReceiptItem_Click" Text="Adjust Item Receipt" />
                </td>
            </tr>
        </table>
        <%--</ContentTemplate>
