<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Fabric_SUB_TRN_Misc.aspx.cs"
    Inherits="Module_Yarn_SalesWork_Pages_Fabric_SUB_TRN_Misc" %>
...
<head id="Head1" runat="server">
    <title>Generate Fabric Recieving Sub Tran</title>
                ...
                <table>
                    <tr>
                        <td align="center" class="td TableHeader" valign="top">
                            <strong class="titleheading">Sub Transaction of Fabric Receiving</strong>
                        </td>
                    </tr>
                    <%-- <tr>
                        <td align="center" class="td TableHeader" valign="top">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td align="left" valign="top">
                                        <asp:TextBox CssClass="SmallFont  UpperCase  TextBox " ID="txtLotNo" Width="70px"
                                            runat="server"></asp:TextBox>
                                        <br />
                                    </td>
                                    <td align="left" valign="top">
                                        <asp:TextBox ID="txtGrade" CssClass="SmallFont UpperCase TextBox" Width="70px" runat="server"></asp:TextBox>
                                        <br />
                                    </td>
                                    <td align="right" valign="top">
                                        <asp:TextBox ID="txtQty" CssClass="SmallFont TextBoxNo" Width="70px" runat="server"
                                    ...
                                    <td align="right" valign="top">
                                        <asp:TextBox ID="txtNoofUnit" CssClass="SmallFont TextBoxNo" runat="server" Width="70px"
                                            AutoPostBack="True" OnTextChanged="txtNoofUnit_TextChanged"></asp:TextBox>
                                    ...
                                    <td align="left" valign="top">
                                        <asp:DropDownList ID="ddlUOM" CssClass="SmallFont " runat="server">
                                            <%--<asp:ListItem Value="0">------Select---------</asp:ListItem>--%>
                                        </asp:DropDownList>
                                    </td>
                                    <td align="right" valign="top">
                                        <asp:TextBox ID="txtWeightofUnit" CssClass="SmallFont TextBoxNo" runat="server" Width="70px"
