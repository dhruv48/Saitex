<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FabricPendingIndentsDetail.aspx.cs" Inherits="Module_Fabric_FabricSaleWork_Pages_FabricPendingIndentsDetail" %>
                ...
                <asp:GridView ID="gvPendIndDetails" runat="server" AllowPaging="False" PagerSettings-Position="Bottom"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Item Description">
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:Label ID="lblDOJ" Text='<%#Eval("FABR_DESC") %>' runat="server"></asp:Label>
                            </ItemTemplate>
                            <ItemStyle Width="200px" HorizontalAlign="Left" />
                        </asp:TemplateField>
