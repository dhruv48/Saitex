<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TX_FABRIC_TRN_SUB.aspx.cs" Inherits="Module_Fabric_FabricSaleWork_Pages_TX_FABRIC_TRN_SUB" %>
                ...
                <table>
                    <tr>
                        <td align="center" class="td TableHeader" valign="top">
                            <strong class="titleheading">Sub Transaction of Fabric Receiving for Fabric :<asp:Label
                                ID="lblYarnCode" runat="server"></asp:Label>
                                of Shade :<asp:Label ID="txtShadeCode" runat="server"></asp:Label>
                            </strong>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="td tdLeft">
                            <table width="98%">
                                <tr bgcolor="#006699">
                                    ...
                                    <td align="left" class="tdLeft SmallFont" valign="top">
                                        <span class="titleheading"><b>FABRIC Status</b></span>
                                    </td>
                                    <td align="left" class="tdLeft SmallFont" valign="top">
                                        &nbsp;
                                    </td>
                                ...
                                <tr>
                                    <td align="left" valign="top">
                                        <asp:TextBox ID="txtLotNo" Width="70px" class="SmallFont uppercase" runat="server"></asp:TextBox>
                                        <br />
                                    </td>
                                    <td align="left" valign="top">
                                        <asp:TextBox ID="txtGrade" class="SmallFont uppercase" Width="70px" runat="server"></asp:TextBox>
                                        <br />
                                    </td>
                                    <td align="left" valign="top">
                                    ...
                                    <td align="left" valign="top">
                                        <asp:TextBox ID="txtNoofUnit" runat="server" class="SmallFont" Width="70px" AutoPostBack="True"
                                            OnTextChanged="txtNoofUnit_TextChanged"></asp:TextBox>
