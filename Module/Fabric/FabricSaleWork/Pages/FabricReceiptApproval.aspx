<%@ Page Title="" Language="C#" MasterPageFile="~/CommonMaster/admin.master" AutoEventWireup="true" CodeFile="FabricReceiptApproval.aspx.cs" Inherits="Module_Fabric_FabricSaleWork_Pages_FabricReceiptApproval" %>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:ImageButton ID="imgbtnPrint" runat="server" Height="41" 
                                ...
                                ToolTip="Print" Width="48" Visible="False" />
                            &nbsp;
                        </td>
                        <td>
                        ...
                        <td>
                            <asp:ImageButton ID="imgbtnHelp" runat="server" Height="41" 
                                ...
                                ToolTip="Help" Width="48" Visible="False" />
                        </td>
                    </tr>
                </table>
            </td>
