<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MRNDisTaxAdj.aspx.cs" Inherits="Module_Fabric_FabricSaleWork_Pages_MRNDisTaxAdj" %>
                        ...
                        <td class="td tdLeft">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtRate" runat="server" CssClass="SmallFont TextBox" Width="50px" MaxLength="6" AutoPostBack="true" ontextchanged="txtRate_TextChanged"></asp:TextBox>
