<%@ Control Language="C#" AutoEventWireup="true" CodeFile="OrderFlowDetail4YD1.ascx.cs" Inherits="Module_PlanningAndScheduling_Controls_OrderFlowDetail4YD1" %>
            ...
            <table width="100%">
                <tr>
                    <td align="center" style="background-color: #336799; color: white;">
                        <b class="titleheading">Order Detail </b>
                    </td>
                </tr>
            </table>
        </td>
