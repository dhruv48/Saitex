...
public partial class Module_PlanningAndScheduling_Controls_OrderFlowDetail4YD1 : System.Web.UI.UserControl
{
    ...
    protected void imgPrint_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            if (Page.IsValid)
            {
                ...
                string URL = "/Saitex/Module/PlanningAndScheduling/Reports/OrderDetailFlow.aspx" + QueryString;
