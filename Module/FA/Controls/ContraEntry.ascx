<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ContraEntry.ascx.cs" Inherits="Module_FA_Controls_ContraEntry" %>
...
<asp:UpdatePanel ID="UpdatePanel2" runat="server">
    <ContentTemplate>
        <table class="tContentArial">
            ...
            <tr class="TableHeader">
                <td align="center" valign="top" class="td">
                    <span class="titleheading">Bank Contra Entry</span>
                </td>
            </tr>
            <tr>
                <td class="tdLeft td">
                        ...
                        <tr>
                            ...
                            <td class="tdLeft">
                                ...
                                <asp:DropDownList ID="ddlVoucherNo" runat="server" AppendDataBoundItems="true" AutoPostBack="true"
                                    Width="100px" DataTextField="VCHR_NO" DataValueField="VCHR_NO" TabIndex="1" CssClass="SmallFont"
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td class="tdLeft" colspan="3">
                                            <asp:TextBox ID="txtDescription" runat="server" CssClass="TextBox" Width="659px"
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtDebitAmount" runat="server" Width="80px" TabIndex="8" CssClass="TextBoxNo"
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdLeft" colspan="6">
                                            <asp:TextBox ID="txtTranDescription" runat="server" CssClass="TextBox" Width="640px"
                                    ...
                                    <tr id="trCheque" runat="server">
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ddlChequeBookNo" runat="server" AppendDataBoundItems="true"
                                                Width="150px" DataTextField="CHEQUEBOOK_NO" DataValueField="CHEQUEBOOK_CODE"
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ddlChequeNo" runat="server" AppendDataBoundItems="true" Width="80px"
                            ...
                            <td>
                                <asp:GridView ID="grdJourenaldetails" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Cheque Book Code" Visible="false" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:Label ID="lblChequeBookCode" runat="server" Text='<%# Bind("CHEQUEBOOK_CODE") %>'
                                                    CssClass="LabelNo"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Cheque Book" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:Label ID="lblChequeBook" runat="server" Text='<%# Bind("CHEQUEBOOK_NO") %>'
                                                    CssClass="LabelNo"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Cheque No" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:Label ID="lblChequeNo" runat="server" Text='<%# Bind("CHEQUE_NO") %>' CssClass="LabelNo"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
        ...
        <cc4:CalendarExtender ID="ce1" runat="server" TargetControlID="txtJournalDate" OnClientDateSelectionChanged="checkDate"
            Format="dd/MM/yyyy">
