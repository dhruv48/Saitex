<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CashPayment.ascx.cs" Inherits="Module_FA_Controls_CashPayment" %>
        ...
        <table class="tContentArial">
            ...
            <tr class="TableHeader">
                <td align="center" valign="top" class="td">
                    <span class="titleheading">Cash Payment Voucher</span>
                </td>
            </tr>
            <tr>
                <td class="tdLeft td">
                        ...
                        <tr>
                            ...
                            <td class="tdLeft">
                                ...
                                <asp:DropDownList ID="ddlVoucherNo" runat="server" AppendDataBoundItems="true" AutoPostBack="true"
                                    Width="100px" DataTextField="VCHR_DTL" DataValueField="VCHR_NO" TabIndex="1"
                        ...
                        <tr>
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <asp:DropDownList ID="ddlEntry_TypeCR" runat="server" Width="50px" TabIndex="4" CssClass="SmallFont"
                                                Enabled="false">
                            ...
                            <td>
                                <table>
                                    <tr>
                                        ...
                                        <td class="tdLeft">
                                            <asp:TextBox ID="txtTranDescription" runat="server" CssClass="TextBox" Width="460px"
