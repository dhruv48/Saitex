<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BalanceSheet.ascx.cs"
    Inherits="Module_FA_Controls_BalanceSheet" %>
        ...
        <table>
            ...
            <tr class="TableHeader">
                <td class="td" align="center" valign="top">
                    <span class="titleheading">Balance Sheet</span>
                </td>
            </tr>
            <tr>
                <td class="td">
                    ...
                    <table>
                        <tr>
                            <td align="center" valign="top" colspan="2">
                                <asp:Label ID="lblAccountName" runat="server" CssClass="Label" Text="Balance Sheet"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="tdLeft">
                                <cc3:Grid ID="grdLedgerBook_Dr" runat="server" AutoPostBackOnSelect="True" AutoGenerateColumns="False"
                                    OnSelect="grdLedgerBook_Dr_Select" ShowFooter="false" AllowAddingRecords="false"
                                    ShowColumnsFooter="true" ShowTotalNumberOfPages="false" PageSize="100" AllowColumnReordering="true"
                                    AllowSorting="false" AllowPaging="false" OnRebind="grdLedgerBook_Dr_Rebind" OnRowDataBound="grdLedgerBook_Dr_RowDataBound">
                                    <Columns>
                                        <cc3:Column DataField="ACCOUNT_ID" ShowHeader="true" Visible="false" HeaderText="Liabilities"
                                            Width="10px">
                                        </cc3:Column>
                                        <cc3:Column DataField="ACCOUNT_NAME" ShowHeader="true" HeaderText="Liabilities" Width="220px">
                                        </cc3:Column>
                                        <cc3:Column DataField="DR_AMOUNT" ItemStyle-HorizontalAlign="Right" ShowHeader="true"
                                            HeaderText="Amount" Width="120px">
                                        </cc3:Column>
                                    </Columns>
                            ...
                            <td class="tdLeft">
                                <cc3:Grid ID="grdLedgerBook_Cr" runat="server" AutoPostBackOnSelect="True" AutoGenerateColumns="False"
                                    OnSelect="grdLedgerBook_Dr_Select" ShowFooter="false" AllowAddingRecords="false"
                                    ShowColumnsFooter="true" ShowTotalNumberOfPages="false" PageSize="100" AllowColumnReordering="true"
                                    AllowSorting="false" AllowPaging="false" OnRebind="grdLedgerBook_Cr_Rebind" OnRowDataBound="grdLedgerBook_Cr_RowDataBound">
                                    <Columns>
                                        <cc3:Column DataField="ACCOUNT_ID" ShowHeader="true" Visible="false" HeaderText="Assets"
                                            Width="10px">
                                        </cc3:Column>
                                        <cc3:Column DataField="ACCOUNT_NAME" ShowHeader="true" HeaderText="Assets" Width="220px">
                                        </cc3:Column>
