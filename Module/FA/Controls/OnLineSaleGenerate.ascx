<%@ Control Language="C#" AutoEventWireup="true" CodeFile="OnLineSaleGenerate.ascx.cs"
    Inherits="Module_FA_Controls_OnLineSaleGenerate" %>
        ...
        <table align="left" class="tContentArial">
            ...
            <tr>
                <td align="center" class="TableHeader td" width="100%">
                    <b class="titleheading">On Line Bill Vouching (Sale)</b>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="left" class="td">
                    <asp:GridView ID="grdBillGenerate" CssClass="SmallFont" runat="server" AllowSorting="True"
                        ...
                        OnRowCommand="grdBillGenerate_RowCommand">
                        <Columns>
