<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CashReceiptVoucher.ascx.cs"
    Inherits="Module_FA_Controls_CashReceiptVoucher" %>
        ...
        <table class="tContentArial">
            ...
            <tr class="TableHeader">
                <td align="center" valign="top" class="td">
                    <span class="titleheading">Cash Receipt Voucher</span>
                </td>
            </tr>
            <tr>
                <td class="tdLeft td">
