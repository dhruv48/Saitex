<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TradingAccount.ascx.cs"
    Inherits="Module_FA_Controls_TradingAccount" %>
...
--%>        <table>
            ...
            <tr class="TableHeader">
                <td align="center" valign="top" class="td">
                    <span class="titleheading">Trading Account</span>
                </td>
            </tr>
            <tr>
                <td class="td">
                    ...
                    <table>
                        ...
                        <tr>
                            <td align="left" valign="top" colspan="4">
                                <cc3:Grid ID="grdTrading" runat="server" AutoPostBackOnSelect="True" AutoGenerateColumns="False"
                                    OnSelect="grdTrading_Select" ShowFooter="false" AllowAddingRecords="false" ShowColumnsFooter="true"
                                    ShowTotalNumberOfPages="false" PageSize="100" AllowColumnReordering="true" AllowSorting="false"
                                    AllowPaging="false" OnRebind="grdTrading_Rebind" OnRowDataBound="grdTrading_RowDataBound">
                                    <Columns>
                                        <cc3:Column DataField="ACCOUNT_ID" ShowHeader="true" Visible="false" HeaderText="Particulars"
                                            Width="10px">
                                        </cc3:Column>
                                        <cc3:Column DataField="ACCOUNT_NAME" ShowHeader="true" HeaderText="Particulars" Width="275px">
                                        </cc3:Column>
                                        <cc3:Column DataField="CR_AMOUNT" ItemStyle-HorizontalAlign="Right" ShowHeader="true"
                                            HeaderText="Dr" Width="120px">
                                        </cc3:Column>
                                        <cc3:Column DataField="DR_AMOUNT" ShowHeader="true" HeaderText="Cr" Width="120px">
                                        </cc3:Column>
                                    </Columns>
