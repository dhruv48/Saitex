<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AdvancedAdviceConfirm.ascx.cs"
    Inherits="Module_FA_Controls_AdvancedAdviceConfirm" %>
        ...
        <table align="left" class="tContentArial">
            ...
            <tr>
                <td align="center" class="TableHeader td" width="100%">
                    <b class="titleheading">Advanced Advice Confirmation</b>
                </td>
            </tr>
            <tr>
            ...
            <tr id="trgrid" runat="server">
                <td align="left" class="td">
                    <asp:GridView ID="grdAdvancedAdviceConfirmation" CssClass="SmallFont" runat="server"
                        AllowSorting="True" AutoGenerateColumns="False" AllowPaging="True" OnPageIndexChanging="grdAdvancedAdviceConfirmation_PageIndexChanging">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Advice Date" HeaderStyle-HorizontalAlign ="Center">
                                <ItemTemplate>
                                    <asp:Label ID="lblAdviceDate" runat="server" HtmlEncode="false" Text='<%# Bind("ADV_DATE", "{0:dd-MM-yyyy}") %>'
                            ...
                            <asp:TemplateField HeaderText="Confirm" HeaderStyle-HorizontalAlign ="Center">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Confirm Date" HeaderStyle-HorizontalAlign ="Center">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Confirm By" HeaderStyle-HorizontalAlign ="Center">
                                <ItemTemplate>
