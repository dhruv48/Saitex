<%@ Control Language="C#" AutoEventWireup="true" CodeFile="JournalVoucherReport.ascx.cs"
    Inherits="Module_FA_Controls_JournalVoucherReport" %>
        ...
        <table class="td tContentArial">
            ...
            <tr>
                <td class="TableHeader td" align="center" colspan="4">
                    <b class="titleheading">Journal Voucher Report</b>
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    <table style="width: 412px">
                        ...
                        <tr>
                            <td colspan="2" align="center">
                                <asp:Button ID="btnprint" runat="server" Text="Print" OnClick="btnprint_Click" Style="height: 26px" />
                            </td>
                        </tr>
                    </table>
                </td>
