<%@ Control Language="C#" AutoEventWireup="true" CodeFile="LedgerMaster.ascx.cs"
    Inherits="FA_Controls_LedgerMaster" %>
                        ...
                        <tr>
                            ...
                            <td align="left" valign="top" style="height: 24px">
                                ...
                                <%--<asp:LinkButton ID="lnkbtnGroupCode" runat="server" ForeColor="BlueViolet" Font-Bold="true"
                                    Font-Italic="true" OnClick="lnkbtnGroupCode_Click">Click</asp:LinkButton>--%>
