<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ViewAllVouchers.ascx.cs"
    Inherits="Module_FA_Controls_ViewAllVouchers" %>
        ...
        <table class="tContentArial">
            ...
            <tr class="TableHeader">
                <td align="center" valign="top" class="td">
                    <span class="titleheading">View All Vouchers</span>
                </td>
            </tr>
            <tr>
                <td class="tdLeft td">
