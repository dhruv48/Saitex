<%@ Control Language="C#" AutoEventWireup="true" CodeFile="JournalEntry.ascx.cs"
    Inherits="Module_FA_Controls_JournalEntry" %>
        ...
        <table class="tContentArial">
            ...
            <tr class="TableHeader">
                <td align="center" valign="top" class="td">
                    <span class="titleheading">Journal Voucher</span>
                </td>
            </tr>
            <tr>
                <td class="tdLeft td">
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtDebitAmount" runat="server" Width="80px" TabIndex="8" 
                                                CssClass="TextBoxNo" style="text-align: right"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtCreditAmount" runat="server" Width="80px" TabIndex="9" 
                                                CssClass="TextBoxNo" style="text-align: right"></asp:TextBox>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdCentre">
                                            <asp:TextBox ID="txtLedgerPopUp" runat="server" Width="1px" Visible="false" AutoPostBack="true"
                                                OnTextChanged="txtLedgerPopUp_TextChanged" BackColor="#C1D3FB" BorderStyle="None"></asp:TextBox>
                                            <asp:Button ID="btnLedger" runat="server" Text="Add Ledger" TabIndex="15" OnClick="btnLedger_Click">
                                            </asp:Button>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <td>
                                <asp:GridView ID="grdJourenaldetails" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Debit Amount" HeaderStyle-HorizontalAlign ="Right" ItemStyle-HorizontalAlign = "Right"  FooterStyle-HorizontalAlign = "Right" FooterStyle-Font-Bold = "true">
                                            <FooterTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Credit Amount" HeaderStyle-HorizontalAlign ="Right" ItemStyle-HorizontalAlign = "Right"  FooterStyle-HorizontalAlign = "Right" FooterStyle-Font-Bold = "true">
                                            <FooterTemplate>
