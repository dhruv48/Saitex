<%@ Page Language="C#" MasterPageFile="~/CommonMaster/admin.master" AutoEventWireup="true" CodeFile="SewingThreadStockReport.aspx.cs" Inherits="Module_Yarn_SalesWork_Reports_YarnStockReport" Title="Untitled Page" %>
...
<table align="left" class=" td tContentArial" width="945px">
    ...
    <tr>
        <td align="center" class="TableHeader td" colspan="8">
            <span class="titleheading"><strong>Sewing Thread Stock Report  </strong></span>
        </td>
    </tr>
    <tr>
        <td align="right">
            ...
            <asp:Panel ID="pnlShowHover" runat="server" Height="350px" ScrollBars="Auto" Width="945px">
                <asp:GridView ID="GridLedger" runat="server" AllowPaging="True" AllowSorting="True"
                    ...
                    Font-Size="X-Small" ForeColor="#333333" PagerStyle-HorizontalAlign="Left" PageSize="25"
                     OnPageIndexChanging="GridLedger_PageIndexChanging1" Visible="False">
