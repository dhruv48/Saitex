<%@ Page Language="C#" MasterPageFile="~/CommonMaster/admin.master" AutoEventWireup="true" CodeFile="SewingThreadTransactionreport.aspx.cs" Inherits="Module_SewingThread_Reports_SewingThreadTransactionreport" Title="Untitled Page" %>
    ...
    <table align="left" class=" td tContentArial" width="945px">
        ...
        <tr>
            <td align="center" class="TableHeader td" colspan="8">
                <span class="titleheading"><strong> SEWING THREAD TRANSACTION REPORT</strong></span>
            </td>
        </tr>
        <tr>
            <td align="right">
