<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SW_Detail.ascx.cs" Inherits="Module_SewingThread_Controls_SW_Detail_Report" %>
           ...
           <table width="100%">
                <tr>
                    <td align="center" class="TableHeader td" colspan="8">
                        <b>&nbsp;</b><span class="titleheading"><strong> Sewing Detail Stock Report</strong> </span>
                    </td>
                </tr>
                <tr>
                    <td align="right">
                            ...
                            <td>
                                <asp:GridView ID="GrdYarnDetail" runat="server" AllowPaging="True" AllowSorting="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="YARN_CAT" HeaderText="SW Catagory" />
                                        <asp:BoundField DataField="YARN_TYPE" HeaderText="SW Type" />
