<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Invoice_Against_CR_Party.ascx.cs"
    Inherits="Module_SewingThread_Controls_Invoice_Against_CR_Party" %>
        ...
        <table class="tdMain" width="100%">
            ...
            <tr>
                <td align="center" class="TableHeader td" width="100%">
                    <b class="titleheading">Invoice Against Customer Request To Party</b>
                </td>
            </tr>
            <tr>
                ...
                <td width="100%" class="td">
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            Width="100%"></asp:Label>--%><asp:Label ID="Label7" runat="server" Text="Doc No :"
                            ...
                            Width="99%">
                        </asp:DropDownList>--%><asp:TextBox ID="txtDocNo" runat="server" TabIndex="14" Width="99%"
                        ...
                        <tr>
                            ...
                            <td valign="top" align="left" width="15%">
                                <cc2:ComboBox ID="CmBParty" runat="server" AutoPostBack="True" EnableLoadOnDemand="true"
                                    ...
                                    MenuWidth="550px" EnableVirtualScrolling="true" EmptyText="Select Transporter">
                                    <HeaderTemplate>
                                        <div class="header c1">
                                            Code</div>
                                        <div class="header c5">
                        ...
                        <tr id="trOther" runat="server" visible="false">
                            <td class="tdRight" colspan="6">
                                <asp:Panel ID="pnlOtherDTL" runat="server" BackColor="Desktop" BorderStyle="Ridge"
                                    BorderWidth="5px">
                                    <table>
                                        <tr>
                                            <td align="right">
