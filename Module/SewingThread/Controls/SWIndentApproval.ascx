<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SWIndentApproval.ascx.cs"
    Inherits="Module_Sewing_Thread_Controls_SWIndentApproval" %>
...
<table align="left" border="0" cellpadding="0" cellspacing="0" class="tContentArial">
    ...
    <tr>
        <td align="center" class="TableHeader td" colspan="3">
            <b class="titleheading">SW Indent Approval</b>
        </td>
    </tr>
    <tr>
            ...
            <asp:GridView ID="gvMaterialIndentApproval" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Indent Type">
                        <ItemTemplate>
                            <asp:Label ID="lblITEM_TYPE" runat="server" Text='<%# Bind("IND_TYPE") %>' ToolTip='<%# Bind("IND_TYPE") %>'></asp:Label>
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Approved Qty">
                        <ItemTemplate>
                            ...
                            <asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="txtApprovedQty"
                                Display="dynamic" ErrorMessage="Pls enter b/w 0 to 100000" MaximumValue="100000"
