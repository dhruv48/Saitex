<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SWThreadStockAgingReport.ascx.cs" Inherits="Module_SewingThread_Controls_SWThreadStockAgingReport" %>
                ...
                <td>
                    <table style="width: 715px">
                        <tr>
                            ...
                            <td class="tdRight">
                                <asp:Label ID="Label3" runat="server" Text="SW Type :" CssClass="Label"></asp:Label>
                            </td>
                            <td class="tdLeft">
