...
public partial class Module_SewingThread_Controls_SWThreadStockAgingReport : System.Web.UI.UserControl
{
    ...
    private void GetYarnType()
    {
        ...
        {
            DataTable dt = new DataTable();
            //dt = SaitexBL.Interface.Method.Yarn_Stock_Data.GetSweingThreadType();
    ...
    protected void imgbtnClear_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            Response.Redirect("./SWThreadStockAging.aspx", false);
        }
        catch (Exception ex)
        {
        ...
        try
        {
            if (ddlBranch.SelectedIndex > 0)
            {
                ...
                if (txtDay1.Text != string.Empty && txtDay2.Text != string.Empty && txtDay3.Text != string.Empty)
                {
                    ...
                    string URL = "./SWStockAging.aspx?strBranch=" + strBranch + "&strItemType=" + strItemType + "&strCatCode=" + strCatCode + "&strDay1=" + strDay1 + "&strDay2=" + strDay2 + "&strDay3=" + strDay3 + "";
                    //URL = URL.Replace("'", "$");
