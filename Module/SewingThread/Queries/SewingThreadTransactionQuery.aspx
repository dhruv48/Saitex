<%@ Page Language="C#" MasterPageFile="~/CommonMaster/admin.master" AutoEventWireup="true" CodeFile="SewingThreadTransactionQuery.aspx.cs" Inherits="Module_SewingThread_Queries_SewingThreadTransactionQuery" Title="Untitled Page" %>
            ...
            <table width="945px">
                <tr>
                    <td align="center" class="TableHeader td" colspan="13">
                        <span class="titleheading"><strong>Sewing Thread Transaction Query Form </strong></span>
                    </td>
                </tr>
                <tr>
                    <td align="right">
                ...
                <tr>
                    ...
                    <td class="tdLeft">
                        <cc2:combobox ID="ddlYarn" runat="server" CssClass="SmallFont" EmptyText="------------All----------"
                            EnableLoadOnDemand="True" Height="200px" MenuWidth="600px" OnLoadingItems="ddlYarn_LoadingItems"
                            Width="161px" EnableVirtualScrolling="True">
                            <HeaderTemplate>
                                <div class="header c2">
                                    SW Code</div>
                                <div class="header c4">
                ...
                <tr>
                    <td class="td tContentArial" colspan="8">
                        ...
                        <asp:GridView ID="grid_trn_Query" runat="server" AllowPaging="True" AllowSorting="True"
                                AutoGenerateColumns="False" CellPadding="3" BorderStyle="Ridge" 
                                CssClass="smallfont" Font-Size="X-Small"
                                ForeColor="#333333" PagerStyle-HorizontalAlign="Left" PageSize="15" 
                                Width="135%">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="YARN_DESC" HeaderText="SW DESC" />
