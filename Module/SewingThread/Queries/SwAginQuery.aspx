<%@ Page Title="" Language="C#" MasterPageFile="~/CommonMaster/admin.master" AutoEventWireup="true" CodeFile="SwAginQuery.aspx.cs" Inherits="Module_SewingThread_Queries_SwAginQuery" %>
  ...
  <table class="td tContent" style="width: 945px">
            ...
            <tr>
                <td class="TableHeader td" align="center">
                    <span class="titleheading">Sewing thread Stock Ageing</span>
                </td>
            </tr>
            <tr>
                <td class="tdLeft td">
                ...
                <td>
                    <table style="width: 945px">
                        ...
                        <td><asp:Button ID="txtGetRecord" runat="server" Text="GetRecord" 
                                onclick="txtGetRecord_Click"></asp:Button></td>
                        </tr>
            ...
            <tr><td colspan = "9" class ="tContent">
               
 

                               <asp:GridView ID="grdAgin" runat="server"  HeaderStyle-CssClass ="tContentArial"
                    AutoGenerateColumns="False"   CssClass ="tContentArial" AllowPaging ="true"
                                ShowFooter="true" CellPadding="4" ForeColor="#333333"  
                    BorderStyle="Ridge" GridLines="Both"
                               
                    onpageindexchanging="grdAgin_PageIndexChanging" onrowdatabound="grdAgin_RowDataBound1">
                               <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                ...
                                <Columns>
                                    ...
                                    <%-- <asp:BoundField DataField="YARN_CODE" HeaderText="Sw Code"  HeaderStyle-HorizontalAlign ="Left" ItemStyle-HorizontalAlign ="Left" />                                    
                                      <asp:BoundField DataField="YARN_DESC" HeaderText="Sw Description" HeaderStyle-HorizontalAlign ="Left" ItemStyle-HorizontalAlign ="Left" />--%>
                                     <asp:TemplateField HeaderStyle-HorizontalAlign="Right" HeaderText="Sw Code" FooterStyle-HorizontalAlign="Right">
                                      <ItemTemplate>
                                            <asp:Label ID="lblyarn" runat="server" Text='<%# Eval("YARN_CODE") %>' ToolTip = '<%# Eval("YARN_DESC") %>' ></asp:Label>
                                        </ItemTemplate>
                                     </asp:TemplateField>
