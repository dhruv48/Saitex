...
using Common;
using System.Data;
public partial class Module_SewingThread_Queries_SwAginQuery : System.Web.UI.Page
{
    ...
    protected void imgbtnPrint_Click(object sender, ImageClickEventArgs e)
    {
        ...
        try
        {
            if (ddlBranch.SelectedIndex > 0)
            {
                ...
                if (ddlCatCode.SelectedValue.ToString() != null && ddlCatCode.SelectedValue.ToString() != string.Empty)
                {
                ...
                if (txtDay1.Text != string.Empty && txtDay2.Text != string.Empty && txtDay3.Text != string.Empty)
                {
                    ...
                    string URL = "./YarnItemStockAge.aspx?strBranch=" + strBranch + "&strItemType=" + strItemType + "&strCatCode=" + strCatCode + "&strDay1=" + strDay1 + "&strDay2=" + strDay2 + "&strDay3=" + strDay3 + "";
                    //URL = URL.Replace("'", "$");
    ...
    private void BindStockAgeingGrid()
    {
        try
        {
            ...
            if (CheckValidation())
            {
                ...
                DataTable dt = SaitexBL.Interface.Method.YRN_PROD_MST.GetYarnStockAgingReport(oUserLoginDetail.COMP_CODE, strBranch, strItemType, strCatCode, iDay1, iDay2, iDay3,"","");
