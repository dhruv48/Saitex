<%@ Page Language="C#" MasterPageFile="~/CommonMaster/admin.master" AutoEventWireup="true" CodeFile="SewingThreadLedgerQuery.aspx.cs" Inherits="Module_SewingThread_Queries_SewingThreadLedgerQuery" Title="Untitled Page" %>
...
<table align="left" class=" td tContentArial" width="945px">
    ...
    <tr>
        <td align="center" class="TableHeader td" colspan="8">
            <span class="titleheading"><strong>Sewing Thread Ledger Query </strong></span>
        </td>
    </tr>
    <tr>
        <td align="right">
    ...
    <tr>
        ...
        <td align="center" colspan="2">
            <asp:Button ID="btnGetReport" runat="server" 
                Text="Get Report" onclick="btnGetReport_Click1" />
        </td>
    </tr>
    <tr>
