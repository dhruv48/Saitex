                ...
                <table border="0" cellpadding="3" cellspacing="0" width="600" class="tContentArial tablebox">
                    ...
                    <tr>
                        ...
                        <td align="left" valign="top" width="58%">
                            <asp:RadioButtonList ID="radLeaveSelection"  runat="server" RepeatColumns="2" RepeatDirection="Horizontal" TabIndex="2">
                    ...
                    <tr>
                        ...
                        <td align="left" valign="top" width="58%">
                            <asp:TextBox ID="txtHoildayName" runat="server" Width="200px" CssClass="gCtrTxt UpperCase"
                    ...
                    <tr>
                        ...
                        <td align="left" valign="top" width="58%">
                            <asp:TextBox ID="txtHoildayDate" runat="server" Width="200px" CssClass="gCtrTxt" MaxLength="25"
                ...
                <tr>
                    <td align="left" valign="top" class="td" colspan="2">
                        <cc2:Grid ID="Grid1" runat="server" AllowAddingRecords="False"
                            ...
                            <Columns>
                                <cc2:Column DataField="HLD_ID" HeaderText="hCode" visible="false" Width="100px">
                                </cc2:Column>
