<%@ Control Language="C#" AutoEventWireup="true" CodeFile="LeaveMasterQuery.ascx.cs" Inherits="Module_HRMS_Controls_LeaveMasterQuery" %>
...
<table class="tContentArial">
    ...
    <tr>
        <td align="center" valign="top" class="tRowColorAdmin td">
            <span class="titleheading">Leave Master Query</span>
        </td>
    </tr>
     <tr>
        <td class="td">
