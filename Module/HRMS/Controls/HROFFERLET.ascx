<%@ Control Language="C#" AutoEventWireup="true" CodeFile="HROFFERLET.ascx.cs" Inherits="Module_HRMS_Controls_HROFFERLET" %>
<table class="tContentArial">
    ...
    <tr>
        <td class="TableHeader td" align="center" width="100%">
            <span class="titleheading"><b>Print Offer Letter
                <asp:Label ID="lblOFFERLET" runat="server"></asp:Label></b></span>
        </td>
    </tr>
    <tr>
        <td class="td">
