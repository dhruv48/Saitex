<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Salary_Report_Filter.ascx.cs"
    Inherits="Module_HRMS_Controls_Salary_Report_Filter" %>
                    ...
                    <table border="0" width="100%">
                        <tr>
                            <td align="center" width="100%">
                                <span class="titleheading"><b>Print Salary</b></span>
                            </td>
                        </tr>
                    </table>
                </td>
