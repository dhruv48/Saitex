<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PAFAdmin.ascx.cs" Inherits="Module_HRMS_Controls_PAFAdmin" %>
...
<asp:UpdatePanel ID="UpdatePanel2" runat="server">
    <ContentTemplate>
        <table align="left" class="tContentArial">
            ...
            <tr>
                <td class="TableHeader td" align="center">
                    <b class="titleheading">Performance Appraisal Form For Appraiser</b>
                </td>
            </tr>
            <tr>
                                ...
                                <asp:Panel ID="pnlEmpDTL" runat="server">
                                    <table border="2" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <cc2:ComboBox runat="server" ID="cmbEmpSelect" Width="185px" Height="200px" EnableLoadOnDemand="true"
                                                    AutoPostBack="True" MenuWidth="300px" EmptyText="Select Employee" TabIndex="1"
                                                    DataValueField="EMP_CODE" DataTextField="EMPLOYEENAME" OnLoadingItems="cmbEmpSelect_LoadingItems"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtAssessmentYr" runat="server" CssClass="TextBox SmallFont TextBoxDisplay"
                                            ...
                                            <td>
                                                <table cellpadding="0" cellspacing="0" border="2">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtEmpAchievement" runat="server" Width="80px" TabIndex="14" CssClass="TextBoxDisplay TextBoxNo SmallFont"
                                                                Style="text-align: right" ReadOnly="true"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtEmpWeightage" runat="server" Width="80px" TabIndex="15" CssClass="TextBoxDisplay TextBoxNo SmallFont"
                                                                Style="text-align: right" ReadOnly="true"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtEmpRatingPoint" runat="server" Width="80px" TabIndex="16" CssClass="TextBoxDisplay TextBoxNo SmallFont"
                                                                ReadOnly="true" Style="text-align: right" OnTextChanged="txtEmpRatingPoint_TextChanged"
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:GridView ID="grdAppraisal" runat="server" AutoGenerateColumns="False" CellSpacing="0"
                                                            ...
                                                            <Columns>
                                                                <asp:TemplateField HeaderText="Unique ID" Visible="false" HeaderStyle-HorizontalAlign="Right"
                                                                    ItemStyle-HorizontalAlign="Right">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblUNIQUE_ID" runat="server" Text='<%# Bind("UNIQUE_ID") %>' CssClass="LabelNo SmallFont"
                                                                ...
                                                                <asp:TemplateField HeaderText="Weightage(W)" HeaderStyle-HorizontalAlign="Center">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="lblEmpWeightage" runat="server" Text='<%# Bind("EMP_WEIGHTAGE") %>'
                                                                            CssClass="TextBoxNo SmallFont TextBoxDisplay" Width="78px" ReadOnly="true"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                ...
                                                                <asp:TemplateField HeaderText="Rating Point(R)" HeaderStyle-HorizontalAlign="Center">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="lblEmpRatingPoint" runat="server" Text='<%# Bind("EMP_RATING_POINT") %>'
                                                                            CssClass="TextBoxNo SmallFont TextBoxDisplay" ReadOnly="true" Width="78px"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                    <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                                                </asp:TemplateField>
                                                                ...
                                                                <asp:TemplateField HeaderText="Achievement%" HeaderStyle-HorizontalAlign="Right"
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="lblApprAchievement" runat="server" Text='<%# Bind("APPR_ACHIEVEMENT") %>'
                                                                            CssClass="TextBoxNo SmallFont" Width="80px"></asp:TextBox>
                                                                        <asp:RequiredFieldValidator ID="RFlblApprAchievement" runat="server" ErrorMessage="Please. Enter Achievement %"
                                                                            ValidationGroup="M1" Display="None" SetFocusOnError="True" ControlToValidate="lblApprAchievement"></asp:RequiredFieldValidator>
                                                                        <asp:RangeValidator ID="RVlblApprAchievement" runat="server" ErrorMessage="Enter Only Numeric Value between 1 To 100.."
                                                                            MinimumValue="1" MaximumValue="100" Type="Double" ValidationGroup="M1" Display="None"
                                                                            SetFocusOnError="True" ControlToValidate="lblApprAchievement"></asp:RangeValidator>
                                                                    </ItemTemplate>
                                                                    <HeaderStyle HorizontalAlign="Right"></HeaderStyle>
                                                                    <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Weightage(W)" HeaderStyle-HorizontalAlign="Center">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="lblApprWeightage" runat="server" Text='<%# Bind("APPR_WEIGHTAGE") %>'
                                                                            CssClass="TextBoxNo SmallFont" Width="78px"></asp:TextBox>
                                                                        <asp:RequiredFieldValidator ID="RFlblApprWeightage" runat="server" ErrorMessage="Please. Enter Weightage %"
                                                                            ValidationGroup="M1" Display="None" SetFocusOnError="True" ControlToValidate="lblApprWeightage"></asp:RequiredFieldValidator>
                                                                        <asp:RangeValidator ID="RVlblApprWeightage" runat="server" ErrorMessage="Enter Only Numeric Value between 1 To 100.."
                                                                            MinimumValue="1" MaximumValue="100" Type="Double" ValidationGroup="M1" Display="None"
                                                                            SetFocusOnError="True" ControlToValidate="lblApprWeightage"></asp:RangeValidator>
                                                                    </ItemTemplate>
                                                                    <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Rating Point(R)" HeaderStyle-HorizontalAlign="Center">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="lblApprRatingPoint" runat="server" Text='<%# Bind("APPR_RATING_POINT") %>'
                                                                            CssClass="TextBoxNo SmallFont" Width="78px" AutoPostBack="true" OnTextChanged="lblApprRatingPoint_TextChanged"></asp:TextBox>
                                                                        <asp:RangeValidator ID="RVlblApprRatingPoint" runat="server" ErrorMessage="Enter Only Numeric Value between 1 To 100.."
                                                                            MinimumValue="1" MaximumValue="100" Type="Double" ValidationGroup="M1" Display="None"
                                                                            SetFocusOnError="True" ControlToValidate="lblApprRatingPoint"></asp:RangeValidator>
                                                                        <asp:RequiredFieldValidator ID="RFlblApprRatingPoint" runat="server" ErrorMessage="Please. Enter Rating Point %"
                                                                            ValidationGroup="M1" Display="None" SetFocusOnError="True" ControlToValidate="lblApprRatingPoint"></asp:RequiredFieldValidator>
                                                                    </ItemTemplate>
                                                                    <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="W*R" HeaderStyle-HorizontalAlign="Center">
        ...
        <asp:RequiredFieldValidator ID="RFAppraiser" runat="server" ErrorMessage="Please. Enter Appraiser Name.."
            ValidationGroup="M1" Display="None" SetFocusOnError="True" ControlToValidate="txtAppraiser"></asp:RequiredFieldValidator>
