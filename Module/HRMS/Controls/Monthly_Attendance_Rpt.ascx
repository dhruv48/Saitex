<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Monthly_Attendance_Rpt.ascx.cs"
    Inherits="Module_HRMS_Controls_Monthly_Attendance_Rpt" %>
            ...
            <table border="0" width="100%">
                <tr>
                    <td align="center" width="100%">
                        <span class="titleheading"><b>Print Monthly Attendance</b></span>
                    </td>
                </tr>
            </table>
        </td>
        ...
        <td width="100%" align="left" class="td">
            <table border="0" cellpadding="3" cellspacing="0" width="100%" class="tContentArial">
                ...
                <tr>
                    ...
                    <td colspan="4" align="center" valign="top" style="height: 25px; text-align: left;">
