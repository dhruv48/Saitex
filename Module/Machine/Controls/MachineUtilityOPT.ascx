<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MachineUtilityOPT.ascx.cs" Inherits="Module_Machine_Controls_MachineUtilityOPT" %>
...
<table class="tContentArial" align="left">
    ...
    <tr>
        <td align="center" valign="top" class="tRowColorAdmin td">
            <span class="titleheading">Machine Utility Report</span>
        </td>
    </tr>
        <tr>
    <td>
