<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Payroll_MST.ascx.cs" Inherits="Module_Admin_Controls_Payroll_MST" %>
            ...
            <table>
                <tr>
                    ...
                    <td align="left" valign="top">
                        ...
                        <asp:DropDownList ID="DDLSearch" Visible="false" DataValueField="PMASTER_CODE" 
                            DataTextField="SearchBy" runat="server" Width="154px" AutoPostBack="True" 
