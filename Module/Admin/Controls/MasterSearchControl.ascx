<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MasterSearchControl.ascx.cs" Inherits="Module_Admin_Controls_MasterSearchControl" %>
...
<table id="tblDesgMainTable" runat="server" cellspacing="0" cellpadding="0" align="Left" class="tContentArial">
    ...
    <tr>
        <td align="center" class ="TableHeader td">
            <span class="titleheading">MIS Report Master</span>
        </td>
    </tr>
    ...
    <tr>
        <td class ="td">
            <table border="0" cellpadding="3" cellspacing="0" align="left" width="750">
                   ...
                   <tr>
                        <td><asp:Label ID="lblFrom" runat="server" Text=""></asp:Label>  From Date:</td>
                        <td>
                        ...
                        <td></td>
                        <td><asp:Label ID="LblTo" runat="server" Text=""></asp:Label>  To Date:</td>
                        <td>
 ...
 <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="true" PrintMode="Pdf" ReuseParameterValuesOnRefresh="true" />
  </ContentTemplate>                   
                </asp:UpdatePanel>