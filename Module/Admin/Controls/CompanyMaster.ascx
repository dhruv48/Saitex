<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CompanyMaster.ascx.cs"
    Inherits="Module_Admin_Controls_CompanyMaster" %>
...
{
var aa = imgFile.value.substr(imgFile.value.lastIndexOf('.'));
//if(aa == ".jpeg" || aa == ".jpg" ||aa == ".JPG" || aa == ".JPEG")
if(aa == ".jpeg" || aa == ".jpg" ||aa == ".JPG" || aa == ".JPEG")
{
   ...
   document.getElementById("<%=HF1.ClientID %>").value = document.getElementById("<%=FileUpload1.ClientID %>").value;
}
else
{
...
{
var newPreview = document.getElementById("pic");
newPreview.filters.item("DXImageTransform.Microsoft.AlphaImageLoader").src = "../Images/Untitled-1.gif";
newPreview.style.width = "150px";
newPreview.style.height = "150px";
            ...
            <table cellpadding="0" cellspacing="0" class="tContentArial">
                <tr>
                    ...
                    <asp:ImageButton ID="imgbtnUpdate" runat="server" Height="41" ImageUrl="~/CommonImages/edit1.jpg"
                             ToolTip="Find" Width="48" onclick="imgbtnUpdate_Click" />
                    </td>
                    ...
                    <td width="48">
                        <asp:ImageButton ID="imgbtnPrint" runat="server" Height="41" ImageUrl="~/CommonImages/link_print.png"
                            OnClick="imgbtnPrint_Click" ToolTip="Print" Width="48" OnClientClick="if (!confirm('Are you want to Print record ?')) { return false; }" />
                    </td>
                    <td width="48">
                        ...
                        <table>
                            <tr>
                                ...
                                <td align="left" valign="top" colspan="1" width="280px">
                                    ...
                                    <cc2:ComboBox ID="ddlCompanyCode" runat="server" AutoPostBack="True" EnableLoadOnDemand="true"
                                        OnLoadingItems="ddlCompanyCode_LoadingItems" DataTextField="COMP_NAME" DataValueField="COMP_CODE"
                                        Width="150px" MenuWidth="350px" Height="200px" CssClass="SmallFont" TabIndex="1"
                                        EmptyText="Find " OnSelectedIndexChanged="ddlCompanyCode_SelectedIndexChanged"
                                        Visible="False">
                                        <HeaderTemplate>
                                            <div class="header c1">
                                                COMP CODE</div>
                                        ...
                                        <ItemTemplate>
                                            <div class="item c1">
                                                <asp:Literal runat="server" ID="Container1" Text='<%# Eval("COMP_CODE") %>' /></div>
                                            <div class="item c2">
                                                <asp:Literal runat="server" ID="Container2" Text='<%# Eval("COMP_NAME") %>' /></div>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                            Displaying items
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td align="left" style="height: 8px" valign="top">
                                    <asp:CheckBox ID="chk_Status" runat="server" TabIndex="23" Checked="true" />
                ...
                <tr>
                    <td align="left" colspan="4" valign="top" class="td">
                        ...
                        <cc2:Grid ID="gvCompMaster" runat="server" AllowPaging="true" AllowSorting="true"
                            AutoGenerateColumns="false" BorderWidth="1px" CssClass="tContentArial" OnSelectedIndexChanged="gvCompMaster_SelectedIndexChanged"
                            PageSize="10" OnSelect="gvCompMaster_Select">
                            <Columns>
                                ...
                                <cc2:Column DataField="DEL_STATUS" HeaderText="Delete Status" ItemStyle-HorizontalAlign="left"
                                    Width="100px" ItemStyle-VerticalAlign="top" />
                                <%--
                          <cc2:Column DataField="COMP_HISTROY" HeaderText="Company Histroy" ItemStyle-HorizontalAlign="left" Visible = "false" 
                                    ItemStyle-VerticalAlign="top"  />
                                <cc2:Column DataField="COMP_ADD" HeaderText="Group Address" ItemStyle-HorizontalAlign="left"  Visible = "false"  
                                    ItemStyle-VerticalAlign="top"  />
                                <cc2:Column DataField="COMP_COUNTRY" HeaderText="Country" ItemStyle-HorizontalAlign="left"  Visible = "false" 
                                    ItemStyle-VerticalAlign="top" />
                                 <cc2:Column DataField="COMP_FAX_NO" HeaderText="Fax No" ItemStyle-HorizontalAlign="center"  Visible = "true" 
                                    ItemStyle-VerticalAlign="top" />
                                
                                <cc2:Column DataField="COMP_EMAIL_ID" HeaderText="Email Id" ItemStyle-HorizontalAlign="center"  Visible = "true" 
                                    ItemStyle-VerticalAlign="top" />
                              
                                <cc2:Column DataField="COMP_CST_NO" HeaderText="Customer No" ItemStyle-HorizontalAlign="left" Visible = "false"  
                                    ItemStyle-VerticalAlign="top"  />
                                <cc2:Column DataField="COMP_TIN_NO" HeaderText="Tin No." ItemStyle-HorizontalAlign="left"  Visible = "false" 
                                    ItemStyle-VerticalAlign="top" />
                          
                          
                          
                                <cc2:Column DataField="COMP_ESI_NO" HeaderText="Esi" ItemStyle-HorizontalAlign="left" Visible = "false"  
                                    ItemStyle-VerticalAlign="top"  />
                                <cc2:Column DataField="COMP_PAN_NO" HeaderText="PAN no" ItemStyle-HorizontalAlign="left"  Visible = "false"  
                                    ItemStyle-VerticalAlign="top"  />
                                <cc2:Column DataField="COMP_SERVICE_TAX_NO" HeaderText="SERVICE TAX NO" ItemStyle-HorizontalAlign="left"  Visible = "false"  
                                    ItemStyle-VerticalAlign="top" />
                                <cc2:Column DataField="COMP_REMARKS" HeaderText="Remarks" ItemStyle-HorizontalAlign="center" Visible = "false" 
                                    ItemStyle-VerticalAlign="top" />
                                <cc2:Column DataField="COMP_SERVICE_TAX_DATE" HeaderText="Comapny Service Tax No" ItemStyle-HorizontalAlign="left"  Visible = "false"  
                                    ItemStyle-VerticalAlign="top"  />
                                <cc2:Column DataField="COMP_ESI_DATE" HeaderText="Date" ItemStyle-HorizontalAlign="left"  Visible = "false"  
                                    ItemStyle-VerticalAlign="top" />
                          
                          
                            <cc2:Column DataField="COMP_CST_DATE" HeaderText="Company Date" ItemStyle-HorizontalAlign="left" Visible = "false" 
                                    ItemStyle-VerticalAlign="top" />
                                <cc2:Column DataField="COMP_TIN_DATE" HeaderText="Tin Date" ItemStyle-HorizontalAlign="left"  Visible = "false"   
                                    ItemStyle-VerticalAlign="top"  />
                                <cc2:Column DataField="GRP_CODE" HeaderText="Grp Code" ItemStyle-HorizontalAlign="left"  Visible = "false"  
                                    ItemStyle-VerticalAlign="top" />
                                <cc2:Column DataField="LOGO_PATH" HeaderText="Logo Path" ItemStyle-HorizontalAlign="center"  Visible = "false"  
                                    ItemStyle-VerticalAlign="top" />
                               
                                <cc2:Column DataField="STATUS" HeaderText="Delete Status" ItemStyle-HorizontalAlign="left"  Visible = "false"  
                                    ItemStyle-VerticalAlign="top" />
                          --%>
                            </Columns>
