<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BranchMaster.ascx.cs"
    Inherits="Module_Admin_Controls_BranchMaster" %>
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td id="tdUpdate" align="left" width="48" runat="server">
                                            <asp:ImageButton ID="imgbtnUpdate" runat="server" ValidationGroup="M1" ImageUrl="~/CommonImages/edit1.jpg"
                                                ToolTip="Update" Height="41" Width="48" OnClientClick="if (!confirm('Are you want to Update?')) { return false; }"
                                        ...
                                        <td id="tdDelete" align="left" width="48" runat="server">
                                            <asp:ImageButton ID="imgbtnDelete" OnClick="imgbtnDelete_Click" runat="server" ImageUrl="~/CommonImages/del6.png"
                                                ToolTip="Delete" Height="41" Width="48" OnClientClick="if (!confirm('Are you want to Delete ?')) { return false; }">
                                            </asp:ImageButton>
                                        </td>
                                        ...
                                        <td id="tdClear" runat="server" align="left" width="48">
                                            <asp:ImageButton ID="imgbtnClear" OnClick="imgbtnClear_Click" runat="server" ImageUrl="~/CommonImages/clear.jpg"
                                                ToolTip="Clear" Height="41" Width="48" OnClientClick="if (!confirm('Are you want to Clear ?')) { return false; }">
                                            </asp:ImageButton>
                                        </td>
                                        <td id="tdPrint" runat="server" align="left" width="48">
                                            <asp:ImageButton ID="imgbtnPrint" OnClick="imgbtnPrint_Click" runat="server" ImageUrl="~/CommonImages/link_print.png"
                                                ToolTip="Print" Height="41" Width="48" OnClientClick="if (!confirm('Are you want to Print ?')) { return false; }">
                                            </asp:ImageButton>
                                        </td>
                                        <td id="tdExit" runat="server" align="left" width="48">
                                            <asp:ImageButton ID="imgbtnExit" OnClick="imgbtnExit_Click" runat="server" ImageUrl="~/CommonImages/link_exit.png"
                                                ToolTip="Exit" Height="41" Width="48" OnClientClick="if (!confirm('Are you sure to Exit From This Form ?')) { return false; }">
                                            </asp:ImageButton>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" valign="top">
                                            <asp:TextBox ID="txtState" runat="server" TabIndex="23" ValidationGroup="M1" Width="130px"
                                                CssClass="SmallFont UpperCase" MaxLength="20" TextMode="singleLine"></asp:TextBox>
                        ...
                        <tr>
                            <td class="td">
                                <cc2:Grid ID="grdShowBranch" runat="server" AllowAddingRecords="False" AllowFiltering="True"
                                    PageSize="5" AutoGenerateColumns="False" OnSelect="grdShowBranch_Select" TabIndex="25">
                                    <Columns>
                                        ...
                                        <cc2:Column DataField="SEQ_PREFIX" Align="Left" HeaderText="Prefix" Visible="false"
                                         ...
                                         <cc2:Column DataField="STATE" Align="Left" HeaderText="STATE" Visible="false"
                                            Wrap="True">
                                        </cc2:Column>
                                         <cc2:Column DataField="ECC_NO" Align="Left" HeaderText="ECC_NO" Visible="false"
                                            Wrap="True">
                                        </cc2:Column>
                                         <cc2:Column DataField="F_LC_NO" Align="Left" HeaderText="F_LC_NO" Visible="false"
                                            Wrap="True">
                                        </cc2:Column>
                                         <cc2:Column DataField="AIR_POLUTION_NO" Align="Left" HeaderText="AIR_POLUTION_NO" Visible="false"
                                            Wrap="True">
                                        </cc2:Column>
