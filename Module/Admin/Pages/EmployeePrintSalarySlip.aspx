<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmployeePrintSalarySlip.aspx.cs" Inherits="Module_HRMS_Pages_EmployeePrintSalarySlip"  %>
...
<head id="Head1" runat="server">
    ...
    <link href="../../../StyleSheet/PrintStyleSheet.css" type="text/css" rel="stylesheet" />
</head>
<body onload="window.print();" topmargin="0" leftmargin="0">
                                                            ...
                                                            <asp:TemplateField HeaderText="Earning" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left">
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:TextBox ID="txtSalaryAmount" Text='<%#Eval("SalaryAmount") %>' runat="server"
                                                                        Width="70px" CssClass="tContentArial10" OnTextChanged="txtSalaryAmount_TextChanged"
                                            ...
                                            <tr>
                                                <td colspan="2" valign="top">
                                                    <asp:GridView ID="gvDeductionCalculation_Loans" runat="server" ShowFooter="false"
                                                        ...
                                                        onrowdatabound="gvDeductionCalculation_Loans_RowDataBound">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Earning" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtSalaryAmount" Text='<%#Eval("SalaryAmount") %>' runat="server"
                                                                        Width="70px" CssClass="tContentArial10" OnTextChanged="txtSalaryAmount_Loans_TextChanged"
                                                                        AutoPostBack="false"></asp:TextBox>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        </Columns>
                                            ...
                                            <tr>
                                                <td colspan="2" valign="top">
                                                    <asp:GridView ID="gvDeductionCalculation" runat="server" ShowFooter="false" ShowHeader="false"
                                                        AutoGenerateColumns="false" AllowPaging="false" GridLines="None" 
                                                        CssClass="tContentArial10" onrowdatabound="gvDeductionCalculation_RowDataBound">
                                                        <Columns>
                                                            <%--<asp:BoundField DataField="SalaryName" HeaderText="" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="100px" />--%>
                                                            <asp:TemplateField HeaderText="" ItemStyle-Width="150px">
                                                                <ItemTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="Earning" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtSalaryAmount" Text='<%#Eval("SalaryAmount") %>' runat="server"
                                                                        Width="70px" CssClass="tContentArial10" OnTextChanged="txtSalaryAmount_Deduction_TextChanged"
                                                                        AutoPostBack="false"></asp:TextBox>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        </Columns>
