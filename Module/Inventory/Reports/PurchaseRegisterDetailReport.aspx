<%@ Page Language="C#" MasterPageFile="~/CommonMaster/admin.master" AutoEventWireup="true"
    CodeFile="PurchaseRegisterDetailReport.aspx.cs" Inherits="Module_Inventory_Reports_PurchaseRegisterDetailReport"
    Title="Untitled Page" %>
    ...
    <table align="left" class=" td tContentArial" width="945px">
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddlpartycode" runat="server" DataTextField="PRTY_NAME" DataValueField="PRTY_CODE"
                    Width="160px" AutoPostBack="True" CssClass="gCtrTxt ">
                </asp:DropDownList>
            </td>
            <tr>
                <td>
        ...
        <tr>
            <td class="TdBackVir" colspan="8">
                <b>
                    <%--TotTotal Records : --%>&nbsp;&nbsp;</b><asp:Label ID="lblTotalRecord" runat="server"
        ...
        <tr>
            <td class="td tContentArial" colspan="8">
                <asp:Panel ID="pnlShowHover" runat="server" Width="945px" ScrollBars="Auto" Height="350px">
                    <asp:GridView ID="GridLedger" runat="server" AutoGenerateColumns="False" Width="250%"
                        ...
                        PageSize="14" AllowSorting="True" OnSelectedIndexChanged="GridLedger_SelectedIndexChanged"
                        Visible="False">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="TRN_DESC" HeaderText="TRNASCTION DESCRIPTION" />
