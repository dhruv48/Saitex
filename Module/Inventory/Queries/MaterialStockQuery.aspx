<%@ Page Language="C#" MasterPageFile="~/CommonMaster/EMPMaster.master" AutoEventWireup="true"
    CodeFile="MaterialStockQuery.aspx.cs" Inherits="Module_Inventory_Queries_MaterialStockQuery"
    Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        function OpenReceiptDetails(BCODE, ICODE, TTYPE,LOCATION,STORE) {

            var YEAR = $("#<%=ddlYear.ClientID%> option:selected").text();
            var SDATE = $('#<%= txtDate1.ClientID %>').val();
            var EDATE = $('#<%= txtDate2.ClientID%>').val();
            window.showModalDialog("ReceiptQ.aspx?BCODE=" + BCODE + "&ICODE=" + ICODE + "&YEAR=" + YEAR + "&TRANS_TYPE=" + TTYPE + "&LOCATION="+LOCATION+"&STORE="+STORE +"&SDATE=" + SDATE + "&EDATE=" + EDATE, null, "dialogheight:600px; dialogWidth:850px; center:yes");
        ...
        function OpenIssueDetails(BCODE, ICODE, TTYPE, LOCATION, STORE) {
            var YEAR = $("#<%=ddlYear.ClientID%> option:selected").text();
            //  var YEAR = $('#<%= ddlYear.ClientID %>').val();
            var SDATE = $('#<%= txtDate1.ClientID %>').val();
            var EDATE = $('#<%= txtDate2.ClientID %>').val();

            window.showModalDialog("IssueQ.aspx?BCODE=" + BCODE + "&ICODE=" + ICODE + "&YEAR=" + YEAR + "&TRANS_TYPE=" + TTYPE + "&LOCATION=" + LOCATION + "&STORE=" + STORE + "&SDATE=" + SDATE + "&EDATE=" + EDATE, null, "dialogheight:600px; dialogWidth:850px; center:yes");
            //$(".viresh").colorbox({width:"90%", height:"90%", iframe:true,href:"ReceiptQ.aspx?BCODE="+BCODE+"&DCODE="+DCODE+"&YEAR="+YEAR+"&SDATE="+SDATE+"&EDATE="+EDATE});
        }
    </script>
    ...
    <asp:UpdatePanel ID="UpdatePane2l" runat="server">
        <ContentTemplate>
            <table cellpadding="3" cellspacing="0" width="100%" class="tContentArial td">
                        ...
                        <table class="style1" cellspacing="0" cellpadding="0" border="0" align="left">
                            <tbody>
                                <tr>
                                    ...
                                    <%-- <td>  
                              <asp:ImageButton ID="imgBtnExportExcel" runat="server" Width="41" Height="41" ToolTip="Print"
                ...
                <tr>
                    <td align="center" class="TableHeader" colspan="10" width="100%">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtDate2" runat="server"
                            Width="165px" CssClass="tdText"></asp:TextBox>
                            <%-- AutoPostBack="True"  OnTextChanged="txtDate2_TextChanged"--%>
                    </td>                    
                ...
                <tr>
                    <td colspan="8"  align="center">
                        <b>Total Records :&nbsp;</b><asp:Label ID="lblTotalRecord" runat="server"  Text="0"></asp:Label>&nbsp;&nbsp;
                         <b>Total Opening Qty : &nbsp;</b><asp:Label ID="lblTotalOpBalQty" runat="server" Text="0"></asp:Label>&nbsp;&nbsp;
                          <b>Total Receving Qty :&nbsp;</b><asp:Label ID="lblTotalRecQty" runat="server" Text="0"></asp:Label>&nbsp;&nbsp;
                          <b>Total Issue Qty : &nbsp;</b><asp:Label ID="lblTotalIssueQty" runat="server" Text="0"></asp:Label>&nbsp;&nbsp;
                          <b>Total Balance Qty : &nbsp;</b><asp:Label ID="lblTotalBalanceQty" runat="server" Text="0"></asp:Label>&nbsp;&nbsp;
                    </td>
                </tr>
                <tr>
                    <td colspan="8" class="td" align="center">
                        <asp:Panel ID="pnlShowHover" runat="server" ScrollBars="None" Width="945px">
                            <asp:GridView ID="gvReportDisplayGrid" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                PagerStyle-HorizontalAlign="Left" PagerStyle-CssClass="Pager" 
                                PageSize="20" Width="100%" onrowdatabound="gvReportDisplayGrid_RowDataBound">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Opening Qty.">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblOpnBalQty" runat="server" Text='<%#Eval("OPBAL_STOK","{0:N3}").ToString() %>'></asp:Label>
                                        </ItemTemplate>                                        
                                    ...
                                    <asp:TemplateField HeaderText="Receipt Qty.">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="hlReceiptQty" runat="server" Font-Bold="true" ForeColor="Brown"
                                                NavigateUrl='<%# "javascript:OpenReceiptDetails("+"&#39;"+ Eval("BRANCH_CODE") + "&#39;,&#39;" + Eval("ITEM_CODE") + "&#39;,&#39;" + "R" +"&#39;,&#39;"+Eval("LOCATION")+"&#39;,&#39;"+Eval("STORE")+ "&#39;);" %>'
                                    ...
                                    <asp:TemplateField HeaderText="Issue Qty.">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="hlIssueQty" runat="server" Font-Bold="true" ForeColor="Brown"
                                                NavigateUrl='<%# "javascript:OpenIssueDetails("+"&#39;"+ Eval("BRANCH_CODE") + "&#39;,&#39;" + Eval("ITEM_CODE") + "&#39;,&#39;" + "I" +"&#39;,&#39;"+Eval("LOCATION")+"&#39;,&#39;"+Eval("STORE")+ "&#39;);" %>'
                                    ...
                                    <asp:TemplateField HeaderText="Opening Value">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblOpnBalValue" runat="server" Text='<%#Eval("OPBAL_VALUE","{0:N3}").ToString() %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Right" Width="2%" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Receipt Value">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="hlReceiptValue" runat="server" Font-Bold="true" ForeColor="Brown"
                                                NavigateUrl='<%# "javascript:OpenReceiptDetails("+"&#39;"+ Eval("BRANCH_CODE") + "&#39;,&#39;" + Eval("ITEM_CODE") + "&#39;,&#39;" + "R" +"&#39;,&#39;"+Eval("LOCATION")+"&#39;,&#39;"+Eval("STORE")+ "&#39;);" %>'
                                    ...
                                    <asp:TemplateField HeaderText="Issue Value">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="hlIssueValue" runat="server" Font-Bold="true" ForeColor="Brown"
                                                NavigateUrl='<%# "javascript:OpenIssueDetails("+"&#39;"+ Eval("BRANCH_CODE") + "&#39;,&#39;" + Eval("ITEM_CODE") + "&#39;,&#39;" + "I" +"&#39;,&#39;"+Eval("LOCATION")+"&#39;,&#39;"+Eval("STORE") + "&#39;);" %>'
