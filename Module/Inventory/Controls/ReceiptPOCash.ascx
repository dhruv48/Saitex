<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ReceiptPOCash.ascx.cs"
    Inherits="Inventory_Controls_ReceiptPOCash" %>
...
<table class="tdMain" width="100%">
    ...
    <tr>
        <td align="center" class="TableHeader td" width="100%">
            <b class="titleheading">M.R.N. Against PO Cash</b>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td width="100%" class="td">
            <table width="100%">
                ...
                <tr>
                    <td>
                        <cc2:ComboBox ID="cmbPOITEM" runat="server" CssClass="SmallFont" AutoPostBack="true"
                            EnableLoadOnDemand="true" MenuWidth="650" Width="80px" Height="200px" OnLoadingItems="cmbPOITEM_LoadingItems1"
                            OnSelectedIndexChanged="cmbPOITEM_SelectedIndexChanged1">
                            <HeaderTemplate>
                                <div class="header c1">
                                    PO No.</div>
                                <div class="header c2">
                        ...
                        <%-- <cc2:ComboBox ID="cmbPOITEM" runat="server" CssClass="SmallFont" EmptyText="select..."
                            ...
                            <ItemTemplate>
                                ...
                                <div class="item c2">
                                    <asp:Literal runat="server" ID="Literal6" Text='<%# Eval("QTY_RTN") %>' /></div>
                                <div class="item c6">
                    ...
                    <td>
                        <asp:TextBox ID="txtBasicRate" runat="server" 
                            CssClass="TextBoxNo TextBoxDisplay SmallFont" Width="50px" ReadOnly="True"></asp:TextBox>
                    </td>
                    <td>
