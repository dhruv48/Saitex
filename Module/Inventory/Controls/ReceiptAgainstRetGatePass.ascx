<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ReceiptAgainstRetGatePass.ascx.cs"
    Inherits="Module_Inventory_Controls_ReceiptAgainstRetGatePass" %>
        ...
        <td width="100%" class="td">
            <table width="100%">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtBasicRate" runat="server" CssClass="TextBoxNo SmallFont" Width="50px"></asp:TextBox>
                    </td>
                    <td>
