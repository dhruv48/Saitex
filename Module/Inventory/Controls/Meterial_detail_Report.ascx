<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Meterial_detail_Report.ascx.cs"
    Inherits="Module_Inventory_Controls_Meterial_detail_Report" %>
                                ...
                                <asp:Panel ID="pnl1001" runat="server" ScrollBars="Both" Width="95%" Height="350px">
                                    <asp:GridView ID="GrdItemQuery" runat="server" AutoGenerateColumns="False" Font-Size="Smaller"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Item Type">
                                                <HeaderTemplate>
                                                    <table width="100%">
                                                        <tr>
                                                            <td align="left" valign="top" width="100%">
                                            ...
                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Trn Type">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblTRN_TYPE" runat="server" CssClass=" SmallFont" Text='<%# Eval("TRN_TYPE") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle CssClass=" label SmallFont" HorizontalAlign="Left" VerticalAlign="Top"
                                                    Wrap="true" />
                                            </asp:TemplateField>
                                            <%--<asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Trn Date">
                                                <HeaderTemplate>
                                                    <table width="100%">
                                                        <tr>
                                                            <td align="left" valign="top" width="100%">
                                                        ...
                                                        <tr>
                                                            <td width="80%">
                                                                <asp:TextBox ID="txttrndate" Width="70px" CssClass="SmallFont" runat="server"></asp:TextBox>
                                                                <cc1:MaskedEditExtender ID="MaskedEditExtender21" runat="server" MaskType="Date"
                                                                    UserDateFormat="DayMonthYear" TargetControlID="txttrndate" Mask="99/99/9999">
                                                                </cc1:MaskedEditExtender>
                                                            </td>
                                                            <td width="20%">
                                                                <asp:ImageButton ID="btntrndate" CssClass="SmallFont" runat="server" Text="Go" ImageUrl="~/CommonImages/Icons/Search.png"
                                                                    OnClick="Btnyear_Click" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblTRN_DATE" runat="server" CssClass=" SmallFont" Text='<%# Eval("TRN_DATE") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle CssClass=" label SmallFont" HorizontalAlign="Left" VerticalAlign="Top"
                                                    Wrap="true" />
                                            ...
                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Po Type">
                                                <HeaderTemplate>
                                                    <table width="100%">
                                                        <tr>
                                                            <td align="left" valign="top" width="100%">
