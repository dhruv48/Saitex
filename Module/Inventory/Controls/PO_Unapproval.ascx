<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PO_Unapproval.ascx.cs" Inherits="Module_Inventory_Controls_PO_Unapproval"  %>
...
<table width="100%" align="left" class="tContentArial">
    ...
    <tr>
        <td align="center" class="TableHeader td" width="100%">
            <b class="titleheading">Approved Material Purchase Order Un Approval</b>
        </td>
    </tr>
    <tr>
