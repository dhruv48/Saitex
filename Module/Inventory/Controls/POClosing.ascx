<%@ Control Language="C#" AutoEventWireup="true" CodeFile="POClosing.ascx.cs" Inherits="Module_Inventory_Controls_POClosing" %>
...
<table width="100%"  class="tContentArial">
                ...
                <tr>
                    ...
                    <td id="tdFind" runat="server" visible="false" align="left">
                        <asp:ImageButton ID="imgbtnFindTop" Width="48" Height="41" runat="server" ToolTip="Find"
                            ImageUrl="~/CommonImages/link_find.png" onclick="imgbtnFindTop_Click2"></asp:ImageButton>
                    </td>
                    <td>
    ...
    <tr>
        <td align="center" class="TableHeader td" width="100">
            <b class="titleheading">Material Purchase Order Closing</b>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td align="left" class="td" width="100">
            <asp:GridView ID="grdPOMST" runat="server"  CallbackMode="false" Serialize="true" AllowAddingRecords="false"
                AutoGenerateColumns="false" AllowRecordSelection="false" AllowFiltering="True" Width="100%"
                    ...
                    <asp:TemplateField HeaderText="Confirm By">
                        <ItemTemplate>
                            <asp:TextBox ID="txtConfirmBy" runat="server" CssClass="TextBox SmallFont TextBoxDisplay" 
                                Text='<%# Bind("CONF_BY") %>' ReadOnly ="true" Width="50%"></asp:TextBox>
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Confirm Date">
                        <ItemTemplate>
                            <asp:TextBox ID="txtConfirmDate" runat="server" CssClass="TextBox SmallFont " 
                                Text='<%# Bind("CONF_DATE","{0:dd/MM/yyyy}") %>'  Height="16px" Width="50%"></asp:TextBox>
