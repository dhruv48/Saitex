<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ReturnMiss.ascx.cs" Inherits="Module_Inventory_Controls_ReturnMiss" %>
        ...
        <table class="tdMain" width="100%">
            ...
            <tr>
                <td align="center" class="TableHeader td" width="100%">
                    <b class="titleheading">Material Return / Issue Gate Pass</b>
                </td>
            </tr>
            <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="btnAdjRec" runat="server" CssClass="SmallFont" OnClick="btnAdjRec_Click"
                                    Text="Adj.Recpt." Width="65px" TabIndex="18" />
                            </td>
                            <td>
                            ...
                            <td>
                                <asp:TextBox ID="txtBasicRate" runat="server" CssClass="TextBoxNo TextBoxDisplay SmallFont"
                                    ReadOnly="true" Width="50px" TabIndex="20"></asp:TextBox>
                            </td>
                            <td>
                                <asp:TextBox ID="txtAmount" runat="server" CssClass="TextBoxNo TextBoxDisplay SmallFont"
                                    ReadOnly="true" Width="50px" TabIndex="21"></asp:TextBox>
                            </td>
