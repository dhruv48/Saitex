<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ReceivingCredit_new.ascx.cs"
    Inherits="Module_Inventory_Controls_ReceivingCredit_new" %>
        ...
        <table class="tdMain tContentArial" width="800px">
            ...
            <tr>
                <td align="center" class="TableHeader td" width="100%">
                    <b class="titleheading">M.R.N. Against PO </b>
                </td>
            </tr>
            <tr>
                            ...
                            <td>
                                <cc2:ComboBox ID="cmbPOITEM" TabIndex="28" runat="server" CssClass="SmallFont" EmptyText="select..."
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <div class="item c1">
                                            <asp:Literal runat="server" ID="Container7" Text='<%# Eval("PO_NUMB") %>' />
                                        </div>
                                        <div class="item c2">
                                        ...
                                        <div class="item c1">
                                            <asp:Literal runat="server" ID="Literal1" Text='<%# Eval("ORD_QTY") %>' />
                                        </div>
                                        <div class="item c1">
                            ...
                            <td colspan="10">
                                ...
                                <asp:TextBox ID="txtDESC" runat="server" CssClass="TextBox TextBoxDisplay SmallFont"
                                    ReadOnly="true" Width="221px"></asp:TextBox>
                                     &nbsp;HSN Code :
                                <asp:TextBox ID="txtHSNCODE" runat="server" CssClass="TextBox TextBoxDisplay SmallFont"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Description">
                                  ...
                                  <asp:TemplateField HeaderText="HSN Code">
                                    <ItemTemplate>
                                        <asp:Label ID="txtHSNCODE" runat="server" CssClass="  Label SmallFont" Text='<%# Bind("HSN_CODE") %>'
                                            Width="120px" ReadOnly="true"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
