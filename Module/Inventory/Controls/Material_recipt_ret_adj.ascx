<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Material_recipt_ret_adj.ascx.cs" Inherits="Module_Inventory_Controls_Meterial_recipt_ret_adj" %>
...
<%--<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>--%>
        <table class="tdMain tContentArial" width="900px">
            ...
            <tr>
                <td align="center" class="TableHeader td" width="100%">
                    <b class="titleheading">Material receiving Cash(Without party & PO)</b>
                </td>
            </tr>
            <tr>
                ...
                <td class="td SmallFont" width="100%">
                    <table width="100%">
                        <tr>
                          ...
                          <tr>
                            <td class="tdRight" width="17%">
                                <asp:Label ID="Label4" runat="server" CssClass="Label SmallFont" Text="Doc Number :"></asp:Label>
                            </td>
                            <td class="tdLeft" width="17%">
                                <asp:TextBox ID="txtPartyChallanNo" runat="server" CssClass="TextBoxNo  SmallFont"
                                     Width="150px"></asp:TextBox>
                            </td>
                            <td class="tdRight" width="17%">
                                <asp:Label ID="Label5" runat="server" CssClass="Label SmallFont" Text="Doc Date :"></asp:Label>
                            </td>
                            <td class="tdLeft" width="17%">
                                <asp:TextBox ID="txtPartyChallanDate" runat="server" CssClass="TextBox   SmallFont"
                                     Width="150px"></asp:TextBox>
                            </td>
                            <td class="tdRight" width="17%">
                        ...
                        <tr>
                            ...
                            <td class="tdRight" width="17%">
                                <asp:Label ID="Label2" runat="server" CssClass="Label SmallFont" Text="Store:"></asp:Label>
                            </td>
                            <td class="tdLeft" width="17%">
                        ...
                        <tr>
                            ...
                            <td class="tdRight">
                                <asp:TextBox ID="txtQTY" runat="server" TabIndex="13" CssClass="TextBoxNo TextBoxDisplay SmallFont"
                                    OnTextChanged="txtQTY_TextChanged" Width="60px"></asp:TextBox>
                            </td>
                            <td class="tdRight">
        ...
        <cc1:CalendarExtender ID="celr2" runat="server" Format="dd/MM/yyyy" TargetControlID="txtPartyChallanDate">
        </cc1:CalendarExtender>
        <asp:RangeValidator ID="rvlr2" runat="server" ControlToValidate="txtPartyChallanDate" Display="Dynamic"
            ErrorMessage="Invalid Date" SetFocusOnError="True" Type="Date" ValidationGroup="M1"></asp:RangeValidator>
        <cc1:ValidatorCalloutExtender ID="Vclr1" runat="server" TargetControlID="rvlr2">
        </cc1:ValidatorCalloutExtender>
   <%-- </ContentTemplate>
</asp:UpdatePanel>--%>