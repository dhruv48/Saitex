<%@ Control Language="C#" AutoEventWireup="true" CodeFile="receiveForGatePass.ascx.cs" Inherits="Module_Inventory_Controls_receiveForGatePass" %>
        ...
        <table class="tdMain tContentArial" width="800px">
                        ...
                        <tr>
                            ...
                            <td id="tdUpdate" runat="server">
                                <asp:ImageButton ID="imgbtnUpdate" OnClick="imgbtnUpdate_Click" runat="server" ToolTip="Update"
                                    ImageUrl="~/CommonImages/edit1.jpg" ValidationGroup="M1" 
                                    style="width: 48px"></asp:ImageButton>
                            </td>
            ...
            <tr>
                <td align="center" class="TableHeader td" width="100%">
                    <b class="titleheading">M.R.N. Against&nbsp; Gate Pass</b>
                </td>
            </tr>
            <tr>
                            ...
                            <td colspan="10">
                               ...
                               <%-- &nbsp;Max. Qty :--%>
                                <asp:TextBox ID="lblMaxQTY" runat="server" CssClass="TextBoxNo TextBoxDisplay SmallFont"
                                    Width="73px" ReadOnly="true" Visible="false"></asp:TextBox>
                            </td>
                            <%--<td>
                                <asp:Button ID="btnTRNCancel" runat="server" CssClass="SmallFont" OnClick="btnTRNCancel_Click"
                                    Text="Cancel" Width="50px" />
                ...
                <td width="100%" class="td">
                    <asp:Panel ID="pnlGrid" runat="server" Width="100%">
                        <asp:GridView ID="grdMaterialItemReceipt" Width="99%" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Ch #" HeaderStyle-CssClass="tdRight">
                                    <ItemTemplate>
                            ...
                            <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="GatePass Rate" HeaderStyle-CssClass="tdRight">
                                    <ItemTemplate>
