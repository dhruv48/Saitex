<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ITEM_OP_BAL_LOT_DETAILS.aspx.cs" Inherits="Module_Inventory_Pages_ITEM_OP_BAL_LOT_DETAILS" %>
...
<head id="Head1" runat="server">
    <title>Item Opening Sub Tran</title>
                ...
                <table width="100%">
                    <tr>
                        <td align="center" class="td TableHeader" valign="top">
                            <strong class="titleheading">Opening Transaction of Item </strong>
                        </td>
                    </tr>
                    <tr>
                        <td align="center" class="td TableHeader" valign="top">
                        ...
                        <td class="td tdLeft">
                            <table width="100%">
                                <tr bgcolor="#006699">
                                    ...
                                    <td align="left" class="SmallFont" valign="top" runat=server id="dthdm" visible="false">
                                        <span class="titleheading"><b>Date&nbsp;of&nbsp;Manufacturing</b></span>
                                    </td>
                                    <td align="left" class=" SmallFont" valign="top" runat=server id="dthms" visible="false">
                                ...
                                <tr>
                                    ...
                                    <td align="left" valign="top" runat=server id="dttdm" visible="false">
                                    ...
                                    <td align="left" valign="top" runat=server id="dttms" visible="false">
                                    ...
                                    <td align="left" valign="top">
                                        <asp:Button ID="BtnBOMSave" runat="server" OnClick="BtnBOMSave_Click" Text="Save"
                                            ValidationGroup="YM"  Width="50px" CssClass="SmallFont"  />
                                         
                                        <asp:Button ID="BtnBOMCancel" runat="server" OnClick="BtnBOMCancel_Click" Text="Cancel" Width="50px" CssClass="SmallFont" />
                                    </td>
                                </tr>
                                <tr>
                                                ...
                                                <asp:TemplateField HeaderText="">
                                                    <ItemTemplate>
                                                        <asp:Button ID="lnkBOMEdit" runat="server" CommandArgument='<%# Eval("UNIQUE_ID") %>'
                                                            CommandName="SUBEdit" TabIndex="12" Text="Edit" Width="50px" CssClass="SmallFont"/>
                                                        <asp:Button ID="lnkBOMDelete" runat="server" CommandArgument='<%# Eval("UNIQUE_ID") %>'
                                                            CommandName="SUBDelete" OnClientClick="return confirm('Are you Sure want to delete this  Detail?');"
                                                            TabIndex="12" Text="Delete" Width="50px" CssClass="SmallFont"/>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                    ...
                    <tr>
                        <td align="center" class="td" valign="top">
                            <asp:Button ID="btnSubmit" runat="server" OnClick="btnSubmit_Click" Text="Submit"
                                ValidationGroup="M1" Width="60px" CssClass="SmallFont"/>
                        </td>
                    </tr>
                </table>
            </ContentTemplate>
