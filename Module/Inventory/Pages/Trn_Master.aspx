<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CommonMaster/admin.master"
    CodeFile="Trn_Master.aspx.cs" Inherits="Inventory_Trn_Master" %>
                ...
                <table cellpadding="0" cellspacing="0" border="0" align="left" class="tContentArial">
                    ...
                    <tr>
                        <td align="center" class="TableHeader td">
                            <span class="titleheading">Transaction Master</span>
                        </td>
                    </tr>
                    <tr>
                  ...
                  <table class="tContentArial">
                    ...
                    <tr>
                        ...
                        <td  align="left" valign="top" width="70%">
                            ...
                            <cc2:OboutDropDownList ID="ddlMasterName" runat="server" Width="150px" 
                                TabIndex="1" Height="250px" MenuWidth="300px">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" Display="None" runat="server"
                                ErrorMessage="*Select Master Name" ControlToValidate="ddlMasterName" 
                    ...
                    <tr>
                        ...
                        <td align="left" valign="top" width="70%"  >
                            <asp:TextBox ID="txtMstCode" runat="server" CssClass="TextBox" Width="148px" TabIndex="2"
