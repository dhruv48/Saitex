<%@ Page Language="C#" MasterPageFile="~/CommonMaster/admin.master" AutoEventWireup="true"
    CodeFile="Material_Stock_Statement.aspx.cs" Inherits="Module_Inventory_Pages_Material_Stock_Statement"
    Title="Untitled Page" %>
        ...
        <ContentTemplate>
            ...
            <table class="tContentArial" width="100%">
                ...
                <tr>
                    ...
                    <td class="tdLeft">
                        <asp:DropDownList ID="DDLItemMake" Width="151px" runat="server" CssClass="SmallFont TextBox UpperCase">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="tdLeft">
                        <asp:DropDownList ID="DDLItemRac" Width="151px" runat="server" CssClass="SmallFont TextBox UpperCase">
                        </asp:DropDownList>
                    </td>
                    <td class="tdRight">
                        Associate Item:
                    ...
                    <td class="tdLeft">
                        <asp:DropDownList ID="DDLAssociate" Width="151px" runat="server" CssClass="SmallFont TextBox UpperCase">
                        </asp:DropDownList>
                    </td>
                    <td class="tdRight">
                        Location:
                    ...
                    <td class="tdLeft">
                        <asp:DropDownList ID="ddllocation" Width="151px" runat="server" CssClass="SmallFont TextBox UpperCase">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                <td class="tdRight">
                    ...
                    <td class="tdLeft">
                        <asp:DropDownList ID="ddlstore" Width="151px" runat="server" CssClass="SmallFont TextBox UpperCase">
                        </asp:DropDownList>
                    </td>
                </tr>
            </table>
