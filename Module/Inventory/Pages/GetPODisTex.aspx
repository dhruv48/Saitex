<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GetPODisTex.aspx.cs" Inherits="Inventory_GetPODisTex" %>
                ...
                <table>
                    ...
                    <tr>
                        <td class="td tdLeft">
                            <table>
                                ...
                                <tr>
                                    <td>
                                        <asp:DropDownList ID="ddlRateComponent" CssClass="SmallFont " runat="server" AppendDataBoundItems="True"
                                            Width="120px">
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtRate" runat="server" CssClass="SmallFont TextBoxNo" Width="50px"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:Button ID="btnSaveRateCompo" CssClass="SmallFont " runat="server" OnClick="btnSaveRateCompo_Click"
                                            Text="Save"></asp:Button>
                                        <asp:Button ID="btnCancelRateCompo" CssClass="SmallFont " runat="server" OnClick="btnCancelRateCompo_Click"
                    ...
                    <tr>
                        <td class="td" align="center" valign="top">
                            &nbsp;Base Rate :<asp:TextBox ID="txtBaseRate" runat="server" CssClass="SmallFont TextBoxDisplay TextBoxNo"
                                ReadOnly="true" Width="60px"></asp:TextBox>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Final Rate
                            :
                            <asp:TextBox ID="txtFinalAmount" runat="server" CssClass="SmallFont TextBoxDisplay TextBoxNo"
                                ReadOnly="true" Width="60px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
