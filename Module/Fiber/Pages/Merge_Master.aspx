<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CommonMaster/admin.master" CodeFile="Merge_Master.aspx.cs" Inherits="Module_Fiber_Pages_Merge_Master" %>
...
<table cellpadding="0" cellspacing="0" border="0" width="100%" align="left">
           ...
           <%-- tContentArial tablebox--%>
                ...
                <tr>
                    ...
                    <td align="left" valign="top" width="70%">
                        ...
                        <asp:TextBox ID="txtMstDesc" runat="server" CssClass="TextBox UpperCase" Width="150px"
                   ...
                   <cc2:ComboBox ID="txtItemCode" runat="server"  CssClass="SmallFont"
                            DataTextField="FIBER_DESC"  DataValueField="FIBER_CODE" 
   ...
   --%>                 </td>
                 ...
                 <%--   added by Nishant rai at 26/07/2013--%>
                    ...
                    <tr>
                        <td align="right" valign="top" width="30%">
                          <asp:Label ID="lblCodePrefix" runat="server" Text="Party:" ></asp:Label>  
                        </td>
                        <td align="left" valign="top" width="70%"  >
