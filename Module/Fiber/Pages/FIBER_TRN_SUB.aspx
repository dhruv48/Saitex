...
<head id="Head1" runat="server">
    <title>Generate Poy Recieving Sub Tran</title>
                            ...
                            <table width="100%" >
                                <tr bgcolor="#006699">
                                    <td align="left" class="tdLeft SmallFont" valign="top">
                                        <span class="titleheading"><b>Pallet No</b></span>
                                    </td>
                                    <td align="left" class="tdLeft SmallFont" valign="top">
                                    ...
                                    <td align="left" class="tdLeft SmallFont" valign="top">
                                        <span class="titleheading"><b>No of Tubes</b></span>
                                    </td>
                                    <td align="left" class="tdLeft SmallFont" valign="top">
                                        <span class="titleheading"><b>UOM</b></span>
                                    </td>
                                    <td align="left" class="tdLeft SmallFont" valign="top">
                                        <span class="titleheading"><b>Weight. of Tube</b></span>
                                    </td>
                                ...
                                <tr>
                                    <td align="left" valign="top">
                                        <asp:TextBox ID="txtLotNo" Width="70px" class="SmallFont uppercase" runat="server" MaxLength="14" TabIndex="1"></asp:TextBox>
                                      
                                    </td>
                                    <td align="left" valign="top">
                                        <asp:TextBox ID="txtGrade" class="SmallFont uppercase" Width="70px" runat="server" MaxLength="14" TabIndex="2"></asp:TextBox>
                                       
                                    </td>
                                    <td align="left" valign="top">
                                        <asp:TextBox ID="txtQty" Width="70px" class="SmallFont" runat="server" AutoPostBack="True"
                                            OnTextChanged="txtQty_TextChanged" MaxLength="9" TabIndex="3"></asp:TextBox>
                                    ...
                                    <td align="left" valign="top">
                                        <asp:TextBox ID="txtNoofUnit" runat="server" class="SmallFont" Width="70px" AutoPostBack="True"
                                            OnTextChanged="txtNoofUnit_TextChanged" MaxLength="5" TabIndex="5"></asp:TextBox>
                                    ...
                                    <td align="left" valign="top">
                                        <asp:DropDownList ID="ddlUOM" class="SmallFont" runat="server" TabIndex="6">
                                        </asp:DropDownList>
                                    </td>
                                    <td align="left" valign="top">
                                    ...
                                    <td align="left" valign="top" visible="false" runat="server">
                                        <asp:TextBox ID="txtDofMfd" class="SmallFont" Width="70px" runat="server" TabIndex="7"></asp:TextBox>
                                    ...
                                    <td align="left" valign="top" visible="false" runat="server">
                                        <asp:DropDownList ID="ddlMaterialStatus" class="SmallFont" runat="server" TabIndex="8">
                                   ...
                                   <td>
                                        <asp:Button ID="BtnBOMSave" class="SmallFont" runat="server" OnClick="BtnBOMSave_Click"
                                            Text="Add" ValidationGroup="YM" Width="60px" TabIndex="9" />
                                        
                                            </td>
                                            
                                            <td>
                                            <asp:Button ID="BtnBOMCancel" runat="server" class="SmallFont" OnClick="BtnBOMCancel_Click"
                                            Text="Cancel" Width="60px" TabIndex="10"/>
                                            </td>
                                            </tr></table>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" colspan="9" valign="top">
                                        <asp:GridView ID="grdsub_trn" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                            ...
                                            Width="98%" onrowdatabound="grdsub_trn_RowDataBound">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Pallet">
                                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbtlotno" runat="server" CssClass="LabelNo SmallFont" Text='<%# Bind("PALLET_NO") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Grade">
                                                    ...
                                                    <ItemTemplate>
                                                     ...
                                                     <FooterTemplate>
                                                    <asp:Label ID="lblTotal" runat="server" CssClass="LabelNo SmallFont"  >Total:</asp:Label>
                                                    </FooterTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="QTY">
                                                    ...
                                                    <ItemStyle HorizontalAlign="Right" VerticalAlign="Top" />
                                                     <FooterTemplate>
                                                    <asp:Label ID="txtTotalQTY" runat="server" CssClass="LabelNo SmallFont" ></asp:Label>
                                                    </FooterTemplate>
                                                    <FooterStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="No of Tubes">
                                                    ...
                                                    <FooterTemplate>
                                                    <asp:Label ID="lblTotalNoUnit" runat="server" CssClass="LabelNo SmallFont" ></asp:Label>
                                                    </FooterTemplate>
                                                    <FooterStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Material Status" Visible="false">
                                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
                                                    <ItemTemplate>
                                                        <asp:Label ID="txtBOMStatus" runat="server" CssClass="Label SmallFont" Text='<%# Bind("MATERIAL_STATUS") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                  <asp:TemplateField HeaderText="Material Status" Visible="false">
                                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
                                                    <ItemTemplate>
                                                        <asp:Label ID="txtBOMState" runat="server" CssClass="Label SmallFont" Text='<%# Bind("ROW_STATE") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                    ...
                    <tr>
                        <td align="center" class="td" valign="top">
                            <asp:Button ID="btnSubmit" class="SmallFont" runat="server" OnClick="btnSubmit_Click"
                                Text="Submit" ValidationGroup="M1" Width="70px" TabIndex="11"/>
                        </td>
                    </tr>
                </table>
            </ContentTemplate>
