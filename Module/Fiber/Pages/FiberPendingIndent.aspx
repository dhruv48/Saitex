<%@ Page Language="C#" MasterPageFile="~/CommonMaster/admin.master" AutoEventWireup="true" CodeFile="FiberPendingIndent.aspx.cs" Inherits="Module_Fiber_Pages_FiberPendingIndent"  Title="Untitled Page" %>
...
<td align="right"  width="10%" >
        ...
        <td  align ="left" width: 10%" ID="txtDate1" >
            <asp:TextBox ID="txtDate1" runat="server"  OnTextChanged="TxtFromDate_TextChanged"  CssClass ="TextBox"></asp:TextBox>
...
<td  align="right" width="10%" >
    ...
    <td align ="left" width: 15%">
                        ...
                        DataTextField="FIBER_CODE" DataValueField="FIBER_CODE" MenuWidth="650px" EnableVirtualScrolling="true"
   ...
   <td align="right" width="10%" >
    ...
    <td  align ="left" width="15%"  visible ="false" >
   ...
   <td  align="right" width="15%" visible ="false" >
                &nbsp;</td>
           <td align ="left" width: 15%">
...
<td  align="right" width="15%"  visible = "false">
         ...
         <tr>
            <td  colspan="8">
            <asp:GridView ID="gvDeptPendIndents"   runat="server"  
            ...
            CssClass = "smallfont"   
                   ...
                   <%--     <asp:TemplateField HeaderText="Location">
                       ...
                       <%-- <asp:TemplateField HeaderText="Store">
                        ...
                        <asp:TemplateField HeaderText="Poy Qty.">
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Store" Visible ="false">
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:Label ID="lblDOJ" Text='<%#Eval("DEPT_NAME") %>' runat="server"></asp:Label>
                            </ItemTemplate>
                            <ItemStyle Width="2%" HorizontalAlign="Center" />
                        </asp:TemplateField>
