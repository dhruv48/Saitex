            ...
            <ContentTemplate>
                <table class="td" >
                            <caption>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Button ID="btnSaveRateCompo" runat="server"  CssClass="SmallFont" Width="60px"
                                                OnClick="btnSaveRateCompo_Click" Text="Add" />
                                            <asp:Button ID="btnCancelRateCompo" runat="server" CssClass="SmallFont" Width="60px" 
                    ...
                    <tr>
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Button ID="btnSubmit" runat="server" OnClick="btnSubmit_Click" Text="Submit" CssClass="SmallFont" Width="80px"
                                ValidationGroup="M1" />
                        </td>
                    </tr>
                </table>
