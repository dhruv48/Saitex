<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FiberIndentClosing.ascx.cs" Inherits="Module_Fiber_Controls_FiberIndentClosing" %>
...
<table align="left" border="0" cellpadding="0" cellspacing="0" class="tContentArial">
    ...
    <tr>
        <td align="center" class="TableHeader td">
            <b class="titleheading">Poy Indent Closing</b>
        </td>
    </tr>
    <tr>
        <td align="left" valign="top" class="td">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Indent No" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right">
                        <ItemTemplate>
                            ...
                            <asp:Label ID="lblItemCode" runat="server" Text='<%# Bind("FIBER_CODE") %>' ToolTip='<%# Bind("IND_TYPE") %>'
