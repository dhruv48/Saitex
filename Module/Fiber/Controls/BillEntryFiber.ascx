<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BillEntryFiber.ascx.cs" Inherits="Module_Fiber_Controls_BillEntryFiber" %>
        ...
        <table class="tdMain" width="100%">
            ...
            <tr>
                <td align="center" class="TableHeader td" width="100%">
                    <b class="titleheading">Party/Vendor Bill Entry for Fiber Inventory</b>
                </td>
            </tr>
            <tr>
