<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ReceivingPartyFiber.ascx.cs" Inherits="Module_Fiber_Controls_Fiber_Receiving_Miss" %>
...
<td align="center" class="TableHeader td" width="100%">
            <b class="titleheading">Poy Receiving Against Party</b>
        </td>
</tr>
<tr>
            ...
            <table width="100%">
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td align="left" valign="top" width="17%">
                        <asp:TextBox ID="txtLRNo" runat="server" TabIndex="6" Width="150px" CssClass="TextBoxNo TextBoxDisplay SmallFont"
                            MaxLength="15"></asp:TextBox>
                    </td>
                    <td align="right" valign="top" width="17%">
                   ...
                   <asp:TextBox ID="txtPalletCode" runat="server" CssClass="TextBox SmallFont"
                    ...
                    <td>
                       <asp:TextBox ID="txtGrade" runat="server" CssClass="TextBox  SmallFont"
                            ...
                            <td>
                             ...
                             <cc2:ComboBox ID="txtMergeNo" runat="server"  EnableLoadOnDemand="true"
                            OnLoadingItems="txtLotNo_LoadingItems" DataTextField="MST_CODE" DataValueField="MST_CODE"
                            EmptyText="Merge No" 
                            EnableVirtualScrolling="true" Width="100px" MenuWidth="300px" Height="200px"  TabIndex="15">
                            <HeaderTemplate>
                                <div class="header c2">
                                    Merge No</div>
                                <div class="header c3">
                    ...
                    <td >
                      <cc2:ComboBox ID="txtPalletCode" runat="server" EnableLoadOnDemand="true"
                            ...
                            EnableVirtualScrolling="true" Width="100px" MenuWidth="300px" Height="200px"  TabIndex="16">
                            <HeaderTemplate>
                                <div class="header c2">
                                   Pallet Code</div>
                                <div class="header c3">
                    ...
                    <td>
                       <cc2:ComboBox ID="txtGrade" runat="server"  EnableLoadOnDemand="true"
                            ...
                            EmptyText="Grade" 
                            EnableVirtualScrolling="true" Width="60px" MenuWidth="100px" Height="200px"  TabIndex="17">
                            <HeaderTemplate>
                                <div class="header c1">
                                    Grade</div>
