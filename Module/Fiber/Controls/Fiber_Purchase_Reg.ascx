            ...
            <table width="945px" class=" td tContentArial">
                <tr>
                    <td align="center" class="TableHeader td" colspan="8">
                        <span class="titleheading"><strong>Poy Purchase Register Detail</strong> </span>
                    </td>
                </tr>
            </table>
                        ...
                        <tr>
                            ...
                            <td class="tdLeft">
                                <asp:TextBox ID="TxtFromDate" Width="150px" runat="server" CssClass="SmallFont TextBox UpperCase"
                                    ></asp:TextBox><%--OnTextChanged="TxtFromDate_TextChanged" AutoPostBack="True"--%>
                            </td>
                            <td align="right">
                                To&nbsp;Date:
                            </td>
                            <td class="tdLeft">
                                <asp:TextBox ID="TxtToDate" CssClass="SmallFont TextBox UpperCase" Width="150px"
                                    runat="server" ></asp:TextBox><%--OnTextChanged="TxtToDate_TextChanged" AutoPostBack="True"--%>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">
