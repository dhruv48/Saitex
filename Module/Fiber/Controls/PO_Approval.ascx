            ...
            <asp:GridView ID="grd_fib_po_app" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="CONF_BY" HeaderText="CONFIRM BY">
                     ...
                     <asp:TemplateField  >
                        <ItemTemplate>
                        <asp:LinkButton ID="lnkPoNumb" runat="server" Text="Edit" 
                                onclick="lnkPoNumb_Click"></asp:LinkButton>
                            <asp:Label ID="lblPO_NUMB" runat="server" Text='<%# Bind("PO_NUMB") %>' Visible="false"></asp:Label>
