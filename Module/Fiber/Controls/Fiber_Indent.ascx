...
<table class="tContentArial" align="center" width="95%">
    ...
    <tr>
        <td class="TableHeader" class="td" align="center" width="100%">
            <b class="titleheading">Poy Indent Entry</b>
        </td>
    </tr>
    <tr>
            ...
            <table width="98%">
                <tr bgcolor="#006699">
                    <td class="tdLeft SmallFont">
                        <span class="titleheading"><b>Poy Code </b></span>
                    </td>
                   <td class="tdLeft SmallFont">
                 ...
                 <%--  <td   class="tdLeft SmallFont" >
                    ...
                    <td class="tdRight SmallFont">
                      ...
                      <td class="tdRight SmallFont" id="dtUOM2th" runat="server" visible="false">
                        <span class="titleheading"><b>UOM2 </b></span>
                    </td>
                      <td class="tdRight SmallFont" id="dtBAIL2th" runat="server" visible="false">
                ...
                <tr>
                    <td align="left" valign="top">
                        <cc2:ComboBox ID="cmbFabricCode" runat="server" AutoPostBack="True" CssClass="smallfont"
                            ...
                            MenuWidth="500px" OnLoadingItems="Item_LOV_LoadingItems" 
                            OpenOnFocus="true" TabIndex="7" Visible="true" Width="99%"
                 ...
                 <%--   <td align="left" valign="top">
                    ...
                    <td align="right" valign="top">
                        <asp:TextBox ID="txtRequestQty" runat="server" onkeyup="javascript:Calculation(this.id)"
                            CssClass="TextBoxNo SmallFont" Width="99%" TabIndex="8" 
                    ...
                    <td align="right" valign="top">
                      ...
                      <td align="right" valign="top" id="dtUOM2tr" runat="server" visible="false">
                        <asp:TextBox ID="Txtuom2" runat="server" ReadOnly="true" CssClass="TextBox SmallFont TextBoxDisplay"
                            Width="99%"></asp:TextBox>
                    </td>
                      <td align="right" valign="top" id="dtBAIL2tr" runat="server" visible="false">
                    ...
                    <td align="left" valign="top">
                        ...
                        <asp:Button ID="lbtnsavedetail" runat="server" Text="Add" Height="22px" Width="60px" CssClass="SmallFont"
        ...
        <td class="td" align="left" width="100%">
            <asp:Panel ID="pnlGrid" runat="server" Height="250px" ScrollBars="Vertical" Width="100%">
                ...
                <%--   <asp:TemplateField HeaderText="Shade Code" >
                        ...
                        <asp:TemplateField HeaderText="Party&nbsp;Stock">
                            <HeaderStyle VerticalAlign="Top" HorizontalAlign="Left" />
                            <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" Width="5%"></ItemStyle>
                            <ItemTemplate>
