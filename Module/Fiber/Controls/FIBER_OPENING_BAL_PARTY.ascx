<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FIBER_OPENING_BAL_PARTY.ascx.cs"
    Inherits="Module_Fiber_Controls_FIBER_OPENING_BAL_PARTY" %>
            ...
            <table width="100%" class="tContentArial"  >
                <tr>
                    <td align="center" class="TableHeader td" valign="top">
                        <span class="titleheading"><b>P.O.Y. Opening Form Against JobWork Party</b></span>
                    </td>
                </tr>
                <tr>
