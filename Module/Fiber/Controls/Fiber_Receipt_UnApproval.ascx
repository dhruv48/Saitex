<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Fiber_Receipt_UnApproval.ascx.cs" Inherits="Module_Fiber_Controls_Fiber_Receipt_UnApproval" %>
...
<td id = "tdUpdate" align="left" runat="server">
 ...
 <tr>
        <td align="center" class="TableHeader td" width="100%">
            <b class="titleheading">POY Transaction UnApproval</b>
        </td>
    </tr>
    <tr>
