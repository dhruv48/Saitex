...
<table class="tContentArial" width="100%">
    ...
    <tr>
        <td class="TableHeader td" align="center" width="100%">
            <span class="titleheading"><b>Poy Purchaser Order </b></span>
        </td>
    </tr>
    <tr>
        <td class="td tdLeft">
            ...
            <table width="100%">
                <tr style="font-weight: bold">
                    ...
                    <td valign="top" align="left" width="15%">
                        <asp:DropDownList ID="ddlOrderType"  runat="server" Width="125px" CssClass="TextBox SmallFont"
                    ...
                    <td valign="top" align="left" width="15%">
                        <asp:TextBox ID="txtOrderNumber"  Font-Bold="true" runat="server" 
                        ...
                        <cc2:ComboBox ID="ddlOrderNumber" runat="server" AutoPostBack="True" CssClass="SmallFont"
                            DataTextField="PO_NUMB" DataValueField="PO_NUMB" OnLoadingItems="ddlOrderNumber_LoadingItems" EmptyText="Find Item" EnableLoadOnDemand="true"
                            Height="200px" OnSelectedIndexChanged="ddlOrderNumber_SelectedIndexChanged" MenuWidth="450px" 
                    ...
                    <td valign="top" align="left" width="25%">
                        <asp:TextBox ID="txtOrderDate" TabIndex="2" Font-Bold="true" runat="server" Width="60px"
                ...
                <tr>
                    ...
                    <td valign="top" align="left" width="15%">
                        <cc2:ComboBox ID="txtPartyCode" runat="server" AutoPostBack="True" EnableLoadOnDemand="true"
                            ...
                            EnableVirtualScrolling="true" Width="150px" MenuWidth="800px" Height="200px" TabIndex="3" >
                            <HeaderTemplate>
                                <div class="header c1">
                                    Code</div>
                                <div class="header c3">
                ...
                <tr>
                    ...
                    <td valign="top" align="left" width="15%">
                        <cc2:ComboBox ID="txtTransporterCode" runat="server" AutoPostBack="True" EnableLoadOnDemand="true"
                            ...
                            Width="150px" EmptyText="Select transaporter" MenuWidth="800px" Height="200px" TabIndex="4">
                            <HeaderTemplate>
                                <div class="header c1">
                                    Code</div>
                                <div class="header c3">
            ...
            <table width="100%">
                <tr>
                    ...
                    <td width="15%" class="tdLeft">
                        <asp:DropDownList ID="ddlPONature" runat="server" CssClass="SmallFont TextBox" TabIndex="5" Width="80%">
                        </asp:DropDownList>
                    </td>
                    <td width="15%" class="tdRight">
                    ...
                    <td width="15%" class="tdLeft">
                        <asp:DropDownList ID="txtCurrencyCode" Width="80%" runat="server" CssClass="SmallFont TextBox"
                            AppendDataBoundItems="True" AutoPostBack="True" TabIndex="6">
                        </asp:DropDownList>
                    </td>
                    <td width="15%" class="tdRight">
                    ...
                    <td width="25%" class="tdLeft">
                        <asp:TextBox ID="txtconversionRate" CssClass="SmallFont TextBoxNo" runat="server"
                             Width="50px" TabIndex="7"></asp:TextBox>
                    </td>
                </tr>
            </table>
        </td>
                ...
                <tr>
                    ...
                    <td valign="top" align="left" width="35%">
                        <asp:DropDownList ID="ddlDelAdd" runat="server" CssClass="SmallFont TextBox" AutoPostBack="true"
                            Width="150px" AppendDataBoundItems="true" OnSelectedIndexChanged="ddlDelAdd_SelectedIndexChanged" TabIndex="8">
                        </asp:DropDownList>
                        <asp:TextBox ID="txtDelAddress"  runat="server" Width="60%" CssClass="SmallFont gCtrTxt"></asp:TextBox>
                    </td>
                    ...
                    <td class="tdLeft" width="30%">
                        <asp:TextBox ID="txtDeliveryDate" TabIndex="9" runat="server" Width="60px" CssClass="SmallFont gCtrTxt"
    ...
    <tr>
        <td width="100%" class="td SmallFont">
            <table width="100%">
                ...
                <tr id="TRfETCHINDENT" runat="server" visible="false">
                    <td align="right" valign="top" width="15%">
                        Fetch From Indent :
                    </td>
                    <td align="left" valign="top" width="85%">
                        <asp:CheckBox ID="chkFetchIndent" runat="server" AutoPostBack="True" 
                            Width="10px" oncheckedchanged="chkFetchIndent_CheckedChanged" TabIndex="14" />
                        <asp:DropDownList ID="ddlIndent" runat="server" AutoPostBack="True" CssClass="SmallFont TextBox"
                            OnSelectedIndexChanged="ddlIndent_SelectedIndexChanged" Width="100px" Visible="False" TabIndex="15">
                        </asp:DropDownList>
                    </td>
                </tr>
            </table>
    ...
    <tr>
        <td align="left" class="td SmallFont" valign="top" width="100%">
            <table width="100%">
                <tr bgcolor="#336699" width="100%">
                    <td class="tdLeft SmallFont" width="15%">
                        <asp:Label ID="Label18" runat="server" CssClass="LabelNo titleheading" Text="Poy Code"></asp:Label>
                    </td>
                    
                    <td class="tdLeft SmallFont" width="7%" runat="server" visible="false" id="tdindentth">
                        <asp:Label ID="Label20" runat="server" CssClass="LabelNo titleheading" Text="Adjust"></asp:Label>
                    </td>
                    <td class="tdRight SmallFont" width="10%">
                        <asp:Label ID="Label21" runat="server" CssClass="LabelNo titleheading" Text="Quantity"></asp:Label>
                    </td>
                    <td class="tdLeft SmallFont" width="10%">
                        <asp:Label ID="Label22" runat="server" CssClass="LabelNo titleheading" Text="UOM"></asp:Label>
                    </td>
                      <td class="tdLeft SmallFont" id="tdUOM2th" runat="server" visible="false">
                        <asp:Label ID="Label10" runat="server" CssClass="LabelNo titleheading" Text="UOM2"></asp:Label>
                    </td>
                      <td class="tdLeft SmallFont" id="tdBaleth" runat="server" visible="false">
                ...
                <tr>
                    <td class="tdLeft" width="15%">
                        <cc2:ComboBox ID="txtItemCode" runat="server" AutoPostBack="True" CssClass="SmallFont"
                            ...
                            Height="200px" MenuWidth="450px" OnLoadingItems="txtItemCode_LoadingItems" 
                            TabIndex="16" EnableVirtualScrolling="true" Width="99%" 
                   ...
                   <%-- <td class="tdLeft">
                    ...
                    <td class="tdLeft" width="7%" runat="server" visible="false" id="tdindenttr">
                        <asp:Button ID="btnAdjustIndent" TabIndex="17" runat="server" Font-Size="8pt" 
                            Text="Ind.Ajust" onclick="btnAdjustIndent_Click" Width="99%"/>
                    </td>
                    <td class="tdLeft" width="10%">
                        <asp:TextBox ID="txtOrderQty" TabIndex="18" CssClass="TextBoxNo SmallFont"
                            runat="server"  Text='<%# Bind("ORD_QTY") %>' ReadOnly="false" 
                            AutoPostBack="True" ontextchanged="txtOrderQty_TextChanged" Width="99%"></asp:TextBox>
                    </td>
                    <td class="tdLeft" width="10%">
                        <asp:TextBox ID="txtUnit"  CssClass="TextBox SmallFont TextBoxDisplay"
                            runat="server" ReadOnly="true"  Text='<%# Bind("UOM") %>' Width="99%"></asp:TextBox>
                    </td>
                     <td class="tdLeft" id="tdUOM2tr" runat="server" visible="false">
                        <asp:TextBox ID="txtUnit1"  CssClass="TextBox SmallFont TextBoxDisplay"
                            runat="server" ReadOnly="true"  Text='<%# Bind("UOM1") %>' Width="99%"></asp:TextBox>
                    </td>
                     <td class="tdLeft" id="tdBaletr" runat="server" visible="false">
                        <asp:TextBox ID="txtkg_bail"  CssClass="TextBox SmallFont TextBoxDisplay"
                            runat="server" ReadOnly="true"  Text='<%# Bind("UOM_BAIL") %>' Width="99%"></asp:TextBox>
                    </td>
                    <td class="tdLeft" width="10%">
                        <asp:TextBox ID="txtBaseRate" TabIndex="19" runat="server"  Text='<%# Bind("BASIC_RATE") %>'
                            CssClass="TextBoxNo SmallFont" AutoPostBack="True" 
                            ontextchanged="txtBaseRate_TextChanged" Width="99%"></asp:TextBox>
                    ...
                    <td class="tdLeft" width="7%">
                        <asp:Button ID="btnDiscountTaxes" TabIndex="20" runat="server" Font-Size="8pt" Text="Disc/Taxes"
                            onclick="btnDiscountTaxes_Click" 
                             Width="99%"/>
                    </td>
                    <td class="tdLeft" width="10%">
                        <asp:TextBox ID="txtFinalRate"  ReadOnly="true" runat="server" Text='<%# Bind("FINAL_RATE") %>'
                             CssClass="TextBoxNo SmallFont TextBoxDisplay" 
                            AutoPostBack="True" ontextchanged="txtFinalRate_TextChanged" Width="99%"></asp:TextBox>
                    </td>
                    <td class="tdLeft" width="10%">
                        <asp:TextBox ID="txtAmount"   ReadOnly="true" runat="server"
                            Text='<%# Bind("Amount") %>' CssClass="TextBoxNo SmallFont TextBoxDisplay" Width="99%"></asp:TextBox>
                    </td>
                    <td class="tdLeft" width="10%">
                        <asp:TextBox ID="txtQuotation" TabIndex="21"  runat="server" Text='<%# Bind("QUOTATION_NO") %>'
                            CssClass="TextBoxNo SmallFont" Width="99%"></asp:TextBox>
                    </td>
                    <td class="tdLeft" width="10%">
                        <asp:TextBox ID="txtTrnDeliveryDate" TabIndex="22" runat="server" 
                            CssClass="TextBox SmallFont" Width="99%"></asp:TextBox>
                    ...
                    <td class="tdLeft">
                        <asp:Button ID="btnSaveDetail" Text="Add" CssClass=" SmallFont" runat="server" 
                            onclick="btnSaveDetail_Click" TabIndex="23" Width="60px">
                        </asp:Button>
                ...
                <asp:TextBox ID="lblItemCode"  ReadOnly="true" CssClass="TextBox SmallFont TextBoxDisplay"
                    ...
                    <td class="tdLeft" colspan="8">
                        <asp:TextBox ID="txtItemDescription" ReadOnly="true" CssClass="TextBox SmallFont TextBoxDisplay"
                            runat="server" Text='<%# Bind("FABR_DESC") %>' Width="90%" ></asp:TextBox>
                    </td>
                    <td width="10%">
                    <asp:Button ID="btnCancelDetail" Text="Cancel" CssClass=" SmallFont" 
                            runat="server" onclick="btnCancelDetail_Click" TabIndex="24" Width="60px"></asp:Button>
                    </td>
                </tr>
            </table>
        </td>
                ...
                <tr id="trMaterialPOCreditTRN" runat="server">
                    <td width="100%" class="td SmallFont">
                        <asp:GridView ID="gvMaterialPOTRN" TabIndex="16" runat="server" 
                            ...
                            AllowPaging="false" onrowcommand="gvMaterialPOTRN_RowCommand"  Width="98%">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Uom">
                                 ...
                                 <asp:TemplateField HeaderText="Uom1" Visible="false">
                                    <ItemTemplate>
                                 ...
                                 <asp:TemplateField HeaderText="Uom_Bail" Visible="false">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Delete">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkEdit" TabIndex="29" runat="server" Text="Edit" CommandName="POMateialCreditEdit"
                                            CommandArgument='<%# Eval("UniqueId") %>' CausesValidation="false"></asp:LinkButton>
                                        /
