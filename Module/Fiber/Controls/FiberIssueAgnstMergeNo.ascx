<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FiberIssueAgnstMergeNo.ascx.cs"
...
<table class="tdMain" width="100%">
    ...
    <tr>
        <td align="center" class="TableHeader td" width="100%">
            <b class="titleheading">Poy Issue For Production</b>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td width="100%" class="td SmallFont">
            <table width="100%">
                ...
                <tr>
                   <td class="tdRight" width="17%">
                                <asp:Label ID="Label17" runat="server" CssClass="Label SmallFont" Text="Merge No.:"></asp:Label>
                            </td>
                     <td class="tdLeft" width="17%">
                ...
                Height="200px" MenuWidth="600px" TabIndex="9" EnableVirtualScrolling="true"
