...
public partial class Module_Fiber_Controls_PO_Unapproval : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
               lblHeader.Text = "Approved Poy Purchase Order Unapproval";               
                BindFiberPoAppGrid();
            }
        }
        catch (Exception ex)
    ...
    private void BindFiberPoAppGrid()
    {
        try
        {
            SaitexDM.Common.DataModel.UserLoginDetail oUserLoginDetail = (SaitexDM.Common.DataModel.UserLoginDetail)Session["LoginDetail"];
             ...
             dt = SaitexBL.Interface.Method.TX_FIBER_PO_CREDIT.GetDataForUnApproval(oUserLoginDetail.COMP_CODE, oUserLoginDetail.CH_BRANCHCODE, oUserLoginDetail.DT_STARTDATE.Year);
