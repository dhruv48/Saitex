<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Fiber_Issue_Misc.ascx.cs"
    Inherits="Module_Fiber_Controls_Fiber_Issue_Misc" %>
...
<table class="tdMain" width="100%">
    ...
    <tr>
        <td align="center" class="TableHeader td" width="100%">
            <b class="titleheading">Poy Issue Misc.</b>
        </td>
    </tr>
    <tr>
            ...
            <table width="100%">
                ...
                <tr>
                   <td class="tdRight" width="17%">
                     ...
                     <td class="tdLeft" width="17%">
                    <asp:TextBox ID="TxtLotIdNo" runat="server" TabIndex="14" Width="98%" CssClass="TextBoxNo " ></asp:TextBox>
                ...
                <tr>
                    <td width="15%">
                        <cc2:ComboBox ID="DDLPiNo" runat="server" CssClass="SmallFont" EmptyText="select.."
                            AutoPostBack="True" EnableLoadOnDemand="true" MenuWidth="550px" OnLoadingItems="DDLPiNo_LoadingItems"
                            ...
                            <ItemTemplate>
                                ...
                                <div class="item c3">
                                    <asp:Literal runat="server" ID="Literal2" Text='<%# Eval("FIBER_CODE") %>' />
                                </div>
                                <div class="item c4">
                                    <asp:Literal runat="server" ID="Literal3" Text='<%# Eval("FIBER_DESC") %>' />
                                </div>
                                <div class="item c3">
                                    <asp:Literal runat="server" ID="Container2" Text='<%# Eval("FIBER_CAT") %>' />
                                </div>
                            </ItemTemplate>
                            <FooterTemplate>
                                Displaying items
                ...
                <tr>
                    <td colspan="9" width="92%">
                        <asp:TextBox ID="txtPANo" runat="server" CssClass="TextBox TextBoxDisplay SmallFont"
                            ReadOnly="true" Width="110px" Visible="false"></asp:TextBox>
    ...
    <tr>
        <td width="100%" class="td">
            <asp:Panel ID="pnlGrid" runat="server" Width="100%">
                ...
                <asp:Label ID="lblPO_BRANCH" runat="server" Visible="false" Text="B99999"></asp:Label>
                <asp:Label ID="lblPO_TYPE" runat="server" Visible="false" Text="PMR"></asp:Label>
                <asp:Label ID="lblPO_COMP" runat="server" Visible="false" Text="C99999"></asp:Label>
            </asp:Panel>
        </td>
    </tr>
</table>
