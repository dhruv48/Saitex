<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IssueY.aspx.cs" Inherits="Module_Fiber_Queries_IssueY" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Innovative Textiles Pvt. Ltd. :: Issue Details</title>
...
<body bgcolor="#afcae4"">
    ...
    <table border="1" cellpadding="3" cellspacing="0" width="100%" class="tContentArial"
        ...
        <tr>
        <td width="30%">
                Branch : <asp:Label ID="lblBranch"  Font-Bold=true runat="server"></asp:Label>
            </td>
            
            <td width="20%">
                Year : <asp:Label ID="lblYear"  Font-Bold=true runat="server"></asp:Label>
            </td>
           
            <td width="50%">
                Item Description : <asp:Label ID="lblItemDesc"  Font-Bold=true runat="server"></asp:Label>
            </td>
        ...
        <tr>
            <td colspan="6">
               <asp:GridView ID="gvIssueDetails"   runat="server"  
            AutoGenerateColumns="False" AllowPaging="False" AllowSorting="True" Font-Size="x-Small" 
            CellPadding="3"   GridLines="Both" Width="100%" ForeColor="#333333" 
            CssClass = "smallfont"   
                    PagerStyle-HorizontalAlign="Left" onpageindexchanging="gvIssueDetails_PageIndexChanging"                   
