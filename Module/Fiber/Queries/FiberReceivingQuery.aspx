...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <table class="td tContentArial">
        ...
        <tr>
            <td align="center" class="TableHeader tdinset td " colspan="15">
                <span class="titleheading">Poy Recieving Query Form</span>
            </td>
        </tr>
        <tr>
            <td align="right">
            ...
            <td>
                <cc2:ComboBox ID="ddlYarn" runat="server" AutoPostBack="True" CssClass="smallfont"
                    ...
                    MenuWidth="660" OnLoadingItems="Item_LOV_LoadingItems" EnableVirtualScrolling="true" Width="150px"
 ...
 <asp:TemplateField HeaderText="BRANCH" HeaderStyle-HorizontalAlign="Left" Visible="true">
                            ...
                            <asp:TemplateField HeaderText="POY" HeaderStyle-HorizontalAlign="Left" Visible="true" >
                                    <ItemTemplate>
                                    ...
                                    <asp:GridView ID="grdBOM" runat="server" AutoGenerateColumns="False" ShowFooter="true">
                                        <Columns>
                                                ...
                                                <asp:BoundField DataField="WEIGHT_OF_UNIT" HeaderText="WEIGHT OF UNIT" HeaderStyle-Font-Size="8">
                                                       ...
                                                       <asp:BoundField DataField="DATE_OF_MFG" HeaderText="DATE OF MANUFACTURE" HeaderStyle-Font-Size="8" Visible="false">
                                                        <ItemStyle HorizontalAlign="Left" Wrap="true" CssClass="labelNo smallfont" VerticalAlign="Top" />
                                                        </asp:BoundField>
                                                    ...
                                                    <FooterTemplate>
                                                     <asp:Label ID="lblFIssQTY" runat="server" CssClass="LabelNo SmallFont" Font-Bold="true"></asp:Label>
                                                       ...
                                                       <asp:BoundField DataField="MATERIAL_STATUS" HeaderText="STATUS" HeaderStyle-Font-Size="8" Visible="false">
                                                        <ItemStyle HorizontalAlign="Left" Wrap="true" CssClass="labelNo smallfont" VerticalAlign="Top" />
                                                  </asp:BoundField>
