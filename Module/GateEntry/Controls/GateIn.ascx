<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GateIn.ascx.cs" Inherits="Module_GateEntry_Controls_GateIn" %>
...
<table class="tContentArial">
    ...
    <tr>
        <td class="TableHeader td" align="center" width="100%">
            <span class="titleheading"><b>PRINT GATE IN REPORT
