<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FiberGateEntry.ascx.cs"
    Inherits="Module_GateEntry_Controls_FiberGateEntry" %>
                ...
                <tr>
                    <td id="tdSave" runat="server" align="center" valign="top">
                        <asp:ImageButton ID="imgbtnSave" runat="server" Height="41" ImageUrl="~/CommonImages/save.jpg"
                            ToolTip="Save" ValidationGroup="GI" Width="48" 
                    ...
                    <td id="tdUpdate" runat="server" align="center" valign="top">
                        <asp:ImageButton ID="imgbtnUpdate" runat="server" Height="41" ImageUrl="~/CommonImages/edit1.jpg"
                            ToolTip="Update" ValidationGroup="GI" Width="48" 
                    ...
                    <td align="center" valign="top">
                        <asp:ImageButton ID="imgbtnExit" runat="server" Height="41" ImageUrl="~/CommonImages/link_exit.png"
                            ...
                            OnClientClick="if (!confirm('Are you  sure Want to Exit?')) { return false; }" 
        ...
        <td align="left" class="td" valign="top" width="100%">
            <table width="100%">
                <tr style="font-weight: bold" width="100%">
                    ...
                    <td class="tdLeft">
                        <asp:TextBox ID="txtGateRunningNo"  runat="server" MaxLength="15" ReadOnly="true" Width="150px"
                ...
                <tr width="100%">
                    ...
                    <td>
                        <asp:TextBox ID="txtDocNo" TabIndex="3" runat="server" CssClass="SmallFont TextBoxNo" MaxLength="25" Width="150px"></asp:TextBox>
                    ...
                    <td class="tdLeft">
                        ...
                        <asp:RangeValidator ID="RangeValidator1" runat="server" ErrorMessage="Please Enter Doc Amount Numeric and Precision 9  Scale 2"
                          ...
                          <cc1:FilteredTextBoxExtender ID="FiltertxtAmount" runat="server"
                                                       TargetControlID="txtDocAmount"         
                ...
                <tr width="100%">
                    ...
                    <td>
                        <asp:TextBox ID="txtLorryno" TabIndex="6" runat="server" CssClass="SmallFont TextBox" MaxLength="25" Width="150px"></asp:TextBox>
                    </td>
                    <td class="tdRight">
                        Driver Name:
                    </td>
                    <td class="tdLeft">
                        <asp:TextBox ID="txtDriverName" TabIndex="7" runat="server" CssClass="SmallFont TextBox" MaxLength="45" Width="150px"></asp:TextBox>
                    </td>
                    <td class=" tdRight">
                        UOM:
                    </td>
                ...
                <tr id="trUOM1" runat="server" visible="false">
                 <td class=" tdRight">
                        UOM1:
                    </td>
                    <td class="tdLeft">
                        <asp:DropDownList ID="ddlUOM1" TabIndex="16" CssClass="SmallFont " runat="server"
                           Width="150px">
                        </asp:DropDownList>
                    </td>
                     <td class="tdRight">
                    ...
                    <td class="tdLeft">
                        <asp:TextBox ID="txtKgBail" TabIndex="15" runat="server" CssClass="SmallFont TextBox" MaxLength="45" Width="150px"></asp:TextBox>
                    </td>
                </tr>
                <tr width="100%">
                    <td class="tdRight">
                    ...
                    <td>
                        <asp:TextBox ID="txtQty" TabIndex="9" runat="server" CssClass="SmallFont TextBoxNo"
                            MaxLength="9" Width="150px"></asp:TextBox>
                    ...
                    <td class="tdLeft">
                        <asp:TextBox ID="txtSecurityIncharge" TabIndex="10" runat="server" CssClass="SmallFont TextBox"  MaxLength="90" Width="150px"> </asp:TextBox>
                    </td>
                    <td class=" tdRight">
                        Check By:
                    </td>
                    <td class="tdLeft">
                        <asp:TextBox ID="txtCheckBy" runat="server" TabIndex="11" CssClass="SmallFont TextBox "  MaxLength="45" Width="150px"></asp:TextBox>
                 ...
                 <tr width="100%">
                            ...
                            <td class="tdLeft">
                                <asp:TextBox ID="txtWeight" TabIndex="13" runat="server" CssClass="SmallFont TextBox" MaxLength="10" Width="150px"> </asp:TextBox>
                            </td>
                            <td class=" tdRight">
                          ...
                          <tr width="100%">
                            ...
                            <td>
                                    <asp:TextBox ID="txtRemarks" runat="server" TabIndex="14" Width="150px" MaxLength="1000"
                            ...
                            <td class="tdLeft">
                                <asp:TextBox ID="txtLRNo" TabIndex="15" runat="server" CssClass="SmallFont TextBox" MaxLength="10" Width="150px"> </asp:TextBox>
                            </td>
                            <td class=" tdRight">
                                LR Date:
                            </td>
                            <td class="tdLeft">
                                <asp:TextBox ID="txtLRDate" runat="server" TabIndex="16" CssClass="SmallFont TextBox " MaxLength="12" Width="150px"></asp:TextBox>
