<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FabricGateEntry.ascx.cs" Inherits="Module_GateEntry_Controls_FabricGateEntry" %>
<style type="text/css">
...
<script type="text/javascript" language="javascript">
    ...
    { 
     var name=val;                                                               
     document.getElementById('ctl00_cphBody_FabricGateEntry1_txtFinalRate').value=(parseFloat(document.getElementById('ctl00_cphBody_FabricGateEntry1_txtRecievedQuantity').value)*(parseFloat(document.getElementById('ctl00_cphBody_FabricGateEntry1_txtBasicRate').value))).toFixed(3) ;
    }
        ...
        <td align="left" class="td" valign="top" width="100%">
            <table>
                <tr>
                    ...
                    <td class=" ">
                        <cc3:OboutDropDownList ID="ddlTranType" runat="server" AutoPostBack="True" 
                ...
                <tr>
                    ...
                    <td class="tdLeft">
                        ...
                        <cc1:CalendarExtender ID="CalendarExtender2" runat="server" 
                          Format="dd/MM/yyyy"  PopupPosition="TopLeft" TargetControlID="txtDocDate">
                            ...
                            <tr>
                                <td align="left" class="tdLeft SmallFont" valign="top">
                                    <cc2:ComboBox ID="txtPartyCode1" runat="server" AutoPostBack="True" 
                                        DataTextField="FABR_CODE" DataValueField="FABR_CODE" EmptyText="Select Fabric Code" 
                                        EnableLoadOnDemand="true" Height="200px" MenuWidth="600px" 
                                                ...
                                                <asp:TemplateField HeaderText="Yarn Code">
                                                    <ItemTemplate>
                                                        <asp:Label ID="txtICODE" runat="server" CssClass="Label SmallFont" 
                                                            ReadOnly="true" Text='<%# Bind("FABR_CODE") %>' Width="70px"></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Description">
                                                    <ItemTemplate>
                                                        <asp:Label ID="txtDESC" runat="server" CssClass="Label SmallFont" 
                                                            ReadOnly="true" Text='<%# Bind("FABR_BASE") %>' Width="120px"></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
