<%@ Page Language="C#" MasterPageFile="~/CommonMaster/admin.master" AutoEventWireup="true" CodeFile="GATE_OUT.aspx.cs" Inherits="Module_GateEntry_Reports_GATE_OUT" Title="Untitled Page" %>
                ...
                <table>
                    ...
                    <td td class="tdLeft"> 
                        <asp:DropDownList ID="ddlGateType" runat="server"   CssClass="SmallFont"
                            onselectedindexchanged="ddlGateType_SelectedIndexChanged"   AutoPostBack="true" DataTextField="GATE_TYPE" DataValueField="GATE_TYPE" Width="160px" TabIndex="1" >
                        </asp:DropDownList>
                    </td>
                        <td class="tdRight">
