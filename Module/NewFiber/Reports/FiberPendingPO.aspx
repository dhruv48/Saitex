            ...
            <table width="100%"  class ="td tContentArial">
                ...
                <tr>
                    <td width="100%" align="center" class="TableHeader" colspan="10">
                        <b class="titleheading">Fiber Purchase Order Query</b>
                    </td>
                </tr>
                <tr>
                    <td  class="tdRight" >
           ...
           <cc2:ComboBox ID="ddlYarn" runat="server" AutoPostBack="True" CssClass="smallfont"
                ...
                TabIndex="9" Visible="true"
                    ...
                    <td  class="tdRight" >
                     ...
                     <td class="tdLeft" >
                        <asp:TextBox ID="txtPoFrom" runat="server" Width="100px" CssClass="SmallFont TextBoxNo"></asp:TextBox>
                    </td>
                   <td  class="tdRight" >
                        To :
                    </td>
                     <td class="tdLeft" >
                        <asp:TextBox ID="txtPoTo" runat="server" Width="100px" CssClass="SmallFont TextBoxNo"></asp:TextBox>
                    </td>
                        ...
                        <asp:GridView ID="gvReportDisplayGrid" runat="server" AutoGenerateColumns="False"  
                            ...
                            <Columns>
                              ...
                              <%--  <asp:TemplateField HeaderText="Year" HeaderStyle-HorizontalAlign="Left">
                                ...
                                <asp:TemplateField HeaderText="Fiber Description" ItemStyle-Width="250px" HeaderStyle-HorizontalAlign="Left">
                                    <ItemTemplate>
                               ...
                               <%-- <asp:TemplateField HeaderText="SHADE CODE" ItemStyle-Width="250px" HeaderStyle-HorizontalAlign="Left">
                                ...
                                <asp:TemplateField HeaderText="Yarn Code" ItemStyle-Width="250px" HeaderStyle-HorizontalAlign="Left"
                                    Visible="false">
                                    <ItemTemplate>
