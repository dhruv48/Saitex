        ...
        <table class="td tContent" style="width: 945px">
            ...
            <tr>
                <td class="TableHeader td" align="center">
                    <span class="titleheading">Fiber Stock Ageing</span>
                </td>
            </tr>
            <tr>
                <td class="tdLeft td">
                ...
                <td>
                    <table style="width: 945px">
                        <tr>
                            ...
                            <td class="tdRight">
                                <asp:Label ID="Label3" runat="server" Text="Fiber Code :" CssClass="Label"></asp:Label>
                            </td>
                            <td class="tdLeft">
                               ...
                               <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" Width="100%" />
                                ...
                                <Columns>
                                    <asp:BoundField DataField="BRANCH_NAME" HeaderText="Branch"    HeaderStyle-HorizontalAlign ="Left" ItemStyle-HorizontalAlign ="Left" />
                                     <asp:BoundField DataField="FIBER_CODE" HeaderText="Fiber Code"  HeaderStyle-HorizontalAlign ="Left" ItemStyle-HorizontalAlign ="Left" />                                     
                                     <asp:BoundField DataField="FIBER_DESC" HeaderText="FIBER Description" HeaderStyle-HorizontalAlign ="Left" ItemStyle-HorizontalAlign ="Left" />
