            ...
            <table width="100%">
                <tr>
                    <td align="center" class="TableHeader td" colspan="8">
                        <span class="titleheading"><strong>Fiber Detail Stock Report</strong> </span>
                    </td>
                </tr>
                <tr>
                    <td align="right">
               ...
               <asp:TextBox ID="TxtYarnCode" runat="server" Width="158px"></asp:TextBox>
                ...
                <asp:RadioButtonList ID="redForQuery" runat="server" Height="16px" 
                        RepeatDirection="Horizontal">                       
                         <asp:ListItem Text="Red" Value="red" Selected ="True"> Fiber Detail Lotwise Stock Report</asp:ListItem>
                            <asp:ListItem Text="Blue" Value="blue">Fiber Detail Challanwise Report</asp:ListItem>             
                  </asp:RadioButtonList>       
                    </asp:Panel>
                    </td>
                </tr>
