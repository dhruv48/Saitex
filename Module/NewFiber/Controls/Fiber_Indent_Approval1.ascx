<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Fiber_Indent_Approval1.ascx.cs" Inherits="Module_Fiber_Controls_Fiber_Indent_Approval1" %>
...
<b class="titleheading">Fiber Indent Approval</b>
</td>
</tr>
<tr>
...
<td align="left" colspan="3">
    ...
    <asp:GridView ID="grdFiberIndentApproval" runat="server" AllowPaging="True" 
        AllowSorting="True" AutoGenerateColumns="False" BorderWidth="1px" 
        onpageindexchanging="grdFiberIndentApproval_Pageing" PageSize="12">
        <Columns>
            ...
            <Itemtemplate> 
                            ...
                            <asp:Label ID="lblFiberCode" runat="server" ToolTip='<%# Bind("IND_TYPE") %>' 
                             Text='<%# Bind("FIBER_CODE") %>' Visible="false"></asp:Label>
                             </Itemtemplate>
                             <ItemStyle CssClass="labelNo smallfont" HorizontalAlign="Right" 
                            VerticalAlign="Top" Width="40px" />
            </asp:TemplateField>
            <asp:BoundField DataField="REQD_DATE" HeaderText="Required Date" DataFormatString="{0:dd/MM/yyyy}" HtmlEncode="false">  
             <ItemStyle CssClass="label smallfont" HorizontalAlign="Left" 
                            VerticalAlign="Top" Width="80px" />
             </asp:BoundField>
             <asp:BoundField DataField="FIBER_DESC" HeaderText="Fabric Description">
                        <ItemStyle CssClass="label smallfont" HorizontalAlign="Left" 
