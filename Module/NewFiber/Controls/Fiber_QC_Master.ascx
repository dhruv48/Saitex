<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Fiber_QC_Master.ascx.cs" Inherits="Module_NewFiber_Controls_Fiber_QC_Master" %>
                    ...
                    <table align="left" class="tContentArial" width="100%">
                        ...
                        <tr>
                            <td align="center" class="TableHeader td" width="100%">
                                <span class="titleheading"><b>Fiber QC Standard Master</b></span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td width="100%" class="td">
                                <table width="100%">
                                    <tr>
                                            ...
                                            <b>
                                                ...
                                                <cc2:ComboBox ID="ddlTRNNumber" runat="server" AutoPostBack="True" EnableLoadOnDemand="true"
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <div class="item c2">
                                                            <asp:Literal runat="server" ID="Container5" Text='<%# Eval("FIBER_CATEGORY") %>' />
                                                        </div>
                                                        <div class="item c2">
                                                            <asp:Literal runat="server" ID="Container6" Text='<%# Eval("FIBER_CODE") %>' />
                                                        </div>
                                                    </ItemTemplate>
                                                    <FooterTemplate>
                                                        Displaying items
                                        ...
                                        <td width="17%" class="tdRight style2">
                                            <asp:Label ID="Label17" runat="server" Text="Fiber Category : " CssClass="Label SmallFont"></asp:Label>
                                        </td>
                                        <td width="17%" class="tdLeft">
                                            <b>
                                    ...
                                    <tr>
                                        <td width="17%" class="tdRight">
                                            <asp:Label ID="Label10" runat="server" Text="Fiber Description :" CssClass="LabelNo SmallFont"></asp:Label>
                                        </td>
                                        <td width="20%" class="tdLeft">
                                            <cc2:ComboBox ID="ddlyarncode" runat="server" AutoPostBack="True" CssClass="SmallFont"
                                                DataTextField="FIBER_CODE" DataValueField="FIBER_CAT" EmptyText="Find Fiber Code"
