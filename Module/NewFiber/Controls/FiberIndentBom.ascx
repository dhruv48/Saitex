...
<link href="../../../StyleSheet/CommonStyle.css" rel="stylesheet" type="text/css" />
    ...
    .item
   {
    ...
    <b class="titleheading"> Fiber Indent Against BOM
    </b>
    </td>
    </tr>
    <tr>
    ...
    <asp:TextBox ID="txtIndentNumber" runat="server" Width="70px" CssClass="TextBox TextBoxDisplay SmallFont" Font-Bold="true" AutoPostBack="true" OnTextChanged="txtIndentNumber_TextChanged"></asp:TextBox>
    <asp:DropDownList ID="ddlIndentNumber" runat="server" CssClass="SmallFont" AutoPostBack="true" OnSelectedIndexChanged="ddlIndentNumber_SelectedIndexChanged1"></asp:DropDownList>
    </td>
    <td class="tdRight Label" width="15%" style="font-weight:bold; word-spacing:normal;">
    Indent Date:
    </td>
    <td class="tdLeft" width="15%">
    <asp:TextBox ID="txtIndentDate" runat="server" Width="111px" ReadOnly="true" 
    ...
    <td class="tdLeft" width="15%">
    <asp:TextBox ID="txtDepartment" runat="server" Width="109px"  
    ...
    <td class="tdLeft" width="15%">
    <asp:TextBox ID="txtPreparedBy" runat="server" Width="135px" 
            CssClass="TextBox TextBoxDisplay SmallFont" ReadOnly="true"></asp:TextBox>
    </td>
    <td class="tdRight Label" width="15%" style=" font-weight:bold; word-spacing:normal;">
    Required Before:
    ...
    <td class="tdLeft" width="15%">
    <asp:TextBox ID="txtRequiredBefore" runat="server" Width="112px" 
            CssClass="TextBox TextBoxDisplay SmallFont" ></asp:TextBox>
    </td>
    <td class="tdRight Label" width="15%" style="font-weight:bold; word-spacing:normal;">
    Comments:
    ...
    <td>
    <asp:TextBox ID="txtComments" runat="server" Width="112px" 
    ...
    <cc2:ComboBox ID="ddlFiberCode" runat="server" AutoPostBack="true" EnableLoadOnDemand="true" OnLoadingItems="ddlFiberCode_LoadingItems" DataTextField="BASE_ARTICAL_CODE" DataValueField="BASE_SHADE_CODE" OnSelectedIndexChanged="ddlFiberCode_SelectedIndexChanged" EnableVirtualScrolling="true" Width="100%" MenuWidth="300px" Height="200px">
    <HeaderTemplate>
    <div class="header c2">
    PARTY
    </div>
    ...
    <asp:Button ID="btnAdjBom" runat="server" Text="Adj." OnClick="btnAdjBom_CLick" Width="58px" />
    </td>
    <td align="left" valign="top" width="10%">
                                    <asp:TextBox ID="txtReqDate" runat="server" TabIndex="27" Width="60px" CssClass="SmallFont TextBox UpperCase"></asp:TextBox>
       </td>
    <td align="right" valign="top" width="70px" class="style7">
    <asp:TextBox ID="txtRequestQty" runat="server" CssClass="TextBox  SmallFont" Width="70px" ReadOnly="true" OnTextChanged="txtRequestQty_TextChanged" onkeyup="javascript:Calculation(this.id);"></asp:TextBox>
    <br />
    ...
    /<asp:TextBox ID="txtFiberDesc" runat="server" 
            CssClass="SmallFont TextBox TextBoxDisplay" ReadOnly="true" Width="110px"></asp:TextBox>
    &nbsp; 
        &nbsp; Stock:<asp:TextBox ID="txtCurrent" runat="server" ReadOnly="true" CssClass="TextBoxNo SmallFont TextBoxDisplay"
                                Width="60px"></asp:TextBox>
                                &nbsp;
        Min Stock:
        <asp:TextBox ID="txtMinStock" runat="server" ReadOnly="true"
  ...
  <asp:Button ID="lbtnCancel" Text="Cancel" runat="server" TabIndex="16" OnClick="lbtnCancel_Click1"
                                Width="75px" Height="26px" style="margin-left: 0px"></asp:Button>
      </td>  
    </tr>
    </table>
