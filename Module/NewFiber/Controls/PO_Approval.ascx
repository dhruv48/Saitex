<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PO_Approval.ascx.cs" Inherits="Module_Fiber_Controls_PO_Approval" %>
...
<table width="100%" align="left" class="tContentArial">
    ...
    <tr>
        <td align="center" class="TableHeader td" width="100%">
            <b class="titleheading">Fiber Purchase Order Approval</b>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td>
            <asp:GridView ID="grd_fib_po_app" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                PageSize="10" AllowSorting="True" DataKeyNames="PO_NUMB" CellPadding="0" GridLines="Both" BorderStyle="Ridge" CssClass="smallfont"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="CONF_DATE" HeaderText="CONFIRM DATE">
                        <ItemStyle HorizontalAlign="Left" Wrap="true" CssClass="label smallfont" VerticalAlign="Top" />
                    </asp:BoundField>
                    <asp:BoundField DataField="CONF_BY" HeaderText="CONFIRM BY">
                        <ItemStyle HorizontalAlign="Left" Wrap="true" CssClass="label smallfont" VerticalAlign="Top" />
                    </asp:BoundField>
                                ...
                                <td colspan="100%">
                                    <div id="div<%# Eval("PO_NUMB") %>" style="display: none; background-color: #DCDDCF;
                                        ...
                                        <asp:GridView ID="grdchild" runat="server" AutoGenerateColumns="false" BorderStyle="Double"
                                            ...
                                            <Columns>
                                                <asp:BoundField DataField="FIBER_CODE" HeaderText="FIBER CODE" HeaderStyle-HorizontalAlign="Left" />
                                                <asp:BoundField DataField="FIBER_DESC" HeaderText="FIBER DESC" HeaderStyle-HorizontalAlign="Left" />
