...
<table class="tdMain" width="100%">
    ...
    <tr>
        <td align="center" class="TableHeader td" width="100%">
            <b class="titleheading">Fiber Issue Against PA (Production Advice)</b>
        </td>
    </tr>
    <tr>
            ...
            <table width="98%">
                ...
                <tr>
                    <td width="15%">
                        <cc2:ComboBox ID="DDLPiNo" runat="server" CssClass="SmallFont" EmptyText="select.."
                            AutoPostBack="True" EnableLoadOnDemand="true" MenuWidth="780px" OnLoadingItems="DDLPiNo_LoadingItems"
                ...
                <tr>
                    <td colspan="9" width="92%">
                        ...
                        Uom1:<asp:TextBox ID="txtUNIT" runat="server" CssClass="TextBox TextBoxDisplay SmallFont"
