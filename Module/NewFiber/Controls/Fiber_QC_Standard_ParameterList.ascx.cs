...
public partial class Module_NewFiber_Controls_Fiber_QC_Standard_ParameterList : System.Web.UI.UserControl
{
    ...
    protected void GetQuery()
    {
        try
        {
            ...
            dt = SaitexBL.Interface.Method.FIBERQC_PARAMETER.GetQCQuery(oUserLoginDetail.COMP_CODE, oUserLoginDetail.CH_BRANCHCODE, "", "", "", "", "", "", "", "", "", "", "", "", "", "");
            if (dt.Rows.Count > 0)
            {
    ...
    public void SearchbyKeywords()
    {
        ...
        DataTable dt = SaitexBL.Interface.Method.FIBERQC_PARAMETER.GetQCQuery(oUserLoginDetail.COMP_CODE, oUserLoginDetail.CH_BRANCHCODE, txtINWARD_TYPE, txtYARN_CATEGORY, txtYARN_CODE, txtYARN_DESC, txtNOMINAL_COUNT, txtTOTAL_IMPERFECTION, txtSTD_TYPE, txtTOLERANCE, txtTOLERANCE_TYPE, txtTOLERANCE_RANGE, txtUOM, txtSTATUS, txtMAX_VALUE, txtMIN_VALUE);
        if (dt.Rows.Count > 0)
        {
            grdITEMMasterQuery.DataSource = dt;
            grdITEMMasterQuery.DataBind();
    ...
    protected void imgbtnExport_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Common.CommonFuction.ExporttoExcel(data, strFilename, "Fiber QC Standard Master List", oUserLoginDetail.VC_COMPANYNAME);
