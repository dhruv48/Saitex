<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Fiber_Qc_Stan_Approval.ascx.cs" Inherits="Module_NewFiber_Controls_Fiber_Qc_Stan_Approval" %>
<table width="100%" align="left" class="tContentArial">
    ...
    <tr>
        <td align="center" class="TableHeader td" width="100%">
            <b class="titleheading">Fiber QC Standard Master Approval</b>
        </td>
    </tr>
    <tr>
        ...
        <td align="left" class="td" width="100%">
            <asp:GridView ID="gvMaterialReceiptApproval" CssClass="SmallFont" runat="server"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Fiber&nbsp;Category" HeaderStyle-HorizontalAlign="Left">
                        <ItemTemplate>
                            <asp:Label ID="lblYARN_CATEGORY" runat="server" Text='<%#Eval("FIBER_CATEGORY") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
