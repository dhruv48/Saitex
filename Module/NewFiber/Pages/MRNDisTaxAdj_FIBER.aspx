<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MRNDisTaxAdj_FIBER.aspx.cs" Inherits="Module_Fiber_Pages_MRNDisTaxAdj_FIBER" %>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtRate" runat="server" CssClass="SmallFont TextBox" 
                                            Width="50px" MaxLength="6" AutoPostBack="true" 
