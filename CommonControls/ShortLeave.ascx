<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShortLeave.ascx.cs" Inherits="CommonControls_ShortLeave" %>
...
<table cellpadding="0" cellspacing="0" border="0" class="tContentArial">
                ...
                <tr>
                    <td>
                        <asp:ImageButton ID="imgbtnSave" runat="server" ToolTip="Save" ImageUrl="~/CommonImages/save.jpg"
                            Width="61px" Height="40px" ValidationGroup="short" OnClick="imgbtnSave_Click1"></asp:ImageButton>
                    </td>
                    <td>
                        <asp:ImageButton ID="imgbtnUpdate" runat="server" ToolTip="Update" ImageUrl="~/CommonImages/edit1.jpg"
                            Width="48" Height="41" ValidationGroup="short" OnClick="imgbtnUpdate_Click"></asp:ImageButton>
                    </td>
                    <td>
            ...
            <table border="0" cellpadding="3" cellspacing="0" width="400" class="tContentArial tablebox">
                <tr>
                    <td align="center" colspan="8" valign="top" class="tRowColorAdmin">
                        <span class="H3Heading">Short Leave Master</span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td width="50%" align="left" valign="top">
                        <asp:TextBox ID="txtYear" runat="server" MaxLength="4" Width="50px" CssClass="gCtrTxt" ValidationGroup="short"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtYear"
                            Display="Dynamic" ErrorMessage="Field Can't be Empty" ValidationGroup="Suraj"></asp:RequiredFieldValidator>
                        <asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="txtYear"
                            ...
                            Type="Integer" ValidationGroup="short"></asp:RangeValidator>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ControlToValidate="txtYear"
                            ...
                            ValidationExpression="^\d{4}$" ValidationGroup="Suraj"></asp:RegularExpressionValidator>
                    </td>
                </tr>
                <tr>
                    <td width="48%" align="right" valign="top">
                    ...
                    <td width="2%" align="center" valign="top">
                        <b>:</b></td>
                    <td width="50%" align="left" valign="top">
                        <asp:TextBox ID="txtNoOfDays" runat="server" MaxLength="4" Width="50px" CssClass="gCtrTxt" ValidationGroup="short"></asp:TextBox></td>
                </tr>
                <tr>
                    <td width="48%" align="right" valign="top">
    ...
    <tr>
        <td align="left" width="100%" colspan="3">
            <br />
            <asp:GridView ID="gvShortLeavemaster" runat="server" PagerSettings-Mode="Numeric"
                PageSize="10" PagerSettings-Position="Bottom" PagerStyle-HorizontalAlign="Left"
                AutoGenerateColumns="False" AllowPaging="True" Width="100%" CssClass="tContentArial"
                OnRowCommand="gvShortLeavemaster_RowCommand" OnPageIndexChanging="gvShortLeavemaster_PageIndexChanging">
                <HeaderStyle HorizontalAlign="center" />
                <Columns>
                    <asp:BoundField HeaderText="IN_SHORTLEAVEMASTER" DataField="IN_SHORTLEAVEMASTER"
                        Visible="false">
                    ...
                    <asp:TemplateField HeaderText="Edit">
                        <ItemTemplate>
                            <asp:LinkButton ID="lnkEdit" runat="server" CausesValidation="false" CommandArgument='<%# Eval("IN_SHORTLEAVEMASTER") %>'
