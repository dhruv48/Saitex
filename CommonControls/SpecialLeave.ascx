<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SpecialLeave.ascx.cs"
    Inherits="CommonControls_SpecialLeave" %>
...
<table cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                    <td>
                        <asp:ImageButton ID="imgbtnSave" runat="server" ToolTip="Save" ImageUrl="~/CommonImages/save.jpg"
                            Width="61px" Height="40px"  ValidationGroup="Special" OnClick="imgbtnSave_Click1"></asp:ImageButton>
                    </td>
                    <td>
                        <asp:ImageButton ID="imgbtnUpdate" runat="server" ToolTip="Update" ImageUrl="~/CommonImages/edit1.jpg"
                            Width="48" Height="41" ValidationGroup="Special" OnClick="imgbtnUpdate_Click"></asp:ImageButton>
                    </td>
                    <td>
            ...
            <table border="0" cellpadding="3" cellspacing="0" width="400" class="tContentArial">
                <tr>
                    <td align="center" colspan="8" valign="top" class="tRowColorAdmin">
                        <span class="H3Heading">Special Leave Master</span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td width="50%" align="left" valign="top">
                        <asp:TextBox ID="txtYear" runat="server" MaxLength="4" Width="50px" CssClass="gCtrTxt"  ValidationGroup="Special"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtYear"
                            Display="Dynamic" ErrorMessage="Field Can't be Empty"  ValidationGroup="Special"></asp:RequiredFieldValidator>
                        <asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="txtYear"
                            ErrorMessage="Year Can't be Previous Year" MaximumValue="2100" MinimumValue="2010"
                             ValidationGroup="Special"></asp:RangeValidator>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ControlToValidate="txtYear"
                            ...
                            ValidationExpression="^\d{4}$"  ValidationGroup="Special"></asp:RegularExpressionValidator>
                    </td>
                </tr>
                <tr>
                    <td width="48%" align="right" valign="top">
                    ...
                    <td width="2%" align="center" valign="top">
                        <b>:</b></td>
                    <td width="50%" align="left" valign="top">
                        <asp:TextBox ID="txtNoOfDays" runat="server" MaxLength="4" Width="50px" CssClass="gCtrTxt"  ValidationGroup="Special"></asp:TextBox></td>
                </tr>
                <tr>
    ...
    <tr>
        ...
        <br />
            <asp:GridView ID="gvSpecialLeaveMaster" runat="server" PagerSettings-Mode="Numeric" PageSize="10"
                PagerSettings-Position="Bottom" PagerStyle-HorizontalAlign="Left" AutoGenerateColumns="False"
                AllowPaging="True" Width="100%" CssClass="tContentArial" OnRowCommand="gvSpecialLeaveMaster_RowCommand" OnPageIndexChanging="gvSpecialLeaveMaster_PageIndexChanging">
                <HeaderStyle HorizontalAlign="center" />
                <Columns>
                    <asp:BoundField HeaderText="IN_SPECIALLEAVEMASTERID" DataField="IN_SPECIALLEAVEMASTERID"
                        Visible="false">
                   ...
                   <asp:BoundField HeaderText="YEAR" DataField="CH_YEAR">
                    ...
                    <asp:TemplateField HeaderText="Edit">
                        <ItemTemplate>
                            <asp:LinkButton ID="lnkEdit" runat="server" CausesValidation="false" CommandArgument='<%# Eval("IN_SPECIALLEAVEMASTERID") %>'
