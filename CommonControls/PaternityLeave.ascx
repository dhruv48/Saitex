<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PaternityLeave.ascx.cs"
    Inherits="CommonControls_PaternityLeave" %>
<table cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                    <td>
                        <asp:ImageButton ID="imgbtnSave" runat="server" ToolTip="Save" ImageUrl="~/CommonImages/save.jpg"
                            Width="61px" Height="40px" ValidationGroup="Paternity" OnClick="imgbtnSave_Click1"></asp:ImageButton>
                    </td>
                    <td>
                        <asp:ImageButton ID="imgbtnUpdate" runat="server" ToolTip="Update" ImageUrl="~/CommonImages/edit1.jpg"
                            Width="48" Height="41" ValidationGroup="Paternity" OnClick="imgbtnUpdate_Click"></asp:ImageButton>
                    </td>
                    <td>
            ...
            <table border="0" cellpadding="3" cellspacing="0" width="400" class="tContentArial">
                <tr>
                    <td align="center" colspan="8" valign="top" class="tRowColorAdmin">
                        <span class="H3Heading">Paternity Leave Master</span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td align="left" valign="top">
                        <asp:TextBox ID="txtYear" runat="server" CssClass="gCtrTxt" Width="80" MaxLength="4" ValidationGroup="Paternity"></asp:TextBox>&nbsp;
                        ...
                        <asp:RangeValidator ID="RangeValidator2" runat="server" ErrorMessage="Year Can't be Previous Year"
                            MaximumValue="2100" MinimumValue="2010" Type="Integer" ValidationGroup="Paternity" ControlToValidate="txtYear"></asp:RangeValidator></td>
                </tr>
                <tr>
                    ...
                    <td align="left">
                        <asp:TextBox ID="txtLeaveDays" runat="server" CssClass="gCtrTxt" MaxLength="3" Width="50px" ValidationGroup="Paternity"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtLeaveDays"
                            Display="Dynamic" ErrorMessage="Field can't be empty !" ValidationGroup="Paternity"></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtLeaveDays"
                            ...
                            ValidationGroup="Paternity"></asp:RegularExpressionValidator>
                        <asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="txtLeaveDays"
                            ...
                            MinimumValue="0" Type="Integer" ValidationGroup="Paternity"></asp:RangeValidator></td>
                </tr>
                <tr>
   ...
   <tr>
    ...
    <tr>
        ...
        <br />
            <asp:GridView ID="gvPaternityLeaveMaster" runat="server" PagerSettings-Mode="Numeric" PageSize="10"
                PagerSettings-Position="Bottom" PagerStyle-HorizontalAlign="Left" AutoGenerateColumns="False"
                AllowPaging="True" Width="100%" CssClass="tContentArial" OnRowCommand="gvPaternityLeaveMaster_RowCommand" OnPageIndexChanging="gvPaternityLeaveMaster_PageIndexChanging">
                <HeaderStyle HorizontalAlign="center"/>
                <Columns>
                    <asp:BoundField HeaderText="IN_PATERNITYLEAVEMASTERID" DataField="IN_PATERNITYLEAVEMASTERID"
                        Visible="false">
                    ...
                    <asp:TemplateField HeaderText="Edit">
                        <ItemTemplate>
                            <asp:LinkButton ID="lnkEdit" runat="server" CausesValidation="false" CommandArgument='<%# Eval("IN_PATERNITYLEAVEMASTERID") %>'
