<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CompansatoryLeave.ascx.cs" Inherits="CommonControls_CompansatoryLeave" %>
<table cellpadding="0" cellspacing="0" border="0" >
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:ImageButton ID="imgbtnSave" runat="server" ToolTip="Save" ImageUrl="~/CommonImages/save.jpg"
                                Width="61px" Height="40px" OnClick="imgbtnSave_Click1" ValidationGroup="Compensatory"></asp:ImageButton>
                        </td>
                        <td>
                            <asp:ImageButton ID="imgbtnUpdate" runat="server" ToolTip="Update" ImageUrl="~/CommonImages/edit1.jpg"
                                Width="48" Height="41"  ValidationGroup="Compensatory" OnClick="imgbtnUpdate_Click" ></asp:ImageButton>
                        </td>
         ...
         <tr>
                    <td align="center" colspan="8" valign="top" class="tRowColorAdmin">
                        <span class="H3Heading">Compensatory Leave Master</span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td align="left" width="50%" valign="top">
                        <asp:TextBox ID="txtYear" runat="server" CssClass="gCtrTxt" Width="80" MaxLength="4" ValidationGroup="Compensatory"></asp:TextBox>&nbsp;
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="txtYear"
                            ...
                            ValidationGroup="Compensatory"></asp:RegularExpressionValidator>
                        <asp:RangeValidator ID="RangeValidator2" runat="server" ControlToValidate="txtYear"
                            ...
                            Type="Integer" ValidationGroup="Compensatory"></asp:RangeValidator></td>
                </tr>
                <tr>
                     <td align="right" width="48%" valign="top">
                        No of days</td>
                    ...
                    <td align="left" width="50%" valign="top">
                        <asp:TextBox ID="txtLeaveDays" runat="server" CssClass="gCtrTxt" MaxLength="3" Width="50px" ValidationGroup="Compensatory"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtLeaveDays"
                            Display="Dynamic" ErrorMessage="Field can't be empty !" ValidationGroup="Compensatory"></asp:RequiredFieldValidator>
                        ...
                        <asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="txtLeaveDays"
                            ...
                            MinimumValue="0" Type="Integer" ValidationGroup="Compensatory"></asp:RangeValidator></td>
                </tr>
                <tr>
                    <td align="right" width="48%" valign="top">
           ...
           <tr>
            ...
            <tr>
                    ...
                    <br />
                        <asp:GridView ID="gvCompensatoryLeavemaster" runat="server" PagerSettings-Mode="Numeric" PageSize="10" 
                            PagerSettings-Position="Bottom" PagerStyle-HorizontalAlign="Left" AutoGenerateColumns="False"
                            AllowPaging="True" Width="100%" CssClass="tContentArial" OnPageIndexChanging="gvCompensatoryLeavemaster_PageIndexChanging" OnRowCommand="gvCompensatoryLeavemaster_RowCommand" >
                          <HeaderStyle HorizontalAlign="center"/>
                            <Columns>
                                <asp:BoundField HeaderText="COMPENSATORYLEAVEMASTERID" DataField="IN_COMPENSATORYLEAVEMASTERID"
                                    Visible="false">
                                 </asp:BoundField>
                               <asp:BoundField HeaderText="YEAR" DataField="CH_YEAR">
                                ...
                                <asp:TemplateField HeaderText="Edit">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkEdit" runat="server" CausesValidation="false" CommandArgument='<%# Eval("IN_COMPENSATORYLEAVEMASTERID") %>'
