<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SickLeave.ascx.cs" Inherits="CommonControls_SickLeave" %>
<table cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                    <td>
                        <asp:ImageButton ID="imgbtnSave" runat="server" ToolTip="Save" ImageUrl="~/CommonImages/save.jpg"
                            Width="61px" Height="40px" ValidationGroup="Sick" OnClick="imgbtnSave_Click1"></asp:ImageButton>
                    </td>
                    <td>
                        <asp:ImageButton ID="imgbtnUpdate" runat="server" ToolTip="Update" ImageUrl="~/CommonImages/edit1.jpg"
                            Width="48" Height="41" ValidationGroup="Sick" OnClick="imgbtnUpdate_Click"></asp:ImageButton>
                    </td>
                    <td>
            ...
            <table border="0" cellpadding="3" cellspacing="0" width="400" class="tContentArial">
                <tr>
                    <td align="center" colspan="8" valign="top" class="tRowColorAdmin">
                        <span class="H3Heading">Sick Leave Master</span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td align="left" width="50%" valign="top">
                        <asp:TextBox ID="txtYear" runat="server" CssClass="gCtrTxt" Width="80" MaxLength="4" ValidationGroup="Sick"></asp:TextBox>&nbsp;
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="txtYear"
                            ...
                            ValidationGroup="Sick"></asp:RegularExpressionValidator>
                        <asp:RangeValidator ID="RangeValidator2" runat="server" ControlToValidate="txtYear"
                            ...
                            Type="Integer" ValidationGroup="Sick"></asp:RangeValidator></td>
                </tr>
                <tr>
                    <td align="right" width="48%" valign="top">
                        No of days</td>
                    ...
                    <td align="left" width="50%" valign="top">
                        <asp:TextBox ID="txtLeaveDays" runat="server" CssClass="gCtrTxt" MaxLength="3" Width="50px" ValidationGroup="Sick"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtLeaveDays"
                            Display="Dynamic" ErrorMessage="Field can't be empty !" ValidationGroup="Sick"></asp:RequiredFieldValidator>
                        ...
                        <asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="txtLeaveDays"
                            ...
                            MinimumValue="0" Type="Integer" ValidationGroup="Sick"></asp:RangeValidator></td>
                </tr>
                <tr>
                    <td align="right" width="48%" valign="top">
                    ...
                    <td align="left" width="50%" valign="top">
                        <asp:RadioButtonList ID="radLeaveApplicable" AutoPostBack="true" runat="server" RepeatColumns="2"
                            ...
                            <asp:ListItem Text="Limited" Value="PE" Selected="True"></asp:ListItem>
                            <asp:ListItem Text="No Limit" Value="NP"></asp:ListItem>
                        </asp:RadioButtonList>&nbsp; &nbsp; &nbsp; 
                        <asp:TextBox ID="txtPeriod" Width="50" MaxLength="2" CssClass="gCtrTxt" runat="server"></asp:TextBox>
                        <asp:Label ID="lblYear" runat="server" Text="Days"></asp:Label>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtPeriod"
                            Display="Dynamic" ErrorMessage="Field can't be empty !" ValidationGroup="Sick"></asp:RequiredFieldValidator><asp:RegularExpressionValidator
                                ID="RegularExpressionValidator4" runat="server" ControlToValidate="txtPeriod"
                                Display="Dynamic" ErrorMessage="Pls enter digit only !" Font-Bold="False" ValidationExpression="^\s*[0-9]+\s*$"
                                ValidationGroup="Sick"></asp:RegularExpressionValidator></td>
                </tr>
                <tr>
                    <td align="right" width="48%" valign="top">
    ...
    <tr>
        ...
        <br />
            <asp:GridView ID="gvSickLeaveMaster" runat="server" PagerSettings-Mode="Numeric" PageSize="10"
                PagerSettings-Position="Bottom" PagerStyle-HorizontalAlign="Left" AutoGenerateColumns="False"
                AllowPaging="True" Width="100%" CssClass="tContentArial" OnRowCommand="gvSickLeaveMaster_RowCommand" OnPageIndexChanging="gvSickLeaveMaster_PageIndexChanging">
                <Columns>
                    <asp:BoundField HeaderText="IN_SICKLEAVEMASTERID" DataField="IN_SICKLEAVEMASTERID"
                        Visible="false">
                    ...
                    <asp:TemplateField HeaderText="Edit">
                        <ItemTemplate>
                            <asp:LinkButton ID="lnkEdit" runat="server" CausesValidation="false" CommandArgument='<%# Eval("IN_SICKLEAVEMASTERID") %>'
