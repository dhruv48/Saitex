<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Transaction_Of_Master.ascx.cs"
    Inherits="CommonControls_LOV_Transaction_Of_Master" %>
                ...
                <tr>
                    ...
                    <td align="left" valign="top" width="70%">
                        <asp:TextBox ID="txtMstDesc" runat="server" CssClass="TextBox UpperCase" Width="150px"
                            TabIndex="3" Rows="2"  TextMode="MultiLine" MaxLength="50"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" Display="None" runat="server"
